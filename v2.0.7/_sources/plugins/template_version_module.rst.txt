...
.. _ansible_collections.cisco.dnac.template_version_module:
...
cisco.dnac.template_version -- Manage TemplateVersion objects of ConfigurationTemplates
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.template_version`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>TemplateVersionRequestDTO&#x27;s comments.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>TemplateVersionRequestDTO&#x27;s templateId.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.template_version <ansible_collections.cisco.dnac.plugins.module_utils.definitions.template_version_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.template_version** module.
   `TemplateVersion reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the TemplateVersion object model.
   `TemplateVersion reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">configuration_templates.get_template_versions</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
