...
.. _ansible_collections.cisco.dnac.sda_host_onboarding_access_point_module:
...
cisco.dnac.sda_host_onboarding_access_point -- Manage SdaHostOnboardingAccessPoint objects of Sda
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.sda_host_onboarding_access_point`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda host onboarding access point&#x27;s authenticateTemplateName.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda host onboarding access point&#x27;s dataIpAddressPoolName.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda host onboarding access point&#x27;s deviceManagementIpAddress.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda host onboarding access point&#x27;s interfaceName.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda host onboarding access point&#x27;s siteNameHierarchy.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda host onboarding access point&#x27;s voiceIpAddressPoolName.</div>
                                                        </td>
            </tr>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.sda_host_onboarding_access_point <ansible_collections.cisco.dnac.plugins.module_utils.definitions.sda_host_onboarding_access_point_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.sda_host_onboarding_access_point** module.
   `SdaHostOnboardingAccessPoint reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SdaHostOnboardingAccessPoint object model.
   `SdaHostOnboardingAccessPoint reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sda.add_port_assignment_for_access_point</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
