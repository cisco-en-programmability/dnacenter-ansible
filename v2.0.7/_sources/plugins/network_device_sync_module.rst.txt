...
.. _ansible_collections.cisco.dnac.network_device_sync_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.network_device_sync`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>ForceSync query parameter.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.network_device_sync <ansible_collections.cisco.dnac.plugins.module_utils.definitions.network_device_sync_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.network_device_sync** module.
   `NetworkDeviceSync reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the NetworkDeviceSync object model.
   `NetworkDeviceSync reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">devices.sync_devices_using_forcesync</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
