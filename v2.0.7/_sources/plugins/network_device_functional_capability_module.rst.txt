...
.. _ansible_collections.cisco.dnac.network_device_functional_capability_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.network_device_functional_capability`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Accepts comma separated deviceid&#x27;s and return list of functional-capabilities for the given id&#x27;s. If invalid or not-found id&#x27;s are provided, null entry will be returned in the list.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <b>function_name</b>
                    <a class="ansibleOptionLink" href="#parameter-function_name" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>FunctionName query parameter.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Functional Capability UUID.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.network_device_functional_capability <ansible_collections.cisco.dnac.plugins.module_utils.definitions.network_device_functional_capability_module>`
   ...
   `NetworkDeviceFunctionalCapability reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the NetworkDeviceFunctionalCapability object model.
   `NetworkDeviceFunctionalCapability reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">devices.get_functional_capability_by_id</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
