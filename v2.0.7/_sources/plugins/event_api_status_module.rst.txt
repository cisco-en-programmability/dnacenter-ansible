...
.. _ansible_collections.cisco.dnac.event_api_status_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.event_api_status`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-execution_id"></div>
                    <b>execution_id</b>
                    <a class="ansibleOptionLink" href="#parameter-execution_id" title="Permalink to this option"></a>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.event_api_status <ansible_collections.cisco.dnac.plugins.module_utils.definitions.event_api_status_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.event_api_status** module.
   `EventApiStatus reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the EventApiStatus object model.
   `EventApiStatus reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">event_management.get_status_api_for_events</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
