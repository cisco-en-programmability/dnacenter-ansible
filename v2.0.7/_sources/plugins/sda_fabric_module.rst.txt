...
.. _ansible_collections.cisco.dnac.sda_fabric_module:
...
cisco.dnac.sda_fabric -- Manage SdaFabric objects of Sda
++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.sda_fabric`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda fabric&#x27;s fabricName.</div>
                                                        </td>
            </tr>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.sda_fabric <ansible_collections.cisco.dnac.plugins.module_utils.definitions.sda_fabric_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.sda_fabric** module.
   `SdaFabric reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SdaFabric object model.
   `SdaFabric reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sda.add_fabric</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
