...
.. _ansible_collections.cisco.dnac.network_device_poller_legit_reads_module:
...
cisco.dnac.network_device_poller_legit_reads -- Manage NetworkDevicePollerLegitReads objects of CommandRunner
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.network_device_poller_legit_reads`.
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.network_device_poller_legit_reads <ansible_collections.cisco.dnac.plugins.module_utils.definitions.network_device_poller_legit_reads_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.network_device_poller_legit_reads** module.
   `NetworkDevicePollerLegitReads reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the NetworkDevicePollerLegitReads object model.
   `NetworkDevicePollerLegitReads reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">command_runner.get_all_keywords_of_clis_accepted</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
