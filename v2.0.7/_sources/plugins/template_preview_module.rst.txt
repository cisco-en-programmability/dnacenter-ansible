...
.. _ansible_collections.cisco.dnac.template_preview_module:
...
cisco.dnac.template_preview -- Manage TemplatePreview objects of ConfigurationTemplates
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.template_preview`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>TemplatePreviewRequestDTO&#x27;s params.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>TemplatePreviewRequestDTO&#x27;s templateId.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.template_preview <ansible_collections.cisco.dnac.plugins.module_utils.definitions.template_preview_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.template_preview** module.
   `TemplatePreview reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the TemplatePreview object model.
   `TemplatePreview reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">configuration_templates.preview_template</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
