...
.. _ansible_collections.cisco.dnac.network_device_register_module:
...
cisco.dnac.network_device_register -- Manage NetworkDeviceRegister objects of Devices
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.network_device_register`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Mac addres of the device.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.network_device_register <ansible_collections.cisco.dnac.plugins.module_utils.definitions.network_device_register_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.network_device_register** module.
   `NetworkDeviceRegister reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the NetworkDeviceRegister object model.
   `NetworkDeviceRegister reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">devices.register_device_for_wsa</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
