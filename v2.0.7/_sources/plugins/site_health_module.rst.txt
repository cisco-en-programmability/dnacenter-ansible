...
.. _ansible_collections.cisco.dnac.site_health_module:
...
cisco.dnac.site_health -- Manage SiteHealth objects of Sites
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.site_health`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Epoch time(in milliseconds) when the Site Hierarchy data is required.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.site_health <ansible_collections.cisco.dnac.plugins.module_utils.definitions.site_health_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.site_health** module.
   `SiteHealth reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SiteHealth object model.
   `SiteHealth reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sites.get_site_health</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
