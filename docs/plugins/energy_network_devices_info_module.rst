...
.. _ansible_collections.cisco.dnac.energy_network_devices_info_module:
...
cisco.dnac.energy_network_devices_info module -- Information module for Energy Network Devices
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.energy_network_devices_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.energy_network_devices_info`.
...
.. _ansible_collections.cisco.dnac.energy_network_devices_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-attribute:
    ...
    - .. raw:: html
      ...
      Attribute query parameter. List of attributes. Please refer to \`NetworkDeviceEnergyAttribute\` for supported list of attributes Examples \`attribute=id&attribute=energyConsumed\`.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-cursor"></div>

      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-cursor:
      ...
      **cursor**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-cursor" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-devicecategory:
    ...
    - .. raw:: html
      ...
      DeviceCategory query parameter. The list of device deviceCategories. Examples \`deviceCategory=Switch\` (single device family requested) \`deviceCategory=Switch&deviceCategory=Router\` (multiple device categories with comma separator).
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-devicesubcategory:
    ...
    - .. raw:: html
      ...
      DeviceSubCategory query parameter. The list of device sub categories. Examples \`deviceSubCategory=Cisco Catalyst 9300 Series Switches\` (single device family requested) \`deviceSubCategory=Cisco Catalyst 9300 Series Switches&deviceSubCategory=Cisco Catalyst 9400 Series Switches\`.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-endtime:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-id:
    ...
    - .. raw:: html
      ...
      Id query parameter. The list of Device Uuids (e.g., \`6bef213c-19ca-4170-8375-b694e251101c\`). Examples \`id=6bef213c-19ca-4170-8375-b694e251101c\` (single device requested) \`id=6bef213c-19ca-4170-8375-b694e251101c&id=32219612-819e-4b5e-a96b-cf22aca13dd9\`.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-limit:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-sitehierarchy:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-sitehierarchyid:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-siteid:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-sortby:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-starttime:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-validate_response_schema:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__parameter-view:
    ...
    - .. raw:: html
      ...
      View query parameter. List of views. View and attribute work in union. Each view will include its attributes. For example, view device includes all the attributes related to device. Please refer to \`NetworkDeviceEnergyView\` model for supported list of views Examples \`view=device&view=energy\`.
...
.. note::
   - SDK Method used are devices.Devices.get\_device\_energy\_by\_id, devices.Devices.get\_devices\_energy,
   - Paths used are get /dna/data/api/v1/energy/networkDevices, get /dna/data/api/v1/energy/networkDevices/{id},
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Devices GetDeviceEnergyByID <https://developer.cisco.com/docs/dna-center/#!get-device-energy-by-id>`_
       Complete reference of the GetDeviceEnergyByID API.
   `Cisco DNA Center documentation for Devices GetDevicesEnergy <https://developer.cisco.com/docs/dna-center/#!get-devices-energy>`_
       Complete reference of the GetDevicesEnergy API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.energy_network_devices_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": {"carbonIntensity": 0, "deviceCategory": "string", "deviceName": "string", "deviceSubCategory": "string", "energyConsumed": 0, "estimatedCost": 0, "estimatedEmission": 0, "id": "string", "siteHierarchy": "string", "siteHierarchyId": "string", "siteId": "string"}, "version": "string"}`
