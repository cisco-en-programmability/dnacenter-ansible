...
.. _ansible_collections.cisco.dnac.client_health_module:
...
cisco.dnac.client_health -- Manage ClientHealth objects of Clients
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.client_health`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Epoch time(in milliseconds) when the Client health data is required.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.client_health <ansible_collections.cisco.dnac.plugins.module_utils.definitions.client_health_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.client_health** module.
   `ClientHealth reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the ClientHealth object model.
   `ClientHealth reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">clients.get_overall_client_health</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
