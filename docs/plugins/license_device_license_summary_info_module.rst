...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.license_device_license_summary_info_module_requirements>` for details.
...
.. _ansible_collections.cisco.dnac.license_device_license_summary_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-device_type:
    ...
    - .. raw:: html
      ...
      Device\_type query parameter. Type of device.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-device_uuid:
    ...
    - .. raw:: html
      ...
      Device\_uuid query parameter. Id of device.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dna_level:
    ...
    - .. raw:: html
      ...
      Dna\_level query parameter. Device Cisco DNA license level.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-limit:
    ...
    - .. raw:: html
      ...
      Limit query parameter. Specifies the maximum number of device license summaries to return per page. Must be an integer between 1 and 500, inclusive.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-page_number:
    ...
    - .. raw:: html
      ...
      Page\_number query parameter. Page number of response.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-registration_status:
    ...
    - .. raw:: html
      ...
      Registration\_status query parameter. Smart license registration status of device.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-smart_account_id:
    ...
    - .. raw:: html
      ...
      Smart\_account\_id query parameter. Id of smart account.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-sort_by:
    ...
    - .. raw:: html
      ...
      Sort\_by query parameter. Sort result by field.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-validate_response_schema:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__parameter-virtual_account_name:
    ...
    - .. raw:: html
      ...
      Virtual\_account\_name query parameter. Name of virtual account.
...
.. note::
   - SDK Method used are licenses.Licenses.device\_license\_summary,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Licenses DeviceLicenseSummary <https://developer.cisco.com/docs/dna-center/#!device-license-summary>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_device_license_summary_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`"[\\n  {\\n    \\"authorization\_status\\": \\"string\\",\\n    \\"last\_updated\_time\\": \\"string\\",\\n    \\"is\_performance\_allowed\\": true,\\n    \\"sle\_auth\_code\\": \\"string\\",\\n    \\"throughput\_level\\": \\"string\\",\\n    \\"hsec\_status\\": \\"string\\",\\n    \\"device\_uuid\\": \\"string\\",\\n    \\"site\\": \\"string\\",\\n    \\"total\_access\_point\_count\\": 0,\\n    \\"model\\": \\"string\\",\\n    \\"is\_wireless\_capable\\": true,\\n    \\"registration\_status\\": \\"string\\",\\n    \\"sle\_state\\": \\"string\\",\\n    \\"performance\_license\\": \\"string\\",\\n    \\"license\_mode\\": \\"string\\",\\n    \\"is\_license\_expired\\": true,\\n    \\"software\_version\\": \\"string\\",\\n    \\"reservation\_status\\": \\"string\\",\\n    \\"is\_wireless\\": true,\\n    \\"network\_license\\": \\"string\\",\\n    \\"evaluation\_license\_expiry\\": \\"string\\",\\n    \\"wireless\_capable\_network\_license\\": \\"string\\",\\n    \\"device\_name\\": \\"string\\",\\n    \\"device\_type\\": \\"string\\",\\n    \\"dna\_level\\": \\"string\\",\\n    \\"virtual\_account\_name\\": \\"string\\",\\n    \\"last\_successful\_rum\_usage\_upload\_time\\": \\"string\\",\\n    \\"ip\_address\\": \\"string\\",\\n    \\"wireless\_capable\_dna\_license\\": \\"string\\",\\n    \\"mac\_address\\": \\"string\\",\\n    \\"customer\_tag1\\": \\"string\\",\\n    \\"customer\_tag2\\": \\"string\\",\\n    \\"customer\_tag3\\": \\"string\\",\\n    \\"customer\_tag4\\": \\"string\\",\\n    \\"smart\_account\_name\\": \\"string\\"\\n  }\\n]\\n"`
