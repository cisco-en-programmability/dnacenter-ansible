...
.. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.compliance_device_by_id_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.compliance_device_by_id_info`.
...
.. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-category:
    ...
    - .. raw:: html
      ...
      Category query parameter. Category can have any value among 'INTENT', 'RUNNING\_CONFIG' , 'IMAGE' , 'PSIRT' , 'DESIGN\_OOD' , 'EOX' , 'NETWORK\_SETTINGS'.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-complianceType"></div>

      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-compliancetype:
      ...
      **complianceType**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-complianceType" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      ComplianceType query parameter. Specify "Compliance type(s)" separated by commas. The Compliance type can be 'APPLICATION\_VISIBILITY', 'EOX', 'FABRIC', 'IMAGE', 'NETWORK\_PROFILE', 'NETWORK\_SETTINGS', 'PSIRT', 'RUNNING\_CONFIG', 'WORKFLOW'.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-deviceUuid"></div>

      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-deviceuuid:
      ...
      **deviceUuid**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-deviceUuid" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-diffList"></div>

      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-difflist:
      ...
      **diffList**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-diffList" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-headers:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-remediationSupported"></div>

      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-remediationsupported:
      ...
      **remediationSupported**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-remediationSupported" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-status:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are compliance.Compliance.compliance\_details\_of\_device,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Compliance ComplianceDetailsOfDevice <https://developer.cisco.com/docs/dna-center/#!compliance-details-of-device>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.compliance_device_by_id_info_module__return-dnac_response:
