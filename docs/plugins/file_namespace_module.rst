...
.. _ansible_collections.cisco.dnac.file_namespace_module:
...
cisco.dnac.file_namespace -- Manage FileNamespace objects of File
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.file_namespace`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-name_space"></div>
                    <b>name_space</b>
                    <a class="ansibleOptionLink" href="#parameter-name_space" title="Permalink to this option"></a>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.file_namespace <ansible_collections.cisco.dnac.plugins.module_utils.definitions.file_namespace_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.file_namespace** module.
   `FileNamespace reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the FileNamespace object model.
   `FileNamespace reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">file.get_list_of_available_namespaces</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
