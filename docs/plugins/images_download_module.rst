...
.. _ansible_collections.cisco.dnac.images_download_module:
...
cisco.dnac.images_download module -- Resource module for Images Download
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.images_download_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.images_download`.
...
- Manage operation create of the resource Images Download. - \> Initiates download of the software image from Cisco.com on the disk for the given \`id\`. Refer to \`/dna/intent/api/v1/images\` for obtaining \`id\`.
...
.. _ansible_collections.cisco.dnac.images_download_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are software\_image\_management\_swim.SoftwareImageManagementSwim.download\_the\_software\_image,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Software Image Management (SWIM) DownloadTheSoftwareImage <https://developer.cisco.com/docs/dna-center/#!download-the-software-image>`_
       Complete reference of the DownloadTheSoftwareImage API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.images_download_module__return-dnac_response:
