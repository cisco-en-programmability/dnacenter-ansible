...
.. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module:
...
cisco.dnac.user_enrichment_details_v2_info module -- Information module for User Enrichment Details V2
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.user_enrichment_details_v2_info`.
...
- Get all User Enrichment Details V2. - \> Enriches a given network End User context a network user-id or end user's device Mac Address with details about the user and devices that the user is connected to.
...
.. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are users.Users.get\_user\_enrichment\_details\_v2,
   - Paths used are get /dna/intent/api/v2/user-enrichment-details,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Users GetUserEnrichmentDetailsV2 <https://developer.cisco.com/docs/dna-center/#!get-user-enrichment-details-v-2>`_
       Complete reference of the GetUserEnrichmentDetailsV2 API.
...
.. code-block:: yaml+jinja
    ...
    - name: Get all User Enrichment Details V2
      cisco.dnac.user_enrichment_details_v2_info:
        dnac_host: "{{dnac_host}}"
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_v2_info_module__return-dnac_response:
