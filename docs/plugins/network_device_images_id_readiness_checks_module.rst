...
.. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module:
...
cisco.dnac.network_device_images_id_readiness_checks module -- Resource module for Network Device Images Id Readiness Checks
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.network_device_images_id_readiness_checks`.
...
- Manage operation create of the resource Network Device Images Id Readiness Checks. - \> Triggers an on-demand network device update readiness check, where system-defined pre-checks will be performed. Upon task completion, the task API response's \`resultLocation\` attribute will contain the URL for fetching the validation result.
...
.. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are software\_image\_management\_swim.SoftwareImageManagementSwim.trigger\_update\_readiness\_for\_network\_device,
   - Paths used are post /dna/intent/api/v1/networkDeviceImages/{id}/readinessChecks,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Software Image Management (SWIM) TriggerUpdateReadinessForNetworkDevice <https://developer.cisco.com/docs/dna-center/#!trigger-update-readiness-for-network-device>`_
       Complete reference of the TriggerUpdateReadinessForNetworkDevice API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_images_id_readiness_checks_module__return-dnac_response:
