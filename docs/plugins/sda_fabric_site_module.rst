...
.. _ansible_collections.cisco.dnac.sda_fabric_site_module:
...
cisco.dnac.sda_fabric_site -- Manage SdaFabricSite objects of Sda
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.sda_fabric_site`.
                         ...
                         / <span style="color: purple">elements=dictionary</span>                                            </div>
                                ...
                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-payload/fabricName"></div>
                    <b>fabricName</b>
                    <a class="ansibleOptionLink" href="#parameter-payload/fabricName" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda fabric site&#x27;s fabricName.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda fabric site&#x27;s siteNameHierarchy.</div>
                                                        </td>
            </tr>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.sda_fabric_site <ansible_collections.cisco.dnac.plugins.module_utils.definitions.sda_fabric_site_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.sda_fabric_site** module.
   `SdaFabricSite reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SdaFabricSite object model.
   `SdaFabricSite reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sda.add_site</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
