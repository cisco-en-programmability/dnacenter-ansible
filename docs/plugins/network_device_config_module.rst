...
.. _ansible_collections.cisco.dnac.network_device_config_module:
...
cisco.dnac.network_device_config -- Manage NetworkDeviceConfig objects of Devices
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.network_device_config`.
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.network_device_config <ansible_collections.cisco.dnac.plugins.module_utils.definitions.network_device_config_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.network_device_config** module.
   `NetworkDeviceConfig reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the NetworkDeviceConfig object model.
   `NetworkDeviceConfig reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">devices.get_device_config_count</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
