...
.. _ansible_collections.cisco.dnac.user_enrichment_details_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.user_enrichment_details_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.user_enrichment_details_info`.
...
- Get all User Enrichment Details. - \> Enriches a given network End User context a network user-id or end user's device Mac Address with details about the user and devices that the user is connected to.
...
.. _ansible_collections.cisco.dnac.user_enrichment_details_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are users.Users.get\_user\_enrichment\_details,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Users GetUserEnrichmentDetails <https://developer.cisco.com/docs/dna-center/#!get-user-enrichment-details>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_enrichment_details_info_module__return-dnac_response:
