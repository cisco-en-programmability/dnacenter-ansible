...
.. _ansible_collections.cisco.dnac.file_module:
...
cisco.dnac.file -- Manage File objects of File
++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.file`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Directory absolute path. Defaults to current working directory.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-file_id"></div>
                    <b>file_id</b>
                    <a class="ansibleOptionLink" href="#parameter-file_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>File Identification number.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-save_file"></div>
                    <b>save_file</b>
                    <a class="ansibleOptionLink" href="#parameter-save_file" title="Permalink to this option"></a>
                    <div style="font-size: small">
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.file <ansible_collections.cisco.dnac.plugins.module_utils.definitions.file_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.file** module.
   `File reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the File object model.
   `File reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">file.download_a_file_by_fileid</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
