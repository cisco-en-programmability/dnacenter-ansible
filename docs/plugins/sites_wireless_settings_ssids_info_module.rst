...
.. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module:
...
cisco.dnac.sites_wireless_settings_ssids_info module -- Information module for Sites Wireless Settings Ssids
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.sites_wireless_settings_ssids_info`.
...
.. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-authtype:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-l3authtype:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-limit:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-offset:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-siteid:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-ssid:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-validate_response_schema:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__parameter-wlantype:
...
.. note::
   - SDK Method used are wireless.Wireless.get\_ssid\_by\_id, wireless.Wireless.get\_ssid\_by\_site,
   - Paths used are get /dna/intent/api/v1/sites/{siteId}/wirelessSettings/ssids, get /dna/intent/api/v1/sites/{siteId}/wirelessSettings/ssids/{id},
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Wireless GetSSIDByID <https://developer.cisco.com/docs/dna-center/#!get-ssid-by-id>`_
       Complete reference of the GetSSIDByID API.
   `Cisco DNA Center documentation for Wireless GetSSIDBySite <https://developer.cisco.com/docs/dna-center/#!get-ssid-by-site>`_
       Complete reference of the GetSSIDBySite API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.sites_wireless_settings_ssids_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": [{"aaaOverride": true, "acctServers": ["string"], "aclName": "string", "authServer": "string", "authServers": ["string"], "authType": "string", "basicServiceSetClientIdleTimeout": 0, "basicServiceSetMaxIdleEnable": true, "cckmTsfTolerance": 0, "clientExclusionEnable": true, "clientExclusionTimeout": 0, "clientRateLimit": 0, "coverageHoleDetectionEnable": true, "directedMulticastServiceEnable": true, "egressQos": "string", "externalAuthIpAddress": "string", "fastTransition": "string", "fastTransitionOverTheDistributedSystemEnable": true, "ghz24Policy": "string", "ghz6PolicyClientSteering": true, "id": "string", "ingressQos": "string", "inheritedSiteId": "string", "inheritedSiteName": "string", "inheritedSiteNameHierarchy": "string", "isApBeaconProtectionEnabled": true, "isAuthKey8021x": true, "isAuthKey8021xPlusFT": true, "isAuthKey8021x\_SHA256": true, "isAuthKeyEasyPSK": true, "isAuthKeyOWE": true, "isAuthKeyPSK": true, "isAuthKeyPSKPlusFT": true, "isAuthKeyPSKSHA256": true, "isAuthKeySae": true, "isAuthKeySaeExt": true, "isAuthKeySaeExtPlusFT": true, "isAuthKeySaePlusFT": true, "isAuthKeySuiteB1921x": true, "isAuthKeySuiteB1x": true, "isBroadcastSSID": true, "isCckmEnabled": true, "isCustomNasIdOptions": true, "isEnabled": true, "isFastLaneEnabled": true, "isHex": true, "isMacFilteringEnabled": true, "isPosturingEnabled": true, "isRadiusProfilingEnabled": true, "isRandomMacFilterEnabled": true, "isSensorPnp": true, "l3AuthType": "string", "managementFrameProtectionClientprotection": "string", "multiPSKSettings": [{"passphrase": "string", "passphraseType": "string", "priority": 0}], "nasOptions": ["string"], "neighborListEnable": true, "openSsid": "string", "passphrase": "string", "policyProfileName": "string", "profileName": "string", "protectedManagementFrame": "string", "rsnCipherSuiteCcmp128": true, "rsnCipherSuiteCcmp256": true, "rsnCipherSuiteGcmp128": true, "rsnCipherSuiteGcmp256": true, "sessionTimeOut": 0, "sessionTimeOutEnable": true, "sleepingClientEnable": true, "sleepingClientTimeout": 0, "ssid": "string", "ssidRadioType": "string", "webPassthrough": true, "wlanBandSelectEnable": true, "wlanType": "string"}], "version": "string"}`
