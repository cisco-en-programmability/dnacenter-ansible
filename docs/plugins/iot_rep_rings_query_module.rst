...
.. _ansible_collections.cisco.dnac.iot_rep_rings_query_module:
...
cisco.dnac.iot_rep_rings_query module -- Resource module for Iot Rep Rings Query
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.iot_rep_rings_query_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.iot_rep_rings_query`.
...
- Manage operation create of the resource Iot Rep Rings Query. - \> This API returns the list of REP rings for the given fields - networkDeviceId Network device ID of the REP ring member. In case of successful REP ring creation, any of the REP ring member networkDeviceId can be provided. In case of failed REP ring creation, provide only root node networkDeviceId. The networkDeviceId is the instanceUuid attribute in the response of API - /dna/intent/api/v1/networkDevice and deploymentMode FABRIC/NON\_FABRIC .
...
.. _ansible_collections.cisco.dnac.iot_rep_rings_query_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-deploymentmode:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-limit:
    ...
    - .. raw:: html
      ...
      The number of records to show for this page.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-networkdeviceid:
    ...
    - .. raw:: html
      ...
      Network device id of the REP ring member. API \`/dna/intent/api/v1/networkDevices\` can be used to get the list of networkDeviceIds of the neighbors , \`instanceUuid\` attribute in the response contains networkDeviceId.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-offset:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are industrial\_configuration.IndustrialConfiguration.retrieves\_the\_list\_of\_r\_e\_p\_rings,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Industrial Configuration RetrievesTheListOfREPRings <https://developer.cisco.com/docs/dna-center/#!retrieves-the-list-of-rep-rings>`_
       Complete reference of the RetrievesTheListOfREPRings API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_rep_rings_query_module__return-dnac_response:
