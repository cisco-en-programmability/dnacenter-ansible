...
.. _ansible_collections.cisco.dnac.application_set_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.application_set`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the application set&#x27;s name.</div>
                                                        </td>
            </tr>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.application_set <ansible_collections.cisco.dnac.plugins.module_utils.definitions.application_set_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.application_set** module.
   `ApplicationSet reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the ApplicationSet object model.
   `ApplicationSet reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">application_policy.create_application_set</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
