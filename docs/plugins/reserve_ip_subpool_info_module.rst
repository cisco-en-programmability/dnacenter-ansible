...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.reserve_ip_subpool_info_module_requirements>` for details.
...
.. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-groupname:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-headers:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-ignoreInheritedGroups"></div>

      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-ignoreinheritedgroups:
      ...
      **ignoreInheritedGroups**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-ignoreInheritedGroups" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      IgnoreInheritedGroups query parameter. Ignores pools inherited from parent site. Either siteId or ignoreInheritedGroups must be passed. They can also be used together.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-limit:
    ...
    - .. raw:: html
      ...
      Limit query parameter. Number of reserve pools to be retrieved. Default is 25 if not specified. Maximum allowed limit is 500.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-offset:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-poolUsage"></div>

      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-poolusage:
      ...
      **poolUsage**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-poolUsage" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-siteid:
    ...
    - .. raw:: html
      ...
      SiteId query parameter. Site id of site from which to retrieve associated reserve pools. Either siteId (per site queries) or ignoreInheritedGroups must be used. They can also be used together.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are network\_settings.NetworkSettings.get\_reserve\_ip\_subpool,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Network Settings GetReserveIPSubpool <https://developer.cisco.com/docs/dna-center/#!get-reserve-ip-subpool>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.reserve_ip_subpool_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": [{"groupName": "string", "groupOwner": "string", "id": "string", "ipPools": [{"clientOptions": {}, "configureExternalDhcp": true, "context": [{"contextKey": "string", "contextValue": "string", "owner": "string"}], "createTime": 0, "dhcpServerIps": ["string"], "dnsServerIps": ["string"], "gateways": ["string"], "groupUuid": "string", "id": "string", "ipPoolCidr": "string", "ipPoolName": "string", "ipv6": true, "lastUpdateTime": 0, "overlapping": true, "owner": "string", "parentUuid": "string", "shared": true, "totalIpAddressCount": 0, "usedIpAddressCount": 0, "usedPercentage": "string"}], "siteHierarchy": "string", "siteId": "string", "type": "string"}], "version": "string"}`
