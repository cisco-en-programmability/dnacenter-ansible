...
class TestswimWorkflowManager(TestDnacModule):
    ...
    playbook_image_distribution_failed = test_data.get(
        "playbook_image_distribution_failed")
    playbook_swim_image_golden_already_tagged = test_data.get(
        "playbook_swim_image_golden_already_tagged")
    playbook_swim_image_cant_found = test_data.get(
        "playbook_swim_image_cant_found")
    playbook_image_details_distribution_not_provided = test_data.get(
        "playbook_image_details_distribution_not_provided")
    playbook_device_family_not_found = test_data.get(
        "playbook_device_family_not_found")
    playbook_import_image_remote = test_data.get(
        "playbook_import_image_remote")
    playbook_image_distribution_successfull = test_data.get(
        "playbook_image_distribution_successfull")
    playbook_image_distribution_successfull_v2_3_7_6 = test_data.get(
        "playbook_image_distribution_successfull_v2_3_7_6")
    playbook_swim_image_golden_tag = test_data.get(
        "playbook_swim_image_golden_tag")
    ...
    def load_fixtures(self, response=None, device=""):
        ...
        if "playbook_untag_image_as_golden_and_load_on_device" in self._testMethodName:
            self.run_dnac_exec.side_effect = [
                ...
                self.test_data.get(
                    "untag_image_as_golden_and_load_on_device_responce")
            ]
            ...
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_software_image_details_site_not_exist"),
                Exception(),
            ...
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_software_image_details_invalid_swim_image"),
                self.test_data.get(
                    "import_software_image_via_url_invalid_swim_image"),
            ...
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_software_image_details_image_distribution_failed"),
                self.test_data.get(
                    "get_device_list_image_distribution_failed"),
                self.test_data.get("get_site_image_distribution_failed"),
                self.test_data.get("get_membership_image_distribution_failed"),
                self.test_data.get(
                    "trigger_software_image_distribution_image_distribution_failed"),
                self.test_data.get(
                    "task_details_running_image_distribution_failed"),
            ...
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_software_image_details_swim_image_golden_tag"),
                self.test_data.get(
                ...
                self.test_data.get(
                    "tag_as_golden_image_swim_image_golden_tag"),
            ...
            self.run_dnac_exec.side_effect = [
                ...
                self.test_data.get(
                    "swim_image_golden_already_tagged_responce"),
            ]
        elif "playbook_swim_image_cant_found" in self._testMethodName:
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_software_image_details_swim_image_cant_found"),
            ...
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_site_image_details_distribution_not_provided"),
                self.test_data.get(
                    "distribution_failed_for_all_devicesresponse"),
            ]
            ...
            self.run_dnac_exec.side_effect = [
                ...
                self.test_data.get(
                    "import_software_image_via_url_remote_import"),
                self.test_data.get("Task_Details_start"),
                self.test_data.get("Task_Details_end"),
                self.test_data.get(
                    "get_software_image_details_remote_import_1"),
                self.test_data.get(
                    "get_software_image_details_remote_import_2"),
            ...
            self.run_dnac_exec.side_effect = [
                ...
                self.test_data.get(
                    "get_software_image_details_image_distribution_successfull"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull"),
                self.test_data.get(
                    "get_site_image_distribution_successfull_1"),
                self.test_data.get(
                    "get_membership_image_distribution_successfull"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull_1"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull_ep"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull_1"),
                self.test_data.get(
                    "trigger_software_image_distribution_image_distribution_successfull"),
                self.test_data.get(
                    "Task_Details_image_distribution_successfull_start"),
                self.test_data.get(
                    "Task_Details_image_distribution_successfull_end"),
                self.test_data.get(
                    "get_site_image_distribution_successfull_2"),
                self.test_data.get(
                    "get_software_image_details_image_distribution_successfull_1"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull_2"),
                self.test_data.get(
                    "get_software_image_details_image_distribution_successfull_2"),
            ...
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_sites_image_distribution_successfull_v2_3_7_6"),
                self.test_data.get(
                    "get_sites_image_distribution_successfull_v2_3_7_6_1"),
                self.test_data.get(
                    "get_software_image_details_image_distribution_successfull_v2_3_7_6"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull_v2_3_7_6"),
                self.test_data.get(
                    "get_sites_image_distribution_successfull_v2_3_7_6_2"),
                self.test_data.get(
                    "get_sites_image_distribution_successfull_v2_3_7_6_3"),
                self.test_data.get(
                    "get_site_assigned_network_devices_image_distribution_successfull_v2_3_7_6"),
                self.test_data.get(
                    "device_list_response_image_distribution_successfull_v2_3_7_6_1"),
                self.test_data.get(
                    "device_list_response_image_distribution_successfull_v2_3_7_6_2"),
                self.test_data.get(
                    "device_list_response_image_distribution_successfull_v2_3_7_6_3"),
                self.test_data.get(
                    "device_list_response_image_distribution_successfull_v2_3_7_6_4"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull_v2_3_7_6_1"),
                self.test_data.get(
                    "trigger_software_image_distribution_image_distribution_successfull_v2_3_7_6"),
                self.test_data.get(
                    "TaskDetails_image_distribution_successfull_v2_3_7_6"),
                self.test_data.get(
                    "TaskDetails_image_distribution_successfull_v2_3_7_6_1"),
                self.test_data.get(
                    "get_sites_image_distribution_successfull_v2_3_7_6_4"),
                self.test_data.get(
                    "get_sites_image_distribution_successfull_v2_3_7_6_5"),
                self.test_data.get(
                    "get_software_image_details_image_distribution_successfull_v2_3_7_6_1"),
                self.test_data.get(
                    "get_device_list_image_distribution_successfull_v2_3_7_6_2"),
                self.test_data.get(
                    "get_software_image_details_image_distribution_successfull_v2_3_7_6_2"),
                self.test_data.get(
                    "image_distribution_successfull_v2_3_7_6_responce"),
            ]
            ...
            self.run_dnac_exec.side_effect = [
                ...
                self.test_data.get(
                    "inheritted_tag_cannot_be_untagged_responce"),
            ]
        elif "playbook_import_cco_image" in self._testMethodName:
            self.run_dnac_exec.side_effect = [
                self.test_data.get(
                    "get_software_image_details_import_cco_image"),
                ...
                self.test_data.get(
                    "get_software_image_details_import_cco_image_1"),
                self.test_data.get(
                    "get_software_image_details_import_cco_image_2"),
