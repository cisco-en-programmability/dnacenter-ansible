...
.. _ansible_collections.cisco.dnac.lan_automation_status_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.lan_automation_status_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.lan_automation_status_info`.
...
.. _ansible_collections.cisco.dnac.lan_automation_status_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-limit:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-offset:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are lan\_automation.LanAutomation.lan\_automation\_status, lan\_automation.LanAutomation.lan\_automation\_status\_by\_id,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for LAN Automation LANAutomationStatus <https://developer.cisco.com/docs/dna-center/#!l-an-automation-status>`_
       Complete reference of the LANAutomationStatus API.
   `Cisco DNA Center documentation for LAN Automation LANAutomationStatusById <https://developer.cisco.com/docs/dna-center/#!l-an-automation-status-by-id>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.lan_automation_status_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": [{"action": "string", "creationTime": "string", "discoveredDeviceList": [{"ipAddressInUseList": ["string"], "name": "string", "serialNumber": "string", "state": "string"}], "discoveredDeviceSiteNameHierarchy": "string", "discoveryDevices": [{"deviceHostName": "string", "deviceManagementIPAddress": "string", "deviceSerialNumber": "string", "deviceSiteId": "string", "deviceSiteNameHierarchy": "string", "isDeviceDiscovered": true, "isIPAllocated": true, "isIPAssigned": true, "pnpDeviceId": "string"}], "discoveryLevel": 0, "discoveryTimeout": 0, "hostNameFileId": "string", "hostNamePrefix": "string", "id": "string", "ipPools": [{"ipPoolName": "string", "ipPoolRole": "string"}], "multicastEnabled": true, "peerDeviceManagmentIPAddress": "string", "primaryDeviceInterfaceNames": ["string"], "primaryDeviceManagmentIPAddress": "string", "redistributeIsisToBgp": true, "status": "string"}], "version": "string"}`
