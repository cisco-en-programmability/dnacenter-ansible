...
.. _ansible_collections.cisco.dnac.network_device_config_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.network_device_config_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.network_device_config_info`.
...
- Get Network Device Config by id. - \> Returns the config for all devices. This API has been deprecated and will not be available in a Cisco Catalyst Center release after Nov 1st 2024 23 59 59 GMT.
...
.. _ansible_collections.cisco.dnac.network_device_config_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-networkdeviceid:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are devices.Devices.get\_device\_config\_by\_id, devices.Devices.get\_device\_config\_for\_all\_devices,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Devices GetDeviceConfigById <https://developer.cisco.com/docs/dna-center/#!get-device-config-by-id>`_
       Complete reference of the GetDeviceConfigById API.
   `Cisco DNA Center documentation for Devices GetDeviceConfigForAllDevices <https://developer.cisco.com/docs/dna-center/#!get-device-config-for-all-devices>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_device_config_info_module__return-dnac_response:
