...
.. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.network_compliance_workflow_manager_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.network_compliance_workflow_manager`.
...
.. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config/ip_address_list:
    ...
    - .. raw:: html
      ...
      List of IP addresses of devices to run a compliance check on or synchronize device configurations. Either "ip\_address\_list" or "site\_name" is required for module to execute. If both "site\_name" and "ip\_address\_list" are provided, operations are performed on devices that are present in both the "ip\_address\_list" and the specified site. (e.g. ["204.1.2.2", "204.1.2.5", "204.1.2.4"])
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/run_compliance"></div>

      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config/run_compliance:
      ...
      **run_compliance**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/run_compliance" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      Determines if a full compliance check should be triggered on the devices specified in the "ip\_address\_list" and/or "site\_name". if it is True then compliance will be triggered for all categories. If it is False then compliance will be not be triggered even if run\_compliance categories are provided. Note - This operation cannot be performed on Access Points (APs) and if APs are provided, they will be skipped.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/run_compliance_batch_size"></div>

      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config/run_compliance_batch_size:
      ...
      **run_compliance_batch_size**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/run_compliance_batch_size" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/run_compliance_categories"></div>

      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config/run_compliance_categories:
      ...
      **run_compliance_categories**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/run_compliance_categories" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      Specifying compliance categories allows you to trigger compliance checks only for the mentioned categories. Category can have one or more values from among the options "INTENT", "RUNNING\_CONFIG", "IMAGE", "PSIRT", "EOX", "NETWORK\_SETTINGS". Category "INTENT" is mapped to compliance types "NETWORK\_SETTINGS", "NETWORK\_PROFILE", "WORKFLOW", "FABRIC", "APPLICATION\_VISIBILITY". If "run\_compliance" is False then compliance will be not be triggered even if "run\_compliance\_categories" are provided. (e.g. ["INTENT", "RUNNING\_CONFIG", "IMAGE", "PSIRT", "EOX", "NETWORK\_SETTINGS"])
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config/site_name:
    ...
    - .. raw:: html
      ...
      When "site\_name" is specified, the module executes the operation on all the devices located within the specified site. This is a string value that should represent the complete hierarchical path of the site. Either "site\_name" or "ip\_address\_list" is required for module to execute. If both "site\_name" and "ip\_address\_list" are provided, operations are performed on devices that are present in both the "ip\_address\_list" and the specified site. (e.g. "Global/USA/San Francisco/Building\_2/floor\_1")
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/sync_device_config"></div>

      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config/sync_device_config:
      ...
      **sync_device_config**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/sync_device_config" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      Determines whether to synchronize the device configuration on the devices specified in the "ip\_address\_list" and/or "site\_name". Sync device configuration, primarily addresses the status of the \`RUNNING\_CONFIG\`. If set to True, and if \`RUNNING\_CONFIG\` status is non-compliant this operation would commit device running configuration to startup by issuing "write memory" to device. Note - This operation cannot be performed on Access Points (APs) and if APs are provided, they will be skipped.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-config_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_api_task_timeout:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_log:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_log_append:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_log_file_path:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_log_level:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_task_poll_interval:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-state:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__parameter-validate_response_schema:
...
.. note::
   - SDK Methods used are compliance.Compliance.run\_compliance compliance.Compliance.commit\_device\_configuration task.Task.get\_task\_by\_id task.Task.get\_task\_details\_by\_id task.Task.get\_tasks compliance.Compliance.compliance\_details\_of\_device devices.Devices.get\_device\_list devices.Devices.get\_device\_by\_id site.Site.get\_site site.Site.get\_membership site\_design.Site\_design.get\_sites site\_design.Site\_design.get\_site\_assigned\_network\_devices
...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="return-sample_response_1"></div>

      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__return-sample_response_1:
      ...
      **sample_response_1**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#return-sample_response_1" title="Permalink to this return value"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__return-sample_response_2:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_compliance_workflow_manager_module__return-sample_response_3:
