...
.. _ansible_collections.cisco.dnac.license_status_info_module:
...
cisco.dnac.license_status_info module -- Information module for License Status
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.license_status_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.license_status_info`.
...
- Get all License Status. - \> Fetches registration status, authorization status and entitlements of the system with Cisco Smart Software Manage CSSM .
...
.. _ansible_collections.cisco.dnac.license_status_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are licenses.Licenses.system\_licensing\_status,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Licenses SystemLicensingStatus <https://developer.cisco.com/docs/dna-center/#!system-licensing-status>`_
       Complete reference of the SystemLicensingStatus API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.license_status_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": {"authorizationStatus": {"evaluationRemainderTimestamp": 0, "expiryTimestamp": 0, "lastAttemptFailReason": "string", "lastAttemptStatus": "string", "lastAttemptTimestamp": 0, "nextAttemptTimestamp": 0, "status": "string"}, "entitlements": [{"description": "string", "status": "string", "tag": "string", "usageCount": 0}], "exportControl": "string", "registrationStatus": {"expiryTimestamp": 0, "lastAttemptFailReason": "string", "lastAttemptStatus": "string", "lastAttemptTimestamp": 0, "nextAttemptTimestamp": 0, "status": "string"}, "smartAccountId": "string", "virtualAccountId": "string"}, "version": "string"}`
