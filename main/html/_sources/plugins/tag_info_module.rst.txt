...
.. _ansible_collections.cisco.dnac.tag_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.tag_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.tag_info`.
...
.. _ansible_collections.cisco.dnac.tag_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansibleOptionAnchor" id="parameter-additionalInfo_attributes"></div>

      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-additionalinfo_attributes:
      ...
      **additionalInfo_attributes**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-additionalInfo_attributes" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-additionalInfo_nameSpace"></div>

      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-additionalinfo_namespace:
      ...
      **additionalInfo_nameSpace**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-additionalInfo_nameSpace" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-field"></div>

      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-field:
      ...
      **field**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-field" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-level:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-limit:
    ...
    - .. raw:: html
      ...
      Limit query parameter. The number of tags to be retrieved. If not specified, the default is 500. The maximum allowed limit is 500.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-name:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-offset:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-size:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-sortby:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-systemTag"></div>

      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-systemtag:
      ...
      **systemTag**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-systemTag" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are tag.Tag.get\_tag, tag.Tag.get\_tag\_by\_id,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Tag GetTag <https://developer.cisco.com/docs/dna-center/#!get-tag>`_
       Complete reference of the GetTag API.
   `Cisco DNA Center documentation for Tag GetTagById <https://developer.cisco.com/docs/dna-center/#!get-tag-by-id>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.tag_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": {"description": "string", "dynamicRules": [{"memberType": "string", "rules": {"items": ["string"], "name": "string", "operation": "string", "value": "string", "values": ["string"]}}], "id": "string", "instanceTenantId": "string", "name": "string", "systemTag": true}, "version": "string"}`
