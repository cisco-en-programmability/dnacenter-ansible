...
.. _ansible_collections.cisco.dnac.discoverys_jobs_module:
...
cisco.dnac.discoverys_jobs module -- Resource module for Discoverys Jobs
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.discoverys_jobs_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.discoverys_jobs`.
...
- Manage operation create of the resource Discoverys Jobs. - \> This API starts a discovery job using the given discovery id. The response includes a task url that provides access to the task's details. By accessing this URL, users will receive a response containing a resultLocation attribute, which provides details of the discovery job that was started, including the jobId. A new discovery job is created every time this API is triggered.
...
.. _ansible_collections.cisco.dnac.discoverys_jobs_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are devices.Devices.starts\_the\_existing\_discovery,
   - Paths used are post /dna/intent/api/v1/discoverys/{id}/jobs,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Devices StartsTheExistingDiscovery <https://developer.cisco.com/docs/dna-center/#!starts-the-existing-discovery>`_
       Complete reference of the StartsTheExistingDiscovery API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_module__return-dnac_response:
