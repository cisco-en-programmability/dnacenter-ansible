...
.. _ansible_collections.cisco.dnac.pnp_device_unclaim_module:
...
cisco.dnac.pnp_device_unclaim -- Manage PnpDeviceUnclaim objects of DeviceOnboardingPnp
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.pnp_device_unclaim`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-deviceIdList"></div>
                    <b>deviceIdList</b>
                    <a class="ansibleOptionLink" href="#parameter-deviceIdList" title="Permalink to this option"></a>
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>UnclaimRequest&#x27;s deviceIdList (list of strings).</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.pnp_device_unclaim <ansible_collections.cisco.dnac.plugins.module_utils.definitions.pnp_device_unclaim_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.pnp_device_unclaim** module.
   `PnpDeviceUnclaim reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the PnpDeviceUnclaim object model.
   `PnpDeviceUnclaim reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">device_onboarding_pnp.un_claim_device</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
