...
.. _ansible_collections.cisco.dnac.global_credential_module:
...
cisco.dnac.global_credential -- Manage GlobalCredential objects of Discovery
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.global_credential`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-credential_sub_type"></div>
                    <b>credential_sub_type</b>
                    <a class="ansibleOptionLink" href="#parameter-credential_sub_type" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Credential type as CLI / SNMPV2_READ_COMMUNITY / SNMPV2_WRITE_COMMUNITY / SNMPV3 / HTTP_WRITE / HTTP_READ / NETCONF.</div>
                                            <div>Required for state query.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-global_credential_id"></div>
                    <b>global_credential_id</b>
                    <a class="ansibleOptionLink" href="#parameter-global_credential_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>ID of global-credential.</div>
                                            <div>Global credential Uuid.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>SitesInfoDTO&#x27;s siteUuids (list of strings).</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.global_credential <ansible_collections.cisco.dnac.plugins.module_utils.definitions.global_credential_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.global_credential** module.
   `GlobalCredential reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the GlobalCredential object model.
   `GlobalCredential reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">discovery.delete_global_credentials_by_id</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
