...
.. _ansible_collections.cisco.dnac.sda_device_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.sda_device`.
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.sda_device <ansible_collections.cisco.dnac.plugins.module_utils.definitions.sda_device_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.sda_device** module.
   `SdaDevice reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SdaDevice object model.
   `SdaDevice reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sda.get_device_info</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
