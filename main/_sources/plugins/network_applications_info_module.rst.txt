...
.. _ansible_collections.cisco.dnac.network_applications_info_module:
...
cisco.dnac.network_applications_info module -- Information module for Network Applications
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.network_applications_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.network_applications_info`.
...
.. _ansible_collections.cisco.dnac.network_applications_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansibleOptionAnchor" id="parameter-applicationName"></div>

      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-applicationname:
      ...
      **applicationName**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-applicationName" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      ApplicationName query parameter. Name of the application for which the experience data is intended. Examples \`applicationName=webex\` (single applicationName requested) \`applicationName=webex&applicationName=teams\` (multiple applicationName requested).
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-attribute:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-businessRelevance"></div>

      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-businessrelevance:
      ...
      **businessRelevance**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-businessRelevance" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      BusinessRelevance query parameter. The application can be chosen to be categorized as business-relevant, irrelevant, or default (neutral). By doing so, the assurance application prioritizes the monitoring and analysis of business-relevant data, ensuring critical insights are captured. Applications marked as irrelevant or default are selectively excluded from certain data sets, streamlining focus on what's most important for business outcomes.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-endtime:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-limit:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-offset:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-siteid:
    ...
    - .. raw:: html
      ...
      SiteId query parameter. The site UUID without the top level hierarchy. \`siteId\` is mandatory. \`siteId\` must be a site UUID of a building. (Ex."buildingUuid") Examples \`siteId=buildingUuid\` (single siteId requested) \`siteId=buildingUuid1&siteId=buildingUuid2\` (multiple siteId requested).
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-sortby:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-ssid:
    ...
    - .. raw:: html
      ...
      Ssid query parameter. In the context of a network application, SSID refers to the name of the wireless network to which the client connects. Examples \`ssid=Alpha\` (single ssid requested) \`ssid=Alpha&ssid=Guest\` (multiple ssid requested).
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-starttime:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are applications.Applications.retrieves\_the\_list\_of\_network\_applications\_along\_with\_experience\_and\_health\_metrics,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Applications RetrievesTheListOfNetworkApplicationsAlongWithExperienceAndHealthMetrics <https://developer.cisco.com/docs/dna-center/#!retrieves-the-list-of-network-applications-along-with-experience-and-health-metrics>`_
       Complete reference of the RetrievesTheListOfNetworkApplicationsAlongWithExperienceAndHealthMetrics API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.network_applications_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"page": {"count": 0, "limit": 0, "offset": 0, "sortBy": [{"name": "string", "order": "string"}]}, "response": [{"applicationName": "string", "applicationServerLatency": 0, "businessRelevance": "string", "clientNetworkLatency": 0, "exporterIpAddress": "string", "exporterNetworkDeviceId": "string", "healthScore": 0, "id": "string", "jitter": 0, "networkLatency": 0, "packetLossPercent": 0, "serverNetworkLatency": 0, "siteId": "string", "ssid": "string", "throughput": 0, "trafficClass": "string", "usage": 0}], "version": "string"}`
