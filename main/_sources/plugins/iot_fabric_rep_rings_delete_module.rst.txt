...
.. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module:
...
cisco.dnac.iot_fabric_rep_rings_delete module -- Resource module for Iot Fabric Rep Rings Delete
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.iot_fabric_rep_rings_delete`.
...
- Manage operation delete of the resource Iot Fabric Rep Rings Delete. - \> This API deletes the REP ring configured in the FABRIC deployment for the given id. The id of configured REP ring can be retrieved using the API /dna/intent/api/v1/iot/repRings/query.The taskid returned can be used to monitor the status of delete operation using following API -/intent/api/v1/task/{taskId}.
...
.. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are industrial\_configuration.IndustrialConfiguration.delete\_r\_e\_p\_ring\_configured\_in\_the\_f\_a\_b\_r\_i\_c\_deployment,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Industrial Configuration DeleteREPRingConfiguredInTheFABRICDeployment <https://developer.cisco.com/docs/dna-center/#!delete-rep-ring-configured-in-the-fabric-deployment>`_
       Complete reference of the DeleteREPRingConfiguredInTheFABRICDeployment API.
...
.. code-block:: yaml+jinja
    ...
    ---
    - name: Delete by id
      cisco.dnac.iot_fabric_rep_rings_delete:
        dnac_host: "{{dnac_host}}"
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.iot_fabric_rep_rings_delete_module__return-dnac_response:
