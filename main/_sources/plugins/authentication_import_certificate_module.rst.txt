...
.. _ansible_collections.cisco.dnac.authentication_import_certificate_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.authentication_import_certificate_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.authentication_import_certificate`.
...
.. _ansible_collections.cisco.dnac.authentication_import_certificate_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-certfilepath:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-dnac_version:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-listOfUsers"></div>

      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-listofusers:
      ...
      **listOfUsers**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-listOfUsers" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      ListOfUsers query parameter. Specify whether the certificate will be used for controller ("server"), disaster recovery ("ipsec") or both ("server, ipsec"). If no value is provided, the default value taken will be "server".
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-pkFilePath"></div>

      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-pkfilepath:
      ...
      **pkFilePath**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-pkFilePath" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-pkPassword"></div>

      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-pkpassword:
      ...
      **pkPassword**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-pkPassword" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      PkPassword query parameter. Password for encrypted private key.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are authentication\_management.AuthenticationManagement.import\_certificate,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Authentication Management ImportCertificate <https://developer.cisco.com/docs/dna-center/#!import-certificate>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.authentication_import_certificate_module__return-dnac_response:
