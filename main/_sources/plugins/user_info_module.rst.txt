...
.. _ansible_collections.cisco.dnac.user_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.user_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.user_info`.
...
.. _ansible_collections.cisco.dnac.user_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansibleOptionAnchor" id="parameter-authSource"></div>

      .. _ansible_collections.cisco.dnac.user_info_module__parameter-authsource:
      ...
      **authSource**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-authSource" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      AuthSource query parameter. The source that authenticates the user. The value of this query parameter can be set to "internal" or "external". If not provided, then all users will be returned in the response.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are userand\_roles.UserandRoles.get\_users,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for User and Roles GetUsers <https://developer.cisco.com/docs/dna-center/#!get-users>`_
       Complete reference of the GetUsers API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.user_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"users": [{"authSource": "string", "email": "string", "firstName": "string", "lastName": "string", "passphraseUpdateTime": "string", "rds": ["string"], "roleList": ["string"], "userId": "string", "username": "string"}]}`
