...
.. _ansible_collections.cisco.dnac.sda_edge_device_module:
...
cisco.dnac.sda_edge_device -- Manage SdaEdgeDevice objects of Sda
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.sda_edge_device`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-device_ipaddress"></div>
                    <b>device_ipaddress</b>
                    <a class="ansibleOptionLink" href="#parameter-device_ipaddress" title="Permalink to this option"></a>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda edge device&#x27;s deviceManagementIpAddress.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the sda edge device&#x27;s siteNameHierarchy.</div>
                                                        </td>
            </tr>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.sda_edge_device <ansible_collections.cisco.dnac.plugins.module_utils.definitions.sda_edge_device_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.sda_edge_device** module.
   `SdaEdgeDevice reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SdaEdgeDevice object model.
   `SdaEdgeDevice reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sda.add_edge_device</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
