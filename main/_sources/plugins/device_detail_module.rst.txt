...
.. _ansible_collections.cisco.dnac.device_detail_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.device_detail`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>One of keywords macAddress or uuid or nwDeviceName.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-search_by"></div>
                    <b>search_by</b>
                    <a class="ansibleOptionLink" href="#parameter-search_by" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                 / <span style="color: red">required</span>                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>MAC Address or Device Name value or UUID of the network device.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Epoch time(in milliseconds) when the device data is required.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.device_detail <ansible_collections.cisco.dnac.plugins.module_utils.definitions.device_detail_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.device_detail** module.
   `DeviceDetail reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the DeviceDetail object model.
   `DeviceDetail reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">devices.get_device_detail</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
