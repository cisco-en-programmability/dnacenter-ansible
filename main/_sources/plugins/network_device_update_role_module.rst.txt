...
.. _ansible_collections.cisco.dnac.network_device_update_role_module:
...
cisco.dnac.network_device_update_role -- Manage NetworkDeviceUpdateRole objects of Devices
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.network_device_update_role`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>NetworkDeviceBriefNIO&#x27;s id.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>NetworkDeviceBriefNIO&#x27;s role.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-roleSource"></div>
                    <b>roleSource</b>
                    <a class="ansibleOptionLink" href="#parameter-roleSource" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                 / <span style="color: red">required</span>                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>NetworkDeviceBriefNIO&#x27;s roleSource.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.network_device_update_role <ansible_collections.cisco.dnac.plugins.module_utils.definitions.network_device_update_role_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.network_device_update_role** module.
   `NetworkDeviceUpdateRole reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the NetworkDeviceUpdateRole object model.
   `NetworkDeviceUpdateRole reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">devices.update_device_role</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
