...
.. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.disasterrecovery_system_status_info`.
...
.. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are disaster\_recovery.DisasterRecovery.disaster\_recovery\_status,
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.disasterrecovery_system_status_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"ipconfig": [{"interface": "string", "ip": "string", "vip": true}], "ipsec-tunnel": [{"side\_a": "string", "side\_b": "string", "status": "string"}], "main": {"ipconfig": [{"interface": "string", "ip": "string", "vip": true}], "nodes": [{"hostname": "string", "ipaddresses": [{"interface": "string", "ip": "string", "vip": true}], "state": "string"}], "state": "string"}, "recovery": {"ipconfig": [{"interface": "string", "ip": "string", "vip": true}], "nodes": [{"hostname": "string", "ipconfig": [{"interface": "string", "ip": "string", "vip": true}], "state": "string"}], "state": "string"}, "site": "string", "state": "string", "witness": {"ipconfig": [{"interface": "string", "ip": "string", "vip": true}], "nodes": [{"hostname": "string", "ipconfig": [{"interface": "string", "ip": "string", "vip": true}], "state": "string"}], "state": "string"}}`
