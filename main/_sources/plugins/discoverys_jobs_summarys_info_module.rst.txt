...
.. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module:
...
cisco.dnac.discoverys_jobs_summarys_info module -- Information module for Discoverys Jobs Summarys
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.discoverys_jobs_summarys_info`.
...
- Get all Discoverys Jobs Summarys. - \> API to fetch the summary of all discoveries. The response includes the basic details of all discoveries, latest job status and the number of reachable devices.
...
.. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are devices.Devices.fetches\_the\_summary\_of\_all\_discoveries\_with\_latest\_jobs,
   - Paths used are get /dna/intent/api/v1/discoverys/jobs/summarys,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Devices FetchesTheSummaryOfAllDiscoveriesWithLatestJobs <https://developer.cisco.com/docs/dna-center/#!fetches-the-summary-of-all-discoveries-with-latest-jobs>`_
       Complete reference of the FetchesTheSummaryOfAllDiscoveriesWithLatestJobs API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.discoverys_jobs_summarys_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": {"credentials": {"cli": {"description": "string", "globalCredentialIdList": ["string"], "protocolOrder": "string", "username": "string"}, "httpRead": {"description": "string", "globalCredentialIdList": ["string"], "port": 0, "protocol": "string", "username": "string"}, "httpWrite": {"description": "string", "globalCredentialIdList": ["string"], "port": 0, "protocol": "string", "username": "string"}, "netconf": {"description": "string", "globalCredentialIdList": ["string"], "port": 0}, "snmp": {"retries": 0, "snmpV2Read": {"description": "string", "globalCredentialIdList": ["string"]}, "snmpV2Write": {"description": "string", "globalCredentialIdList": ["string"]}, "snmpV3": {"authType": "string", "description": "string", "globalCredentialIdList": ["string"], "mode": "string", "privacyType": "string", "username": "string"}, "timeout": 0}}, "discoveryTypeDetails": {"cidrAddress": {"cidrPrefix": "string", "cidrSuffix": 0}, "hopCount": 0, "ipAddress": "string", "range": [{"ipAddressEnd": "string", "ipAddressStart": "string"}], "subnetFilter": {"cidrAddress": {"cidrPrefix": "string", "cidrSuffix": 0}, "ipAddress": "string"}, "type": "string"}, "managementIpSelectionMethod": "string", "name": "string", "onlyNewDevice": true, "updateManagementIp": true}, "version": "string"}`
