...
.. _ansible_collections.cisco.dnac.import_image_file_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.import_image_file`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The filename (with its extension, for example, test.zip).</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The full path of a file. The file is opened with rb flag.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-is_third_party"></div>
                    <b>is_third_party</b>
                    <a class="ansibleOptionLink" href="#parameter-is_third_party" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Third party Image check.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-third_party_application_type"></div>
                    <b>third_party_application_type</b>
                    <a class="ansibleOptionLink" href="#parameter-third_party_application_type" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>Third Party Application Type.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-third_party_image_family"></div>
                    <b>third_party_image_family</b>
                    <a class="ansibleOptionLink" href="#parameter-third_party_image_family" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>Third Party image family.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-third_party_vendor"></div>
                    <b>third_party_vendor</b>
                    <a class="ansibleOptionLink" href="#parameter-third_party_vendor" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.import_image_file <ansible_collections.cisco.dnac.plugins.module_utils.definitions.import_image_file_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.import_image_file** module.
   `ImportImageFile reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the ImportImageFile object model.
   `ImportImageFile reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">software_image_management_swim.import_local_software_image</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
