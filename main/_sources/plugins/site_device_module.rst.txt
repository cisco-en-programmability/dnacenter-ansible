...
.. _ansible_collections.cisco.dnac.site_device_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.site_device`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the site device&#x27;s ip.</div>
                                                        </td>
            </tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Site id to which site the device to assign.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.site_device <ansible_collections.cisco.dnac.plugins.module_utils.definitions.site_device_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.site_device** module.
   `SiteDevice reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SiteDevice object model.
   `SiteDevice reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sites.assign_device_to_site</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
