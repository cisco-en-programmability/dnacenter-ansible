...
.. _ansible_collections.cisco.dnac.maps_import_status_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.maps_import_status_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.maps_import_status_info`.
...
.. _ansible_collections.cisco.dnac.maps_import_status_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-headers:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-importContextUuid"></div>

      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-importcontextuuid:
      ...
      **importContextUuid**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-importContextUuid" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      ImportContextUuid path parameter. The unique import context UUID given by a previous and recent call to maps/import/start API.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are sites.Sites.import\_map\_archive\_import\_status,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Sites ImportMapArchiveImportStatus <https://developer.cisco.com/docs/dna-center/#!import-map-archive-import-status>`_
       Complete reference of the ImportMapArchiveImportStatus API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.maps_import_status_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"auditLog": {"children": ["string"], "entitiesCount": [{"key": 0}], "entityName": "string", "entityType": "string", "errorEntitiesCount": [{"key": 0}], "errors": [{"message": "string"}], "infos": [{"message": "string"}], "matchingEntitiesCount": [{"key": 0}], "subTasksRootTaskId": "string", "successfullyImportedFloors": ["string"], "warnings": [{"message": "string"}]}, "status": "string", "uuid": {"leastSignificantBits": 0, "mostSignificantBits": 0}}`
