...
.. _ansible_collections.cisco.dnac.nfv_provision_detail_module:
...
cisco.dnac.nfv_provision_detail -- Manage NfvProvisionDetail objects of SiteDesign
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.nfv_provision_detail`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Device Ip, property of the request body.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.nfv_provision_detail <ansible_collections.cisco.dnac.plugins.module_utils.definitions.nfv_provision_detail_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.nfv_provision_detail** module.
   `NfvProvisionDetail reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the NfvProvisionDetail object model.
   `NfvProvisionDetail reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">site_design.nfv_provisioning_detail</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
