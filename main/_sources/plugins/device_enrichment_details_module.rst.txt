...
.. _ansible_collections.cisco.dnac.device_enrichment_details_module:
...
cisco.dnac.device_enrichment_details -- Manage DeviceEnrichmentDetails objects of Devices
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.device_enrichment_details`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Adds the header parameters.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.device_enrichment_details <ansible_collections.cisco.dnac.plugins.module_utils.definitions.device_enrichment_details_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.device_enrichment_details** module.
   `DeviceEnrichmentDetails reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the DeviceEnrichmentDetails object model.
   `DeviceEnrichmentDetails reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">devices.get_device_enrichment_details</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
