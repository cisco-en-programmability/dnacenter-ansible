...
.. _ansible_collections.cisco.dnac.site_membership_module:
...
cisco.dnac.site_membership -- Manage SiteMembership objects of Sites
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.site_membership`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Site id to retrieve device associated with the site.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.site_membership <ansible_collections.cisco.dnac.plugins.module_utils.definitions.site_membership_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.site_membership** module.
   `SiteMembership reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the SiteMembership object model.
   `SiteMembership reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sites.get_membership</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
