...
.. _ansible_collections.cisco.dnac.trigger_image_distribution_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.trigger_image_distribution`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the trigger image distribution&#x27;s deviceUuid.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>It is the trigger image distribution&#x27;s imageUuid.</div>
                                                        </td>
            </tr>
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.trigger_image_distribution <ansible_collections.cisco.dnac.plugins.module_utils.definitions.trigger_image_distribution_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.trigger_image_distribution** module.
   `TriggerImageDistribution reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the TriggerImageDistribution object model.
   `TriggerImageDistribution reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">software_image_management_swim.trigger_software_image_distribution</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
