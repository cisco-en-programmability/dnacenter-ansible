...
.. _ansible_collections.cisco.dnac.user_enrichment_details_module:
...
cisco.dnac.user_enrichment_details -- Manage UserEnrichmentDetails objects of Users
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`cisco.dnac.user_enrichment_details`.
...
.. seealso::
   ...
   :ref:`cisco.dnac.plugins.module_utils.definitions.user_enrichment_details <ansible_collections.cisco.dnac.plugins.module_utils.definitions.user_enrichment_details_module>`
      The official documentation on the **cisco.dnac.plugins.module_utils.definitions.user_enrichment_details** module.
   `UserEnrichmentDetails reference <https://developer.cisco.com/docs/dna-center/api/1-3-3-x>`_
       Complete reference of the UserEnrichmentDetails object model.
   `UserEnrichmentDetails reference <https://dnacentersdk.readthedocs.io/en/latest/api/api.html#v2-1-1-summary>`_
       SDK reference.
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">users.get_user_enrichment_details</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
