...
.. _ansible_collections.cisco.dnac.auth_token_create_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.auth_token_create_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.auth_token_create`.
...
- Manage operation create of the resource Auth Token Create. - \> API to obtain an access token, which remains valid for 1 hour. The token obtained using this API is required to be set as value to the X-Auth-Token HTTP Header for all API calls to System.
...
.. _ansible_collections.cisco.dnac.auth_token_create_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are authentication.Authentication.authentication\_api,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Authentication AuthenticationAPI <https://developer.cisco.com/docs/dna-center/#!authentication-api>`_
       Complete reference of the AuthenticationAPI API.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.auth_token_create_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"Token": "string"}`
