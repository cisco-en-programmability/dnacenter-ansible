...
.. _ansible_collections.cisco.dnac.backup_restore_executions_info_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.backup_restore_executions_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.backup_restore_executions_info`.
...
.. _ansible_collections.cisco.dnac.backup_restore_executions_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansibleOptionAnchor" id="parameter-backupId"></div>

      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-backupid:
      ...
      **backupId**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-backupId" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-id:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-jobType"></div>

      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-jobtype:
      ...
      **jobType**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-jobType" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      JobType query parameter. Execution type of the backup workflow. If the workflow is \`Create Backup\` The jobType is \`CREATE\_BACKUP\`. If the workflow is \`Delete Backup\` The jobType is \`DELETE\_BACKUP\`. If the workflow is \`Restore Backup\` The jobType is \`RESTORE\_BACKUP\`.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-limit:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-offset:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-sortby:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-status:
    ...
    - .. raw:: html
      ...
      Status query parameter. Execution status of the workflow.If the workflow execution has started, the status is \`IN\_PROGRESS\`.If the workflow execution has completed, the status is \`SUCCESS\`.If the workflow execution has failed, the status is \`FAILED\`.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are backup.Backup.get\_backup\_and\_restore\_execution, backup.Backup.get\_backup\_and\_restore\_executions,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Backup GetBackupAndRestoreExecution <https://developer.cisco.com/docs/dna-center/#!get-backup-and-restore-execution>`_
       Complete reference of the GetBackupAndRestoreExecution API.
   `Cisco DNA Center documentation for Backup GetBackupAndRestoreExecutions <https://developer.cisco.com/docs/dna-center/#!get-backup-and-restore-executions>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.backup_restore_executions_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": {"\_metadata": {}, "backupId": "string", "completedPercentage": 0, "createdBy": "string", "duration": 0, "endDate": "string", "errorCode": "string", "errorMessage": "string", "failedTaskDetail": {}, "id": "string", "isForceUpdate": true, "jobType": "string", "scope": "string", "startDate": "string", "status": "string", "systemErrorMessage": "string", "tasks": [{"endDate": "string", "errorCode": "string", "failedTaskDetail": {}, "id": "string", "message": "string", "startDate": "string", "status": "string", "systemErrorMessage": "string", "taskName": "string"}], "updateMessage": "string"}, "version": "string"}`
