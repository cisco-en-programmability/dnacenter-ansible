...
.. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module:
...
cisco.dnac.ipam_site_ip_address_pools_info module -- Information module for Ipam Site Ip Address Pools
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.ipam_site_ip_address_pools_info`.
...
.. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-headers:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-limit:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-offset:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-siteid:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-sortby:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__parameter-validate_response_schema:
...
.. note::
   - SDK Method used are network\_settings.NetworkSettings.retrieves\_an\_ip\_address\_subpool, network\_settings.NetworkSettings.retrieves\_ip\_address\_subpools,
...
.. seealso::
   ...
   `Cisco DNA Center documentation for Network Settings RetrievesAnIPAddressSubpool <https://developer.cisco.com/docs/dna-center/#!retrieves-an-ip-address-subpool>`_
       Complete reference of the RetrievesAnIPAddressSubpool API.
   `Cisco DNA Center documentation for Network Settings RetrievesIPAddressSubpools <https://developer.cisco.com/docs/dna-center/#!retrieves-ip-address-subpools>`_
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.ipam_site_ip_address_pools_info_module__return-dnac_response:
    ...
    - .. raw:: html
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"response": {"id": "string", "ipV4AddressSpace": {"addressSpaceId": "string", "assignedAddresses": "string", "defaultAssignedAddresses": "string", "dhcpServers": ["string"], "dnsServers": ["string"], "gatewayIpAddress": "string", "globalPoolId": "string", "overlapping": true, "prefixLength": 0, "slaacSupport": true, "subnet": "string", "totalAddresses": "string", "unassignableAddresses": "string"}, "ipV6AddressSpace": {"addressSpaceId": "string", "assignedAddresses": "string", "defaultAssignedAddresses": "string", "dhcpServers": ["string"], "dnsServers": ["string"], "gatewayIpAddress": "string", "globalPoolId": "string", "overlapping": true, "prefixLength": 0, "slaacSupport": true, "subnet": "string", "totalAddresses": "string", "unassignableAddresses": "string"}, "name": "string", "poolType": "string", "siteId": "string", "siteName": "string"}, "version": "string"}`
