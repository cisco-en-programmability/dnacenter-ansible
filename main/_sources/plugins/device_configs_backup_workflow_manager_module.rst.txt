...
.. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module:
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module_requirements>` for details.

    To use it in a playbook, specify: :code:`cisco.dnac.device_configs_backup_workflow_manager`.
...
.. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module_requirements:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config:
    ...
    - .. raw:: html
      ...
      When providing multiple parameters at once (excluding "site\_list"), all the filters will be applied together in an AND operation. This means that only the devices matching all the specified criteria will be included in the configuration backup operation. For example, if both \`hostname\` and \`device\_type\` are provided, only devices matching both the specified hostname and device type will be selected.
  ...
  * - .. raw:: html
        ...
        <div class="ansibleOptionAnchor" id="parameter-config/collection_status_list"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/collection_status_list:
      ...
      **collection_status_list**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/collection_status_list" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/config_file_types"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/config_file_types:
      ...
      **config_file_types**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/config_file_types" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      If this parameter is not specified, all available configuration types will be downloaded for the selected devices by default.
      ...
      - :ansible-option-choices-entry:`"STARTUPCONFIG"`
      - :ansible-option-choices-entry:`"RUNNINGCONFIG"`
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/family_list"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/family_list:
      ...
      **family_list**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/family_list" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/file_password"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/file_password:
      ...
      **file_password**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/file_password" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/file_path:
    ...
    - .. raw:: html
      ...
      If the "file\_path" is not provided, the backup file(s) will be stored in a directory named "tmp" in the same directory as the playbook.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/hostname_list:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/ip_address_list:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/mac_address_list:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/serial_number_list:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/series_list"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/series_list:
      ...
      **series_list**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/series_list" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/site_list"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/site_list:
      ...
      **site_list**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/site_list" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      For example - ["Global/USA/San Francisco/Building\_2/floor\_1", "Global/USA/New York/Building\_3/floor\_2"]

      Note -  When additional parameters are provided along with \`site\_list\`, the operation will include all devices in the specified site(s) and any devices matching the additional criteria (excluding \`site\_list\`). In other words, the operation will be performed on devices within the site(s) and those that meet the additional criteria.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/type_list"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/type_list:
      ...
      **type_list**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/type_list" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-config/unzip_backup"></div>

      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config/unzip_backup:
      ...
      **unzip_backup**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-config/unzip_backup" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-config_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_api_task_timeout:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_debug:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_host:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_log:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_log_append:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_log_file_path:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_log_level:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_task_poll_interval:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_username:
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-user:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_verify:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-dnac_version:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-state:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__parameter-validate_response_schema:
...
.. note::
   - SDK Methods used are sites.Sites.get\_site Site\_design.Site\_design.get\_sites sites.Sites.get\_membership site\_design.Site\_design.get\_site\_assigned\_network\_devices devices.Devices.get\_device\_list devices.Devices.get\_device\_by\_id configuration\_archive.ConfigurationsArchive.export\_device\_configurations configuration\_archive.ConfigurationsArchive.download\_unmaskedraw\_device\_configuration\_as\_zip configuration\_archive.ConfigurationsArchive.download\_masked\_device\_configuration configuration\_archive.ConfigurationsArchive.get\_network\_device\_configuration\_file\_details file.Files.download\_a\_file\_by\_fileid
   - Paths used are get /dna/intent/api/v1/site get /dna/intent/api/v1/membership/${siteId} get /dna/intent/api/v1/network-device post /dna/intent/api/v1/network-device-archive/cleartext get /dna/intent/api/v1/file/${fileId} get /dna/intent/api/v1/networkDevices/assignedToSite get /dna/intent/api/v1/sites get /dna/intent/api/v1/network-device/${id} get /dna/intent/api/v1/network-device get /dna/intent/api/v1/networkDeviceConfigFiles post /dna/intent/api/v1/network-device post dna/intent/api/v1/networkDeviceConfigFiles/${id}/downloadMasked post /dna/intent/api/v1/network-device post dna/intent/api/v1/networkDeviceConfigFiles/${id}/downloadUnMasked
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__return-response_1:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.cisco.dnac.device_configs_backup_workflow_manager_module__return-response_2:
