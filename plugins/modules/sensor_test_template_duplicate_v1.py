...
DOCUMENTATION = r"""
---
module: sensor_test_template_duplicate_v1
short_description: Resource module for Sensor Test Template Duplicate V1
description:
  - Manage operation update of the resource Sensor Test Template Duplicate V1.
...
notes:
  - SDK Method used are sensors.Sensors.duplicate_sensor_test_template_v1,
  - Paths used are put /dna/intent/api/v1/sensorTestTemplate,
"""
EXAMPLES = r"""
- name: Update all
  cisco.dnac.sensor_test_template_duplicate_v1:
    dnac_host: "{{dnac_host}}"
