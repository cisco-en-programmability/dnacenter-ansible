...
DOCUMENTATION = r"""
---
module: security_service_insertions_v1
short_description: Resource module for Security Service Insertions V1
description:
  - Manage operation create of the resource Security Service Insertions V1.
  - >
    Enables Security Service Insertion SSI on a fabric site within a network. Security
    Service Insertion allows the
    integration of security services, such as firewalls, into the fabric network,
    ensuring that traffic within Virtual
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.security_service_insertions_v1:
    dnac_host: "{{dnac_host}}"
