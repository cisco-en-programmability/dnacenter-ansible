...
DOCUMENTATION = r"""
---
module: license_device_license_summary_v1_info
short_description: Information module for License Device License Summary V1
description:
- Get all License Device License Summary V1.
...
options:
  ...
  limit:
    description:
    - >
      Limit query parameter. Specifies the maximum number of device license summaries to return per page. Must be
...
EXAMPLES = r"""
- name: Get all License Device License Summary V1
  cisco.dnac.license_device_license_summary_v1_info:
    dnac_host: "{{dnac_host}}"
