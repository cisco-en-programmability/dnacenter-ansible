...
DOCUMENTATION = r"""
---
module: sites_site_id_wireless_settings_flex_connect_native_vlan_v1
...
description:
  - Manage operations update and delete of the resource Sites Site Id Wireless Settings
    Flex Connect Native Vlan V1.
  - This API allows the user to delete a Native VLAN setting at the given site level.
  - >
    This API allows the user to update an existing Native VLAN setting at the given
    site level. The default value of
...
EXAMPLES = r"""
- name: Update all
  cisco.dnac.sites_site_id_wireless_settings_flex_connect_native_vlan_v1:
    dnac_host: "{{dnac_host}}"
