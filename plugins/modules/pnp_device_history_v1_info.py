...
DOCUMENTATION = r"""
---
module: pnp_device_history_v1_info
short_description: Information module for Pnp Device History V1
description:
  - Get all Pnp Device History V1.
...
"""
EXAMPLES = r"""
- name: Get all Pnp Device History V1
  cisco.dnac.pnp_device_history_v1_info:
    dnac_host: "{{dnac_host}}"
