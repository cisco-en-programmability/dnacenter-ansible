...
DOCUMENTATION = r"""
---
module: images_id_sites_site_id_untag_golden_v1
short_description: Resource module for Images Id Sites Site Id Untag Golden V1
description:
- Manage operation create of the resource Images Id Sites Site Id Untag Golden V1.
- >
   Untag the golden images specifically designed for a particular device type or supervisor engine module. Conditions
   for untagging the golden image.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.images_id_sites_site_id_untag_golden_v1:
    dnac_host: "{{dnac_host}}"
