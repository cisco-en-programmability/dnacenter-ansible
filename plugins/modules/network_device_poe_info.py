...
- name: SDK function poe_details used
  link: https://dnacentersdk.rtfd.io/en/latest/api/api.html#dnacentersdk.api.v2_2_3_3.devices.Devices.poe_details

- name: Paths used on the module Network Device Poe
  description: |-
