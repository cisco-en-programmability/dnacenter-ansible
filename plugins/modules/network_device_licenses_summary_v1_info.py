...
DOCUMENTATION = r"""
---
module: network_device_licenses_summary_v1_info
short_description: Information module for Network Device Licenses Summary V1
description:
  - Get all Network Device Licenses Summary V1.
  - >
    Retrieves the summary of consumed network, DNA, and Cisco Networking Subscription
    CNS licenses, along with the
    counts of unregistered and out-of-compliance network devices, and expired and
    expiring network device licenses.
...
"""
EXAMPLES = r"""
- name: Get all Network Device Licenses Summary V1
  cisco.dnac.network_device_licenses_summary_v1_info:
    dnac_host: "{{dnac_host}}"
