...
DOCUMENTATION = r"""
---
module: activities_count_v1_info
short_description: Information module for Activities Count V1
description:
  - Get all Activities Count V1.
...
"""
EXAMPLES = r"""
- name: Get all Activities Count V1
  cisco.dnac.activities_count_v1_info:
    dnac_host: "{{dnac_host}}"
