...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_rrm_general_configurations_id_v1
...
description:
  - Manage operations update and delete of the resource Feature Templates Wireless
    Rrm General Configurations Id V1.
  - This API allows users to delete a specific RRM General configuration feature template
    by ID.
  - This API allows users to update the details of a specific RRM General configuration
...
EXAMPLES = r"""
- name: Delete by id
  cisco.dnac.feature_templates_wireless_rrm_general_configurations_id_v1:
    dnac_host: "{{dnac_host}}"
