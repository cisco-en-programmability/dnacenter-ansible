...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2handoffs_ip_transits
short_description: Resource module for Sda Fabric Devices
  Layer2handoffs Ip Transits
description:
  - Manage operations create, update and delete of the
    resource Sda Fabric Devices Layer2handoffs Ip Transits.
...
options:
  ...
  networkDeviceId:
    ...
    type: str
  payload:
    description: Sda Fabric Devices Layer2handoffs Ip
      Transits's payload.
    elements: dict
    suboptions:
...
---
- name: Create
  cisco.dnac.sda_fabric_devices_layer2handoffs_ip_transits:
    dnac_host: "{{dnac_host}}"
