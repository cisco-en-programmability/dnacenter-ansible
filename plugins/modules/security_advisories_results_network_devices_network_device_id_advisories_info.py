...
short_description: Information module for Security Advisories Results Network Devices Network Device Id Advisories Info
description:
- This module represents an alias of the module security_advisories_results_network_devices_network_device_id_advisories_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of security_advisories_results_network_devices_network_device_id_advisories_v1_info

"""

EXAMPLES = r"""
- name: Get all Security Advisories Results Network Devices Network Device Id Advisories Info
