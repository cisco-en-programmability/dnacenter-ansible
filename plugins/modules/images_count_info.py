...
options:
  ...
  imported:
    ...
    - >
      ...
      for cloud images can be utilised to download images from Cisco.com to the disk.
    type: bool
  name:
    description:
    - >
  ...
  golden:
    description:
    - >
      Golden query parameter. When set to `true`, it will retrieve the images marked tagged golden. When set to
