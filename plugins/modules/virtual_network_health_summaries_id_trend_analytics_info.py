...
short_description: Information module for Virtual Network Health Summaries Id Trend Analytics Info
description:
- This module represents an alias of the module virtual_network_health_summaries_id_trend_analytics_v1_info
...
- name: Cisco DNA Center documentation for SDA TheTrendAnalyticsDataForAVirtualNetworkInTheSpecifiedTimeRangeV1
  description: Complete reference of the TheTrendAnalyticsDataForAVirtualNetworkInTheSpecifiedTimeRangeV1 API.
...
notes:
  ...
  - It should be noted that this module is an alias of virtual_network_health_summaries_id_trend_analytics_v1_info

"""

EXAMPLES = r"""
- name: Get all Virtual Network Health Summaries Id Trend Analytics Info
