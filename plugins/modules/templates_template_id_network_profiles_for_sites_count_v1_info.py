...
short_description: Information module for Templates Template Id Network Profiles For Sites Count V1
description:
...
- name: Get all Templates Template Id Network Profiles For Sites Count V1
  cisco.dnac.templates_template_id_network_profiles_for_sites_count_v1_info:
    dnac_host: "{{dnac_host}}"
