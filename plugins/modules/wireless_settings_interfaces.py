...
notes:
  - SDK Method used are wireless.Wireless.create_interface_v1, wireless.Wireless.delete_interface_v1,
    wireless.Wireless.update_interface_v1,
  - Paths used are post /dna/intent/api/v1/wirelessSettings/interfaces, delete /dna/intent/api/v1/wirelessSettings/interfaces/{id},
