...
DOCUMENTATION = r"""
---
module: assuranceEvents_count_info
short_description: Information module for Assuranceevents Count
description:
- Get all Assuranceevents Count.
- >
...
EXAMPLES = r"""
- name: Get all Assuranceevents Count
  cisco.dnac.assuranceEvents_count_info:
    dnac_host: "{{dnac_host}}"
