...
DOCUMENTATION = r"""
---
module: dhcp_services_top_nanalytics
...
options:
  aggregateAttributes:
    description: Dhcp Services Top Nanalytics's aggregateAttributes.
    elements: dict
    suboptions:
      function:
  ...
  endTime:
    ...
    type: int
  filters:
    description: Dhcp Services Top Nanalytics's filters.
    elements: dict
    suboptions:
      filters:
        description: Filters.
  ...
  headers:
    ...
    type: dict
  page:
    description: Dhcp Services Top Nanalytics's page.
    suboptions:
      limit:
        description: Limit.
        type: int
      offset:
        ...
        type: int
      sortBy:
        description: Dhcp Services Top Nanalytics's
          sortBy.
        elements: dict
        suboptions:
          function:
...
notes:
  - SDK Method used are
    devices.Devices.get_top_n_analytics_data_of_d_h_c_p_services_for_given_set_of_complex_filters,
  - Paths used are
...
---
- name: Create
  cisco.dnac.dhcp_services_top_nanalytics:
    dnac_host: "{{dnac_host}}"
