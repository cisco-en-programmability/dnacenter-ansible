...
DOCUMENTATION = r"""
---
module: sites_device_credentials_status_v1_info
short_description: Information module for Sites Device Credentials Status V1
description:
  - Get all Sites Device Credentials Status V1.
...
"""
EXAMPLES = r"""
- name: Get all Sites Device Credentials Status V1
  cisco.dnac.sites_device_credentials_status_v1_info:
    dnac_host: "{{dnac_host}}"
