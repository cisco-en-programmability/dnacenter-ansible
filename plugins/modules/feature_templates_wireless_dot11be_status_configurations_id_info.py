...
description:
  - This module represents an alias of the module feature_templates_wireless_dot11be_status_configurations_id_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of feature_templates_wireless_dot11be_status_configurations_id_v1_info
"""
EXAMPLES = r"""
- name: Get Feature Templates Wireless Dot11Be Status Configurations Id Info by
    id
  cisco.dnac.feature_templates_wireless_dot11be_status_configurations_id_info:
    dnac_host: "{{dnac_host}}"
