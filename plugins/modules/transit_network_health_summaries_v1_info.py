...
options:
  ...
  id:
    ...
    - >
      ...
      id=1551156a-bc97-3c63-aeda-8a6d3765b5b9&id=4aa20652-237c-4625-b2b4-fd7e82b6a81e (multiple entity uuids with
      '&' separator).
    type: str
  attribute:
    description:
...
- name: Cisco DNA Center documentation for SDA ReadListOfTransitNetworksWithTheirHealthSummaryV1
  description: Complete reference of the ReadListOfTransitNetworksWithTheirHealthSummaryV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!read-list-of-transit-networks-with-their-health-summary
notes:
  - SDK Method used are
    sda.Sda.read_list_of_transit_networks_with_their_health_summary_v1,
