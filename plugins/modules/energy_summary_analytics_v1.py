...
DOCUMENTATION = r"""
---
module: energy_summary_analytics_v1
short_description: Resource module for Energy Summary Analytics V1
description:
  - Manage operation create of the resource Energy Summary Analytics V1.
  - >
    Retrieve the summary analytics data related to device energy consumption for all
    devices, including network
    devices and clients assigned to specific sites. For detailed information about
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.energy_summary_analytics_v1:
    dnac_host: "{{dnac_host}}"
