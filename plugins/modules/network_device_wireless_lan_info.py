...
- name: SDK function get_wireless_lan_controller_details_by_id used
  link: https://dnacentersdk.rtfd.io/en/latest/api/api.html#dnacentersdk.api.v2_2_3_3.devices.Devices.get_wireless_lan_controller_details_by_id

- name: Paths used on the module Network Device Wireless Lan
  description: |-
