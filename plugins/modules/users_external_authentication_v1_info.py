...
DOCUMENTATION = r"""
---
module: users_external_authentication_v1_info
short_description: Information module for Users External Authentication V1
description:
- Get all Users External Authentication V1.
...
- name: Cisco DNA Center documentation for User and Roles GetExternalAuthenticationSettingAPIV1
  ...
  link: https://developer.cisco.com/docs/dna-center/#!get-external-authentication-setting-api-v-1
notes:
  - SDK Method used are
...
EXAMPLES = r"""
- name: Get all Users External Authentication V1
  cisco.dnac.users_external_authentication_v1_info:
    dnac_host: "{{dnac_host}}"
