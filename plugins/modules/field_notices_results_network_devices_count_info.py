...
short_description: Information module for Field Notices Results Network Devices Count
  Info
description:
  - This module represents an alias of the module field_notices_results_network_devices_count_v1_info
...
options:
  ...
  noticeCount:
    description:
      - NoticeCount query parameter. Return network devices with noticeCount greater
        than this noticeCount.
    type: float
requirements:
  - dnacentersdk >= 2.4.9
  - python >= 3.5
...
notes:
  - SDK Method used are compliance.Compliance.get_count_of_field_notice_network_devices_v1,
  - Paths used are get /dna/intent/api/v1/fieldNotices/results/networkDevices/count,
  - It should be noted that this module is an alias of field_notices_results_network_devices_count_v1_info
"""
EXAMPLES = r"""
- name: Get all Field Notices Results Network Devices Count Info
