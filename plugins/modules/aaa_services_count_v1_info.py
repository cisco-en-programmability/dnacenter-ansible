...
DOCUMENTATION = r"""
---
module: aaa_services_count_v1_info
short_description: Information module for Aaa Services Count V1
description:
- Get all Aaa Services Count V1.
- >
...
- name: Cisco DNA Center documentation for Devices RetrievesTheTotalNumberOfAAAServicesForGivenParametersV1
  description: Complete reference of the RetrievesTheTotalNumberOfAAAServicesForGivenParametersV1 API.
...
EXAMPLES = r"""
- name: Get all Aaa Services Count V1
  cisco.dnac.aaa_services_count_v1_info:
    dnac_host: "{{dnac_host}}"
