...
DOCUMENTATION = r"""
---
module: assurance_issues_top_nanalytics
short_description: Resource module for Assurance Issues
  Top Nanalytics
description:
  - Manage operation create of the resource Assurance
    Issues Top Nanalytics. - > Gets the Top N analytics
    data related to issues based on given filters and
    group by field. This data can be used to find top
    sites which has most issues or top device types
    with most issue etc,. For detailed information about
...
options:
  aggregateAttributes:
    description: Assurance Issues Top Nanalytics's aggregateAttributes.
    elements: dict
    suboptions:
      function:
  ...
  endTime:
    ...
    type: int
  filters:
    description: Assurance Issues Top Nanalytics's filters.
    elements: dict
    suboptions:
      filters:
        description: Assurance Issues Top Nanalytics's
          filters.
        elements: dict
        suboptions:
          key:
  ...
  headers:
    ...
    type: dict
  page:
    description: Assurance Issues Top Nanalytics's page.
    suboptions:
      limit:
        description: Limit.
        type: int
...
---
- name: Create
  cisco.dnac.assurance_issues_top_nanalytics:
    dnac_host: "{{dnac_host}}"
