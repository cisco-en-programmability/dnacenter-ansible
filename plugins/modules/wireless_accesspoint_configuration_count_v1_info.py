...
DOCUMENTATION = r"""
---
module: wireless_accesspoint_configuration_count_v1_info
short_description: Information module for Wireless Accesspoint Configuration Count V1
description:
- Get all Wireless Accesspoint Configuration Count V1.
...
notes:
  - SDK Method used are
    wireless.Wireless.get_access_point_configuration_count_v1,
...
EXAMPLES = r"""
- name: Get all Wireless Accesspoint Configuration Count V1
  cisco.dnac.wireless_accesspoint_configuration_count_v1_info:
    dnac_host: "{{dnac_host}}"
