...
DOCUMENTATION = r"""
---
module: sites_ntpSettings_info
short_description: Information module for Sites Ntpsettings
description:
- Get all Sites Ntpsettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Network Settings RetrieveNTPSettingsForASite
  description: Complete reference of the RetrieveNTPSettingsForASite API.
...
EXAMPLES = r"""
- name: Get all Sites Ntpsettings
  cisco.dnac.sites_ntpSettings_info:
    dnac_host: "{{dnac_host}}"
