...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_aaa_radius_attributes_configurations_id_v1_info
short_description: Information module for Feature Templates Wireless Aaa Radius Attributes
  Configurations Id V1
description:
  - Get Feature Templates Wireless Aaa Radius Attributes Configurations Id V1 by id.
  - This API allows users to retrieve a specific AAA Radius Attributes configuration
...
"""
EXAMPLES = r"""
- name: Get Feature Templates Wireless Aaa Radius Attributes Configurations Id V1
    by id
  cisco.dnac.feature_templates_wireless_aaa_radius_attributes_configurations_id_v1_info:
    dnac_host: "{{dnac_host}}"
