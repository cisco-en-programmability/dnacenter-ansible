...
DOCUMENTATION = r"""
---
module: network_device_v1_info
short_description: Information module for Network Device V1
description:
  - Get all Network Device V1.
  - Get Network Device V1 by id.
  - Returns list of network devices based on filter criteria such as management IP
    address, mac address, hostname, etc.
