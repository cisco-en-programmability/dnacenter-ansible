...
short_description: Information module for Network Device Supervisor Card Details Info
description:
- This module represents an alias of the module network_device_supervisor_card_details_v1_info
version_added: '3.1.0'
...
notes:
  ...
  - It should be noted that this module is an alias of network_device_supervisor_card_details_v1_info

"""

EXAMPLES = r"""
- name: Get all Network Device Supervisor Card Details Info
...
RETURN = r"""
dnac_response:
  This alias returns the output of network_device_supervisor_card_details_v1_info.
"""
