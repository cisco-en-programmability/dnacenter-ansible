...
DOCUMENTATION = r"""
---
module: network_applications_summary_analytics_v1
short_description: Resource module for Network Applications Summary Analytics V1
description:
  - Manage operation create of the resource Network Applications Summary Analytics
    V1.
  - >
    Retrieves summary analytics data related to network applications while applying
    complex filtering, aggregate
    functions, and grouping. This API facilitates obtaining consolidated insights
    into the performance and status of
    the network applications. If startTime and endTime are not provided, the API defaults
    to the last 24 hours. For
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.network_applications_summary_analytics_v1:
    dnac_host: "{{dnac_host}}"
