...
short_description: Resource module for Feature Templates Wireless Rrm Fra Configurations
  Id
description:
  - This module represents an alias of the module feature_templates_wireless_rrm_fra_configurations_id_v1
...
options:
  designName:
    ...
    type: str
  featureAttributes:
    description: Feature Templates Wireless Rrm Fra Configurations Id's featureAttributes.
    suboptions:
      fraFreeze:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Wireless DeleteRRMFRAConfigurationFeatureTemplateV1
    description: Complete reference of the DeleteRRMFRAConfigurationFeatureTemplateV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!delete-rrmfra-configuration-feature-template
  - name: Cisco DNA Center documentation for Wireless UpdateRRMFRAConfigurationFeatureTemplateV1
    description: Complete reference of the UpdateRRMFRAConfigurationFeatureTemplateV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!update-rrmfra-configuration-feature-template
notes:
  - SDK Method used are wireless.Wireless.delete_r_r_m_f_r_a_configuration_feature_template_v1,
    wireless.Wireless.update_r_r_m_f_r_a_configuration_feature_template_v1,
  - Paths used are delete /dna/intent/api/v1/featureTemplates/wireless/rrmFraConfigurations/{id},
    put /dna/intent/api/v1/featureTemplates/wireless/rrmFraConfigurations/{id},
  - It should be noted that this module is an alias of feature_templates_wireless_rrm_fra_configurations_id_v1
"""
EXAMPLES = r"""
- name: Update by id
