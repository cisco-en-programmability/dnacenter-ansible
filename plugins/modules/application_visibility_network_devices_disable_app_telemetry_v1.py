...
DOCUMENTATION = r"""
---
module: application_visibility_network_devices_disable_app_telemetry_v1
short_description: Resource module for Application Visibility Network Devices Disable App Telemetry V1
description:
- Manage operation create of the resource Application Visibility Network Devices Disable App Telemetry V1.
- >
   This API can be used to disable application telemetry feature on multiple network devices. Request payload should
...
- name: Cisco DNA Center documentation for Application Policy DisableApplicationTelemetryFeatureOnMultipleNetworkDevicesV1
  description: Complete reference of the DisableApplicationTelemetryFeatureOnMultipleNetworkDevicesV1 API.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.application_visibility_network_devices_disable_app_telemetry_v1:
    dnac_host: "{{dnac_host}}"
