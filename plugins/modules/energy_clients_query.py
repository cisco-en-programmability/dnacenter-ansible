...
description:
  - This module represents an alias of the module energy_clients_query_v1
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Clients QueryClientsEnergyV1
    description: Complete reference of the QueryClientsEnergyV1 API.
    link: https://developer.cisco.com/docs/dna-center/#!query-clients-energy
notes:
  - SDK Method used are clients.Clients.query_clients_energy_v1,
  - Paths used are post /dna/data/api/v1/energy/clients/query,
  - It should be noted that this module is an alias of energy_clients_query_v1
"""
EXAMPLES = r"""
- name: Create
