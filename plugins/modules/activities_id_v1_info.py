...
DOCUMENTATION = r"""
---
module: activities_id_v1_info
short_description: Information module for Activities Id V1
description:
  - Get Activities Id V1 by id.
...
"""
EXAMPLES = r"""
- name: Get Activities Id V1 by id
  cisco.dnac.activities_id_v1_info:
    dnac_host: "{{dnac_host}}"
