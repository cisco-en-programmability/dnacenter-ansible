...
DOCUMENTATION = r"""
---
module: configuration_template_import_project_v1
short_description: Resource module for Configuration Template Import Project V1
description:
- Manage operation create of the resource Configuration Template Import Project V1.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.configuration_template_import_project_v1:
    dnac_host: "{{dnac_host}}"
