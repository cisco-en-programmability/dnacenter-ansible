...
DOCUMENTATION = r"""
---
module: aaa_services_v1_info
short_description: Information module for Aaa Services V1
description:
  - Get all Aaa Services V1.
  - >
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Devices RetrievesTheListOfAAAServicesForGivenParametersV1
    description: Complete reference of the RetrievesTheListOfAAAServicesForGivenParametersV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!retrieves-the-list-of-aaa-services-for-given-parameters
notes:
  - SDK Method used are devices.Devices.retrieves_the_list_of_a_a_a_services_for_given_parameters_v1,
  - Paths used are get /dna/data/api/v1/aaaServices,
"""
EXAMPLES = r"""
- name: Get all Aaa Services V1
  cisco.dnac.aaa_services_v1_info:
    dnac_host: "{{dnac_host}}"
