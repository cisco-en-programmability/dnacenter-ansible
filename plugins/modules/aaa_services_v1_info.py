...
- name: Cisco DNA Center documentation for Devices RetrievesTheListOfAAAServicesForGivenParametersV1
  description: Complete reference of the RetrievesTheListOfAAAServicesForGivenParametersV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!retrieves-the-list-of-aaa-services-for-given-parameters
notes:
  - SDK Method used are
    devices.Devices.retrieves_the_list_of_a_a_a_services_for_given_parameters_v1,
