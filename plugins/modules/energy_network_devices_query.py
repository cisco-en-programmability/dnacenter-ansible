...
description:
  - This module represents an alias of the module energy_network_devices_query_v1
...
notes:
  ...
  - It should be noted that this module is an alias of energy_network_devices_query_v1
"""
EXAMPLES = r"""
- name: Create
