...
DOCUMENTATION = r"""
---
module: pnp_global_settings_v1_info
short_description: Information module for Pnp Global Settings V1
description:
  - Get all Pnp Global Settings V1.
...
"""
EXAMPLES = r"""
- name: Get all Pnp Global Settings V1
  cisco.dnac.pnp_global_settings_v1_info:
    dnac_host: "{{dnac_host}}"
