...
DOCUMENTATION = r"""
---
module: security_service_insertion_system_readiness_v1_info
short_description: Information module for Security Service Insertion System Readiness
  V1
description:
  - Get all Security Service Insertion System Readiness V1.
  - >
    Retrieves readiness information for Security Service Insertion, including integration
    status, security group
...
"""
EXAMPLES = r"""
- name: Get all Security Service Insertion System Readiness V1
  cisco.dnac.security_service_insertion_system_readiness_v1_info:
    dnac_host: "{{dnac_host}}"
