...
DOCUMENTATION = r"""
---
module: wired_network_devices_id_config_features_intended_layer2_v1_info
short_description: Information module for Wired Network Devices Id Config Features
  Intended Layer2 V1
description:
  - Get all Wired Network Devices Id Config Features Intended Layer2 V1.
  - >
    This API returns the configurations for the intended layer 2 features on a wired
    device. Even after the intended
    configurations are deployed using the API /intent/api/v1/networkDevices/{id}/configFeatures/intended/deploy,
    they
  ...
  feature:
    description:
      - >
        ...
        /data/intent/api/wired/networkDevices/{id}/configFeatures/supported/layer2
        can be used to get the list of
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Wired GetConfigurationsForIntendedLayer2FeaturesOnAWiredDeviceV1
    description: Complete reference of the GetConfigurationsForIntendedLayer2FeaturesOnAWiredDeviceV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!get-configurations-for-intended-layer-2-features-on-a-wired-device
notes:
  - SDK Method used are
    wired.Wired.get_configurations_for_intended_layer2_features_on_a_wired_device_v1,
  - Paths used are get
    /dna/intent/api/v1/intent/api/v1/wired/networkDevices/{id}/configFeatures/intended/layer2,
"""
EXAMPLES = r"""
- name: Get all Wired Network Devices Id Config Features Intended Layer2 V1
  cisco.dnac.wired_network_devices_id_config_features_intended_layer2_v1_info:
    dnac_host: "{{dnac_host}}"
