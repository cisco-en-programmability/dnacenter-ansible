...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Compliance CreatesATrialForBugsDetectionOnNetworkDevices
    description: Complete reference of the CreatesATrialForBugsDetectionOnNetworkDevices API.
