...
- name: SDK function get_email_subscription_details used
  link: https://dnacentersdk.rtfd.io/en/latest/api/api.html#dnacentersdk.api.v2_2_3_3.event_management.EventManagement.get_email_subscription_details

- name: Paths used on the module Event Subscription Details Email
  description: |-
