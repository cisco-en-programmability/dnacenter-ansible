...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_rrm_general_configurations_v1
short_description: Resource module for Feature Templates Wireless Rrm General Configurations
  V1
description:
  - Manage operation create of the resource Feature Templates Wireless Rrm General
    Configurations V1.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.feature_templates_wireless_rrm_general_configurations_v1:
    dnac_host: "{{dnac_host}}"
