...
DOCUMENTATION = r"""
---
module: security_service_insertion_fabric_sites_readiness_id_v1_info
short_description: Information module for Security Service Insertion Fabric Sites
  Readiness Id V1
description:
  - Get Security Service Insertion Fabric Sites Readiness Id V1 by id.
  - >
    Gets a list of SDA virtual networks for the specified fabric site, including their
    individual readiness status for
    Security Service Insertion SSI deployment.
...
"""
EXAMPLES = r"""
- name: Get Security Service Insertion Fabric Sites Readiness Id V1 by id
  cisco.dnac.security_service_insertion_fabric_sites_readiness_id_v1_info:
    dnac_host: "{{dnac_host}}"
