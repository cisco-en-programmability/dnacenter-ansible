...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Issues GetTheTotalNumberOfIssuesForGivenSetOfFilters2
  description: Complete reference of the GetTheTotalNumberOfIssuesForGivenSetOfFilters2 API.
  link: https://developer.cisco.com/docs/dna-center/#!get-the-total-number-of-issues-for-given-set-of-filters-2
notes:
  - SDK Method used are
    issues.Issues.get_the_total_number_of_issues_for_given_set_of_filters2,
...
- name: Get all Assuranceissues Count
  cisco.dnac.assuranceIssues_count_info:
    dnac_host: "{{dnac_host}}"
