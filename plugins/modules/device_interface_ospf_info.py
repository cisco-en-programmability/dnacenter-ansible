...
- name: SDK function get_ospf_interfaces used
  link: https://dnacentersdk.rtfd.io/en/latest/api/api.html#dnacentersdk.api.v2_2_3_3.devices.Devices.get_ospf_interfaces

- name: Paths used on the module Device Interface Ospf
  description: |-
