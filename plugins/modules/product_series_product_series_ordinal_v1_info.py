...
DOCUMENTATION = r"""
---
module: product_series_product_series_ordinal_v1_info
short_description: Information module for Product Series Product Series Ordinal V1
description:
  - Get Product Series Product Series Ordinal V1 by id.
...
"""
EXAMPLES = r"""
- name: Get Product Series Product Series Ordinal V1 by id
  cisco.dnac.product_series_product_series_ordinal_v1_info:
    dnac_host: "{{dnac_host}}"
