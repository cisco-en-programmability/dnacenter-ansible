...
DOCUMENTATION = r"""
---
module: energy_sites_query_v1
short_description: Resource module for Energy Sites Query V1
description:
  - Manage operation create of the resource Energy Sites Query V1.
  - >
    Submits a request to retrieve a list of sites along with their energy data for
    a specified time range, based on
    the filters provided in the request body. For detailed information about the usage
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.energy_sites_query_v1:
    dnac_host: "{{dnac_host}}"
