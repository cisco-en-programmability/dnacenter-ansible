...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_advanced_ssidconfigurations_id
...
description:
  - Manage operations update and delete of the resource
    Feature Templates Wireless Advanced Ssidconfigurations
    Id.
...
options:
  ...
  featureAttributes:
    description: Feature Templates Wireless Advanced
      Ssidconfigurations Id's featureAttributes.
    suboptions:
...
---
- name: Delete by id
  cisco.dnac.feature_templates_wireless_advanced_ssidconfigurations_id:
    dnac_host: "{{dnac_host}}"
