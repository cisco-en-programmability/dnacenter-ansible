...
DOCUMENTATION = r"""
---
module: networkDevices_membersAssociations_count_info
short_description: Information module for Networkdevices Membersassociations Count
description:
- Get all Networkdevices Membersassociations Count.
- >
...
notes:
  ...
  - Paths used are
    get /intent/api/v1/tags/networkDevices/membersAssociations/count,

"""

EXAMPLES = r"""
- name: Get all Networkdevices Membersassociations Count
  cisco.dnac.networkDevices_membersAssociations_count_info:
    dnac_host: "{{dnac_host}}"
