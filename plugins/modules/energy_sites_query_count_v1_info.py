...
DOCUMENTATION = r"""
---
module: energy_sites_query_count_v1_info
short_description: Information module for Energy Sites Query Count V1
description:
  - Get all Energy Sites Query Count V1.
  - >
    Gets count sites energy task result for the given task ID. For detailed information
    ...
    api-specs/blob/main/Assurance/CE_Cat_Center_Org-sitesEnergy-1.0.1-resolved.yaml.
...
"""
EXAMPLES = r"""
- name: Get all Energy Sites Query Count V1
  cisco.dnac.energy_sites_query_count_v1_info:
    dnac_host: "{{dnac_host}}"
