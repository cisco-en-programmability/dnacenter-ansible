...
DOCUMENTATION = r"""
---
module: energy_sites_v1_info
short_description: Information module for Energy Sites V1
description:
  - Get all Energy Sites V1.
  - >
...
"""
EXAMPLES = r"""
- name: Get all Energy Sites V1
  cisco.dnac.energy_sites_v1_info:
    dnac_host: "{{dnac_host}}"
