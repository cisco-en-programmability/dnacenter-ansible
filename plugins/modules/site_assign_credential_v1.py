...
DOCUMENTATION = r"""
---
module: site_assign_credential_v1
short_description: Resource module for Site Assign Credential V1
description:
  - Manage operation create of the resource Site Assign Credential V1.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.site_assign_credential_v1:
    dnac_host: "{{dnac_host}}"
