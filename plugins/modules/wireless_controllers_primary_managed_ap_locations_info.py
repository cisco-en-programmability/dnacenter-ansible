...
DOCUMENTATION = r"""
---
module: wirelessControllers_primaryManagedApLocations_info
short_description: Information module for Wirelesscontrollers Primarymanagedaplocations
description:
- Get all Wirelesscontrollers Primarymanagedaplocations.
...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Wireless GetPrimaryManagedAPLocationsForSpecificWirelessController
  description: Complete reference of the GetPrimaryManagedAPLocationsForSpecificWirelessController API.
...
EXAMPLES = r"""
- name: Get all Wirelesscontrollers Primarymanagedaplocations
  cisco.dnac.wirelessControllers_primaryManagedApLocations_info:
    dnac_host: "{{dnac_host}}"
