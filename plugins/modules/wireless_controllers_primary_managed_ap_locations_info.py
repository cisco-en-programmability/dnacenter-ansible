...
short_description: Information module for Wireless Controllers Primary Managed Ap Locations
description:
  - Get all Wireless Controllers Primary Managed Ap Locations.
...
EXAMPLES = r"""
---
- name: Get all Wireless Controllers Primary Managed Ap Locations
