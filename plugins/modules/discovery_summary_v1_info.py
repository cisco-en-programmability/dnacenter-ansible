...
DOCUMENTATION = r"""
---
module: discovery_summary_v1_info
short_description: Information module for Discovery Summary V1
description:
  - Get all Discovery Summary V1.
  - >
    Returns the devices discovered in the given discovery based on given filters.
    Discovery ID can be obtained using
...
"""
EXAMPLES = r"""
- name: Get all Discovery Summary V1
  cisco.dnac.discovery_summary_v1_info:
    dnac_host: "{{dnac_host}}"
