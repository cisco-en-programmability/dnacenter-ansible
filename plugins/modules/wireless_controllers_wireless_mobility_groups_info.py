...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Wireless GetAllMobilityGroups
  description: Complete reference of the GetAllMobilityGroups API.
  link: https://developer.cisco.com/docs/dna-center/#!get-all-mobility-groups
notes:
  - SDK Method used are
    wireless.Wireless.get_all_mobility_groups,
...
- name: Get all Wirelesscontrollers Wirelessmobilitygroups
  cisco.dnac.wirelessControllers_wirelessMobilityGroups_info:
    dnac_host: "{{dnac_host}}"
