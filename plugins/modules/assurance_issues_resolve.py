...
DOCUMENTATION = r"""
---
module: assuranceIssues_resolve
short_description: Resource module for Assuranceissues Resolve
description:
- Manage operation create of the resource Assuranceissues Resolve.
- >
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.assuranceIssues_resolve:
    dnac_host: "{{dnac_host}}"
