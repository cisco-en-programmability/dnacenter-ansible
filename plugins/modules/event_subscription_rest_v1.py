...
DOCUMENTATION = r"""
---
module: event_subscription_rest_v1
short_description: Resource module for Event Subscription Rest V1
description:
  - Manage operations create and update of the resource Event Subscription Rest V1.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.event_subscription_rest_v1:
    dnac_host: "{{dnac_host}}"
