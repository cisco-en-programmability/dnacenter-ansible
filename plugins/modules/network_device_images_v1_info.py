...
DOCUMENTATION = r"""
---
module: network_device_images_v1_info
short_description: Information module for Network Device Images V1
description:
  - Get all Network Device Images V1.
  - >
    This API retrieves information about running images and golden image bundle, if
    they are available for network
    devices. It also provides network device update status and image update status
    related to the golden image bundle
    and the compatible features supported by the network devices.
...
"""
EXAMPLES = r"""
- name: Get all Network Device Images V1
  cisco.dnac.network_device_images_v1_info:
    dnac_host: "{{dnac_host}}"
