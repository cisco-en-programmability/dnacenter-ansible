...
short_description: Resource module for Wireless Provision Ssid Delete Reprovision V1
description:
- Manage operation delete of the resource Wireless Provision Ssid Delete Reprovision V1.
...
EXAMPLES = r"""
- name: Delete by id
  cisco.dnac.wireless_provision_ssid_delete_reprovision_v1:
    dnac_host: "{{dnac_host}}"
