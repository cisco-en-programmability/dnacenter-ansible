...
DOCUMENTATION = r"""
---
module: energy_sites_query_v1_info
short_description: Information module for Energy Sites Query V1
description:
  - Get all Energy Sites Query V1.
  - >
    Gets query sites energy task result for the given task ID. For detailed information
...
"""
EXAMPLES = r"""
- name: Get all Energy Sites Query V1
  cisco.dnac.energy_sites_query_v1_info:
    dnac_host: "{{dnac_host}}"
