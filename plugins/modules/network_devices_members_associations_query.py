...
DOCUMENTATION = r"""
---
module: networkDevices_membersAssociations_query
short_description: Resource module for Networkdevices Membersassociations Query
description:
- Manage operation create of the resource Networkdevices Membersassociations Query.
- >
...
notes:
  ...
  - Paths used are
    post /intent/api/v1/tags/networkDevices/membersAssociations/query,

"""

EXAMPLES = r"""
- name: Create
  cisco.dnac.networkDevices_membersAssociations_query:
    dnac_host: "{{dnac_host}}"
