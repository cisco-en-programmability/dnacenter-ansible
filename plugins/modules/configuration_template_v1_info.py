...
DOCUMENTATION = r"""
---
module: configuration_template_v1_info
short_description: Information module for Configuration Template V1
description:
  - Get all Configuration Template V1.
  - Get Configuration Template V1 by id.
