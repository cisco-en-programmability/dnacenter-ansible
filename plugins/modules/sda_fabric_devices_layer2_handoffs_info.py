...
short_description: Information module for Sda Fabric Devices Layer2 Handoffs Info
description:
  - This module represents an alias of the module sda_fabric_devices_layer2_handoffs_v1_info
...
seealso:
  - name: Cisco DNA Center documentation for SDA GetFabricDevicesLayer2HandoffsV1
    ...
    link:
      https://developer.cisco.com/docs/dna-center/#!get-fabric-devices-layer-2-handoffs
notes:
  - SDK Method used are sda.Sda.get_fabric_devices_layer2_handoffs_v1,
  - Paths used are get /dna/intent/api/v1/sda/fabricDevices/layer2Handoffs,
  - It should be noted that this module is an alias of sda_fabric_devices_layer2_handoffs_v1_info
"""
EXAMPLES = r"""
- name: Get all Sda Fabric Devices Layer2 Handoffs Info
