...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2handoffs_count_info
short_description: Information module for Sda Fabric
  Devices Layer2handoffs Count
description:
  - Get all Sda Fabric Devices Layer2handoffs Count.
  - Returns the count of layer 2 handoffs of fabric
    devices that match the provided query parameters.
...
seealso:
  - name: Cisco DNA Center documentation for SDA GetFabricDevicesLayer2HandoffsCount
    description: Complete reference of the GetFabricDevicesLayer2HandoffsCount
      API.
...
EXAMPLES = r"""
---
- name: Get all Sda Fabric Devices Layer2handoffs Count
  cisco.dnac.sda_fabric_devices_layer2handoffs_count_info:
    dnac_host: "{{dnac_host}}"
