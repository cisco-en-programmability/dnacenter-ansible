...
DOCUMENTATION = r"""
---
module: security_service_insertions_v1_info
short_description: Information module for Security Service Insertions V1
description:
  - Get all Security Service Insertions V1.
  - Retrieves a list of all Security Service Insertions SSIs configured across fabric
    sites.
...
"""
EXAMPLES = r"""
- name: Get all Security Service Insertions V1
  cisco.dnac.security_service_insertions_v1_info:
    dnac_host: "{{dnac_host}}"
