...
DOCUMENTATION = r"""
---
module: assurance_events_child_events_v1_info
short_description: Information module for Assurance Events Child Events V1
description:
  - Get all Assurance Events Child Events V1.
  - >
    Wireless client event could have child events and this API can be used to fetch
    the same using parent event `id`
    as the input. For detailed information about the usage of the API, please refer
...
EXAMPLES = r"""
- name: Get all Assurance Events Child Events V1
  cisco.dnac.assurance_events_child_events_v1_info:
    dnac_host: "{{dnac_host}}"
