...
DOCUMENTATION = r"""
---
module: lan_automation_port_channels_id_add_link_v1
short_description: Resource module for Lan Automation Port Channels Id Add Link V1
description:
  - Manage operation create of the resource Lan Automation Port Channels Id Add Link
    V1.
  - >
    This API adds a new LAN Automated link as a member to an existing Port Channel,
    provided the interface is in UP
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.lan_automation_port_channels_id_add_link_v1:
    dnac_host: "{{dnac_host}}"
