...
- name: Cisco DNA Center documentation for Issues GetTheDetailsOfIssuesForGivenSetOfFilters2
  description: Complete reference of the GetTheDetailsOfIssuesForGivenSetOfFilters2 API.
  link: https://developer.cisco.com/docs/dna-center/#!get-the-details-of-issues-for-given-set-of-filters-2
notes:
  - SDK Method used are
    issues.Issues.get_all_the_details_and_suggested_actions_of_an_issue_for_the_given_issue_id,
    issues.Issues.get_the_details_of_issues_for_given_set_of_filters2,
...
- name: Get all Assuranceissues
  cisco.dnac.assuranceIssues_info:
    dnac_host: "{{dnac_host}}"
