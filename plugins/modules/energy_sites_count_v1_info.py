...
DOCUMENTATION = r"""
---
module: energy_sites_count_v1_info
short_description: Information module for Energy Sites Count V1
description:
  - Get all Energy Sites Count V1.
  - >
    Retrieves the total count of sites that provide energy data, filtered according
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Sites CountSitesEnergyV1
    description: Complete reference of the CountSitesEnergyV1 API.
    link: https://developer.cisco.com/docs/dna-center/#!count-sites-energy
notes:
  - SDK Method used are sites.Sites.count_sites_energy_v1,
  - Paths used are get /dna/data/api/v1/energy/sites/count,
"""
EXAMPLES = r"""
- name: Get all Energy Sites Count V1
  cisco.dnac.energy_sites_count_v1_info:
    dnac_host: "{{dnac_host}}"
