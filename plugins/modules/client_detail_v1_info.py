...
DOCUMENTATION = r"""
---
module: client_detail_v1_info
short_description: Information module for Client Detail V1
description:
  - Get all Client Detail V1.
  - Returns detailed Client information retrieved by Mac Address for any given point
    of time.
version_added: '3.1.0'
