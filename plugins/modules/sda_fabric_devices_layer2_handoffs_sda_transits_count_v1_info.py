...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2_handoffs_sda_transits_count_v1_info
short_description: Information module for Sda Fabric Devices Layer2 Handoffs Sda Transits Count V1
description:
- Get all Sda Fabric Devices Layer2 Handoffs Sda Transits Count V1.
...
- name: Cisco DNA Center documentation for SDA GetFabricDevicesLayer3HandoffsWithSdaTransitCountV1
  ...
  link: https://developer.cisco.com/docs/dna-center/#!get-fabric-devices-layer-3-handoffs-with-sda-transit-count-v-1
notes:
  - SDK Method used are
...
EXAMPLES = r"""
- name: Get all Sda Fabric Devices Layer2 Handoffs Sda Transits Count V1
  cisco.dnac.sda_fabric_devices_layer2_handoffs_sda_transits_count_v1_info:
    dnac_host: "{{dnac_host}}"
