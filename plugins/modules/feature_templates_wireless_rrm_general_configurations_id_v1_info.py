...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_rrm_general_configurations_id_v1_info
short_description: Information module for Feature Templates Wireless Rrm General Configurations
  Id V1
description:
  - Get Feature Templates Wireless Rrm General Configurations Id V1 by id.
  - This API allows users to retrieve a specific RRM General configuration feature
    template by ID.
...
"""
EXAMPLES = r"""
- name: Get Feature Templates Wireless Rrm General Configurations Id V1 by id
  cisco.dnac.feature_templates_wireless_rrm_general_configurations_id_v1_info:
    dnac_host: "{{dnac_host}}"
