...
description:
  - This module represents an alias of the module feature_templates_wireless_multicast_configurations_v1
  ...
  featureAttributes:
    ...
    suboptions:
      ...
      multicastIpv4Address:
        description: Multicast Ipv4 address must be between 224.0.0.0 and 239.255.255.255.
          Note This is only supported when multicastIpv4Mode is set to MULTICAST.
        type: str
      multicastIpv4Mode:
        description: Multicast Ipv4 Mode.
        type: str
      multicastIpv6Address:
        description: Multicast Ipv6 Address must start with FF0 or 11,2,3,4,5,8, or
          E. Note This is only supported when multicastIpv6Mode is set to MULTICAST.
        type: str
      multicastIpv6Mode:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Wireless CreateMulticastConfigurationFeatureTemplateV1
    description: Complete reference of the CreateMulticastConfigurationFeatureTemplateV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!create-multicast-configuration-feature-template
notes:
  - SDK Method used are wireless.Wireless.create_multicast_configuration_feature_template_v1,
  - Paths used are post /dna/intent/api/v1/featureTemplates/wireless/multicastConfigurations,
  - It should be noted that this module is an alias of feature_templates_wireless_multicast_configurations_v1
"""
EXAMPLES = r"""
- name: Create
