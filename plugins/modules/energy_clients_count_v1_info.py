...
DOCUMENTATION = r"""
---
module: energy_clients_count_v1_info
short_description: Information module for Energy Clients Count V1
description:
  - Get all Energy Clients Count V1.
  - >
    Retrieves the total count of client devices that provide energy data, filtered
    according to the specified query
    parameters. For detailed information about the usage of the API, please refer
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Clients CountClientsEnergyV1
    description: Complete reference of the CountClientsEnergyV1 API.
    link: https://developer.cisco.com/docs/dna-center/#!count-clients-energy
notes:
  - SDK Method used are clients.Clients.count_clients_energy_v1,
  - Paths used are get /dna/data/api/v1/energy/clients/count,
"""
EXAMPLES = r"""
- name: Get all Energy Clients Count V1
  cisco.dnac.energy_clients_count_v1_info:
    dnac_host: "{{dnac_host}}"
