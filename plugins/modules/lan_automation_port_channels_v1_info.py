...
DOCUMENTATION = r"""
---
module: lan_automation_port_channels_v1_info
short_description: Information module for Lan Automation Port Channels V1
description:
  - Get all Lan Automation Port Channels V1.
...
"""
EXAMPLES = r"""
- name: Get all Lan Automation Port Channels V1
  cisco.dnac.lan_automation_port_channels_v1_info:
    dnac_host: "{{dnac_host}}"
