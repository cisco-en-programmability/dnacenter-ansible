...
DOCUMENTATION = r"""
---
module: wirelessControllers_ssidDetails_count_info
short_description: Information module for Wirelesscontrollers Ssiddetails Count
description:
- Get all Wirelesscontrollers Ssiddetails Count.
...
EXAMPLES = r"""
- name: Get all Wirelesscontrollers Ssiddetails Count
  cisco.dnac.wirelessControllers_ssidDetails_count_info:
    dnac_host: "{{dnac_host}}"
