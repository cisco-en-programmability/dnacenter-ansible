...
DOCUMENTATION = r"""
---
module: discovery_count_v1_info
short_description: Information module for Discovery Count V1
description:
  - Get all Discovery Count V1.
...
"""
EXAMPLES = r"""
- name: Get all Discovery Count V1
  cisco.dnac.discovery_count_v1_info:
    dnac_host: "{{dnac_host}}"
