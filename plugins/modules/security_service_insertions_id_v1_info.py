...
DOCUMENTATION = r"""
---
module: security_service_insertions_id_v1_info
short_description: Information module for Security Service Insertions Id V1
description:
  - Get Security Service Insertions Id V1 by id.
...
"""
EXAMPLES = r"""
- name: Get Security Service Insertions Id V1 by id
  cisco.dnac.security_service_insertions_id_v1_info:
    dnac_host: "{{dnac_host}}"
