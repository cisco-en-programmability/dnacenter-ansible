...
description:
  - Manage operations update and delete of the resource
    Featuretemplates Wireless Eventdrivenrrmconfigurations
    Id.
...
options:
  ...
  featureAttributes:
    description: Feature Templates Wireless Event Driven
      R R M Configurations Id's featureAttributes.
    suboptions:
...
---
- name: Delete by id
  cisco.dnac.featureTemplates_wireless_eventDrivenRRMConfigurations_id:
    dnac_host: "{{dnac_host}}"
