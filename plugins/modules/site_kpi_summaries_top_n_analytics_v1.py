...
DOCUMENTATION = r"""
---
module: site_kpi_summaries_top_n_analytics_v1
short_description: Resource module for Site Kpi Summaries Top N Analytics V1
description:
  - Manage operation create of the resource Site Kpi Summaries Top N Analytics V1.
  - >
    Gets the Top N entites related based on site analytics for a given kpi type. For
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.site_kpi_summaries_top_n_analytics_v1:
    dnac_host: "{{dnac_host}}"
