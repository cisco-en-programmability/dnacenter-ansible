...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_advanced_ssid_configurations_id_v1
...
description:
  - Manage operations update and delete of the resource Feature Templates Wireless
    Advanced Ssid Configurations Id V1.
  - This API allows users to delete a specific Advanced SSID configuration feature
    template by Id.
  - This API allows users to update the details of a specific Advanced SSID configuration
...
EXAMPLES = r"""
- name: Delete by id
  cisco.dnac.feature_templates_wireless_advanced_ssid_configurations_id_v1:
    dnac_host: "{{dnac_host}}"
