...
DOCUMENTATION = r"""
---
module: iot_fabric_rep_rings_v1
short_description: Resource module for Iot Fabric Rep Rings V1
description:
  - Manage operation create of the resource Iot Fabric Rep Rings V1.
  - >
    This API configures a REP ring on FABRIC deployment. The input payload contains
    the following fields - ringName
    unique ring name , rootNetworkDeviceId Network device ID of the root node of the
    REP Ring and
    rootNeighbourNetworkDeviceIds Network device IDs of the two immediate neighbour
    devices of the root node of the
    REP Ring. The networkDeviceId is the instanceUuid attribute in the response of
    API -
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.iot_fabric_rep_rings_v1:
    dnac_host: "{{dnac_host}}"
