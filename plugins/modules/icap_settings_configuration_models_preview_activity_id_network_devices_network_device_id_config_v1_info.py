...
description:
  - Get Icap Settings Configuration Models Preview Activity Id Network Devices Network
    Device Id Config V1 by id.
  - >
    Returns the device's CLIs of the ICAP intent. For detailed information about the
...
- name: Get Icap Settings Configuration Models Preview Activity Id Network Devices
    Network Device Id Config V1 by id
