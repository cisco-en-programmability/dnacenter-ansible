...
- >
   Returns the device's CLIs of the ICAP intent. For detailed information about the usage of the API, please refer to
...
- name: Cisco DNA Center documentation for Sensors RetrievesTheDevice'sCLIsOfTheICAPIntentV1
  description: Complete reference of the RetrievesTheDevice'sCLIsOfTheICAPIntentV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!retrieves-the-device's-cl-is-of-the-icap-intent
notes:
  - SDK Method used are
    sensors.Sensors.retrieves_the_devices_clis_of_the_i_capintent_v1,
...
EXAMPLES = r"""
- name: Get Icap Settings Configuration Models Preview Activity Id Network Devices Network Device Id Config V1 by id
  cisco.dnac.icap_settings_configuration_models_preview_activity_id_network_devices_network_device_id_config_v1_info:
    dnac_host: "{{dnac_host}}"
