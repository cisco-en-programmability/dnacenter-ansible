...
DOCUMENTATION = r"""
---
module: networkDeviceImageUpdates_count_info
short_description: Information module for Networkdeviceimageupdates Count
description:
- Get all Networkdeviceimageupdates Count.
...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Software Image Management (SWIM) CountOfNetworkDeviceImageUpdates
  description: Complete reference of the CountOfNetworkDeviceImageUpdates API.
...
EXAMPLES = r"""
- name: Get all Networkdeviceimageupdates Count
  cisco.dnac.networkDeviceImageUpdates_count_info:
    dnac_host: "{{dnac_host}}"
