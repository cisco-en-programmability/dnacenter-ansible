...
DOCUMENTATION = r"""
---
module: lan_automation_log_by_serial_number_v1_info
short_description: Information module for Lan Automation Log By Serial Number V1
description:
  - Get Lan Automation Log By Serial Number V1 by id.
  - >
    Invoke this API to get the LAN Automation session logs for individual devices
    based on the given LAN Automation
