...
DOCUMENTATION = r"""
---
module: energy_network_devices_v1_info
short_description: Information module for Energy Network Devices V1
description:
  - Get all Energy Network Devices V1.
  - >
    Retrieves a list of network devices with energy data based on the specified query
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Devices GetDevicesEnergyV1
    description: Complete reference of the GetDevicesEnergyV1 API.
    link: https://developer.cisco.com/docs/dna-center/#!get-devices-energy
notes:
  - SDK Method used are devices.Devices.get_devices_energy_v1,
  - Paths used are get /dna/data/api/v1/energy/networkDevices,
"""
EXAMPLES = r"""
- name: Get all Energy Network Devices V1
  cisco.dnac.energy_network_devices_v1_info:
    dnac_host: "{{dnac_host}}"
