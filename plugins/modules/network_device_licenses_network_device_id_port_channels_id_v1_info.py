...
DOCUMENTATION = r"""
---
module: network_device_licenses_network_device_id_port_channels_id_v1_info
short_description: Information module for Network Device Licenses Network Device Id
  Port Channels Id V1
description:
  - Get Network Device Licenses Network Device Id Port Channels Id V1 by id.
  - >
    This API endpoint retrieves detailed information for a specified port channel
    using its unique identifier within a
...
"""
EXAMPLES = r"""
- name: Get Network Device Licenses Network Device Id Port Channels Id V1 by id
  cisco.dnac.network_device_licenses_network_device_id_port_channels_id_v1_info:
    dnac_host: "{{dnac_host}}"
