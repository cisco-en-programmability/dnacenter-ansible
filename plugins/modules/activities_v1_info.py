...
DOCUMENTATION = r"""
---
module: activities_v1_info
short_description: Information module for Activities V1
description:
  - Get all Activities V1.
...
"""
EXAMPLES = r"""
- name: Get all Activities V1
  cisco.dnac.activities_v1_info:
    dnac_host: "{{dnac_host}}"
