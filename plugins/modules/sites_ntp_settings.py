...
DOCUMENTATION = r"""
---
module: sites_ntpSettings
short_description: Resource module for Sites Ntpsettings
description:
- Manage operation update of the resource Sites Ntpsettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Network Settings SetNTPSettingsForASite
