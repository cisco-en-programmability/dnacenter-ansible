...
DOCUMENTATION = r"""
---
module: iot_rep_rings_query_count_v1
short_description: Resource module for Iot Rep Rings Query Count V1
description:
  - Manage operation create of the resource Iot Rep Rings Query Count V1.
  - >
    This API returns the count of REP rings for the given fields - networkDeviceId
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.iot_rep_rings_query_count_v1:
    dnac_host: "{{dnac_host}}"
