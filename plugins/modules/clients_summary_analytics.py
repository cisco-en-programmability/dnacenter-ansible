...
DOCUMENTATION = r"""
---
module: clients_summaryAnalytics
short_description: Resource module for Clients Summaryanalytics
description:
- Manage operation create of the resource Clients Summaryanalytics.
- >
   Retrieves summary analytics data related to clients while applying complex filtering, aggregate functions, and
   grouping. This API facilitates obtaining consolidated insights into the performance and status of the clients. For
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.clients_summaryAnalytics:
    dnac_host: "{{dnac_host}}"
