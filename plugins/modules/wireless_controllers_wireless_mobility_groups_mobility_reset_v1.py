...
description:
  - Manage operation create of the resource Wireless Controllers Wireless Mobility
    Groups Mobility Reset V1.
  - This API is used to reset wireless mobility which in turn sets mobility group
    name as 'default'.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.wireless_controllers_wireless_mobility_groups_mobility_reset_v1:
    dnac_host: "{{dnac_host}}"
