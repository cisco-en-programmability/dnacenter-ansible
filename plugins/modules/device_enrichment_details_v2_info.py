...
DOCUMENTATION = r"""
---
module: device_enrichment_details_v2_info
short_description: Information module for Device Enrichment Details V2
description:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices GetDeviceEnrichmentDetailsV2
...
EXAMPLES = r"""
---
- name: Get all Device Enrichment Details V2
  cisco.dnac.device_enrichment_details_v2_info:
    dnac_host: "{{dnac_host}}"
