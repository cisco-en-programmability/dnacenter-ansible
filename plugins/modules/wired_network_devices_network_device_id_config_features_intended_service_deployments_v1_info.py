...
short_description: Information module for Wired Network Devices Network Device Id
  Config Features Intended Service Deployments V1
description:
  - Get all Wired Network Devices Network Device Id Config Features Intended Service
    Deployments V1.
...
- name: Get all Wired Network Devices Network Device Id Config Features Intended
    Service Deployments V1
  cisco.dnac.wired_network_devices_network_device_id_config_features_intended_service_deployments_v1_info:
    dnac_host: "{{dnac_host}}"
