...
DOCUMENTATION = r"""
---
module: wired_network_devices_id_config_features_intended_layer2_feature_v1_info
short_description: Information module for Wired Network Devices Id Config Features
  Intended Layer2 Feature V1
description:
  - Get Wired Network Devices Id Config Features Intended Layer2 Feature V1 by id.
  - >
    This API returns the configurations for an intended layer 2 feature on a wired
    device. Even after the intended
    configurations are deployed using the API /dna/intent/api/v1/networkDevices/{id}/configFeatures/intended/deploy,
...
"""
EXAMPLES = r"""
- name: Get Wired Network Devices Id Config Features Intended Layer2 Feature V1
    by id
  cisco.dnac.wired_network_devices_id_config_features_intended_layer2_feature_v1_info:
    dnac_host: "{{dnac_host}}"
