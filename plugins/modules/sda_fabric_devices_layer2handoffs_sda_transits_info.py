...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2handoffs_sda_transits_info
short_description: Information module for Sda Fabric
  Devices Layer2handoffs Sda Transits
description:
  - Get all Sda Fabric Devices Layer2handoffs Sda Transits.
  - Returns a list of layer 3 handoffs with sda transit
...
seealso:
  - name: Cisco DNA Center documentation for SDA GetFabricDevicesLayer3HandoffsWithSdaTransit
    description: Complete reference of the GetFabricDevicesLayer3HandoffsWithSdaTransit
      API.
...
- name: Get all Sda Fabric Devices Layer2handoffs Sda
    Transits
  cisco.dnac.sda_fabric_devices_layer2handoffs_sda_transits_info:
    dnac_host: "{{dnac_host}}"
