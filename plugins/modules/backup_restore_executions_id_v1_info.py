...
DOCUMENTATION = r"""
---
module: backup_restore_executions_id_v1_info
short_description: Information module for Backup Restore Executions Id V1
description:
  - Get Backup Restore Executions Id V1 by id.
  - This api is used to get the execution detail of a specific backup or restore worflow
    process.
...
"""
EXAMPLES = r"""
- name: Get Backup Restore Executions Id V1 by id
  cisco.dnac.backup_restore_executions_id_v1_info:
    dnac_host: "{{dnac_host}}"
