...
DOCUMENTATION = r"""
---
module: maps_import_perform_v1
short_description: Resource module for Maps Import Perform V1
description:
  - Manage operation create of the resource Maps Import Perform V1.
  - >
    For a previously initatied import, approves the import to be performed, accepting
    that data loss may occur. A Map
    import will fully replace existing Maps data for the sites defined in the archive.
    The Map Archive Import Status
    API /maps/import/${contextUuid}/status should always be checked to validate the
    pre-import validation output prior
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.maps_import_perform_v1:
    dnac_host: "{{dnac_host}}"
