...
DOCUMENTATION = r"""
---
module: network_device_licenses_network_device_id_port_channels_v1_info
short_description: Information module for Network Device Licenses Network Device Id
  Port Channels V1
description:
  - Get all Network Device Licenses Network Device Id Port Channels V1.
...
"""
EXAMPLES = r"""
- name: Get all Network Device Licenses Network Device Id Port Channels V1
  cisco.dnac.network_device_licenses_network_device_id_port_channels_v1_info:
    dnac_host: "{{dnac_host}}"
