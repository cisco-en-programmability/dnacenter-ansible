...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_event_driven_r_r_m_configurations_id_v1_info
short_description: Information module for Feature Templates Wireless Event Driven
  R R M Configurations Id V1
description:
  - Get Feature Templates Wireless Event Driven R R M Configurations Id V1 by id.
  - This API allows users to retrieve a specific Event Driven RRM configuration feature
    template by ID.
...
"""
EXAMPLES = r"""
- name: Get Feature Templates Wireless Event Driven R R M Configurations Id V1 by
    id
  cisco.dnac.feature_templates_wireless_event_driven_r_r_m_configurations_id_v1_info:
    dnac_host: "{{dnac_host}}"
