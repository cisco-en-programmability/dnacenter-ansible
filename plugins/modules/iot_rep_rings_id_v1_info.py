...
DOCUMENTATION = r"""
---
module: iot_rep_rings_id_v1_info
short_description: Information module for Iot Rep Rings Id V1
description:
  - Get Iot Rep Rings Id V1 by id.
  - >
    This API returns REP ring for the given id The id of configured REP ring can be
...
"""
EXAMPLES = r"""
- name: Get Iot Rep Rings Id V1 by id
  cisco.dnac.iot_rep_rings_id_v1_info:
    dnac_host: "{{dnac_host}}"
