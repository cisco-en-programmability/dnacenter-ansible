...
description:
  ...
  - Returns the list of network device image updates
...
seealso:
  - name: Cisco DNA Center documentation for Software
      Image Management (SWIM) GetNetworkDeviceImageUpdates
    description: Complete reference of the GetNetworkDeviceImageUpdates
      API.
