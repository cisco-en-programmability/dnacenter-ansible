...
short_description: Information module for Network Device Image Updates
description:
...
options:
  ...
  hostName:
    description:
      - >
        HostName query parameter. Host name of the network device for the image update. Supports case-
