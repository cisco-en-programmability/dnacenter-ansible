...
DOCUMENTATION = r"""
---
module: networkDeviceImageUpdates_info
short_description: Information module for Networkdeviceimageupdates
description:
- Get all Networkdeviceimageupdates.
...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Software Image Management (SWIM) GetNetworkDeviceImageUpdates
  description: Complete reference of the GetNetworkDeviceImageUpdates API.
  link: https://developer.cisco.com/docs/dna-center/#!get-network-device-image-updates
notes:
  - SDK Method used are
    software_image_management_swim.SoftwareImageManagementSwim.get_network_device_image_updates,
...
EXAMPLES = r"""
- name: Get all Networkdeviceimageupdates
  cisco.dnac.networkDeviceImageUpdates_info:
    dnac_host: "{{dnac_host}}"
