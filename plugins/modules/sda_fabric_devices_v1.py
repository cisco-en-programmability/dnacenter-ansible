...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_v1
short_description: Resource module for Sda Fabric Devices V1
description:
- Manage operations create, update and delete of the resource Sda Fabric Devices V1.
...
notes:
  - SDK Method used are
    ...
    sda.Sda.delete_fabric_device_by_id_v1,
...
EXAMPLES = r"""
- name: Update all
  cisco.dnac.sda_fabric_devices_v1:
    dnac_host: "{{dnac_host}}"
