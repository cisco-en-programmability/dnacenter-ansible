...
DOCUMENTATION = r"""
---
module: network_device_user_defined_field_delete_v1
short_description: Resource module for Network Device User Defined Field Delete V1
description:
  - Manage operation delete of the resource Network Device User Defined Field Delete
    V1.
  - >
    Remove a User-Defined-Field from device. Name of UDF has to be passed as the query
...
EXAMPLES = r"""
- name: Delete all
  cisco.dnac.network_device_user_defined_field_delete_v1:
    dnac_host: "{{dnac_host}}"
