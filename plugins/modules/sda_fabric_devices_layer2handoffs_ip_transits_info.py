...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2handoffs_ip_transits_info
short_description: Information module for Sda Fabric
  Devices Layer2handoffs Ip Transits
description:
  - Get all Sda Fabric Devices Layer2handoffs Ip Transits.
  - Returns a list of layer 3 handoffs with ip transit
...
seealso:
  - name: Cisco DNA Center documentation for SDA GetFabricDevicesLayer3HandoffsWithIpTransit
    description: Complete reference of the GetFabricDevicesLayer3HandoffsWithIpTransit
      API.
...
EXAMPLES = r"""
---
- name: Get all Sda Fabric Devices Layer2handoffs Ip
    Transits
  cisco.dnac.sda_fabric_devices_layer2handoffs_ip_transits_info:
    dnac_host: "{{dnac_host}}"
