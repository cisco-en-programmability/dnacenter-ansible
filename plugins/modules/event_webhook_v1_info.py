...
DOCUMENTATION = r"""
---
module: event_webhook_v1_info
short_description: Information module for Event Webhook V1
description:
  - Get all Event Webhook V1.
...
"""
EXAMPLES = r"""
- name: Get all Event Webhook V1
  cisco.dnac.event_webhook_v1_info:
    dnac_host: "{{dnac_host}}"
