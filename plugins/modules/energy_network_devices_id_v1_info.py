...
DOCUMENTATION = r"""
---
module: energy_network_devices_id_v1_info
short_description: Information module for Energy Network Devices Id V1
description:
  - Get Energy Network Devices Id V1 by id.
  - >
    Retrieves network device energy data for a specified time range based on the device
...
"""
EXAMPLES = r"""
- name: Get Energy Network Devices Id V1 by id
  cisco.dnac.energy_network_devices_id_v1_info:
    dnac_host: "{{dnac_host}}"
