...
DOCUMENTATION = r"""
---
module: dns_services_count_v1_info
short_description: Information module for Dns Services Count V1
description:
- Get all Dns Services Count V1.
- >
...
options:
  ...
  ssid:
    ...
    - >
      ...
      search. If the field contains the (`*`) character, please use the /query API for search. Ex `*Alpha*` or
      `Alpha*` or `*Alpha` Examples `ssid=Alpha` (single ssid requested) `ssid=Alpha&ssid=Guest` (multiple ssid
      requested).
    type: str
requirements:
- dnacentersdk >= 2.4.9
...
- name: Cisco DNA Center documentation for Devices RetrievesTheTotalNumberOfDNSServicesForGivenParametersV1
  description: Complete reference of the RetrievesTheTotalNumberOfDNSServicesForGivenParametersV1 API.
...
EXAMPLES = r"""
- name: Get all Dns Services Count V1
  cisco.dnac.dns_services_count_v1_info:
    dnac_host: "{{dnac_host}}"
