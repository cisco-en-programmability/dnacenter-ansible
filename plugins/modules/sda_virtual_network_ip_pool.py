...
options:
  ...
  isBridgeModeVm:
    ...
    type: bool
  isCommonPool:
    description: Common Pool enablement flag(applicable for L3 and L2 and default
      value is False ).
    type: bool
  isIpDirectedBroadcast:
    ...
    type: bool
  isL2FloodingEnabled:
    description: Layer2 flooding enablement flag(applicable for L3 , L2 and always
  ...
  isLayer2Only:
    ...
    type: bool
  isThisCriticalPool:
    description: Critical pool enablement flag(applicable for L3 and default value
      is False ).
    type: bool
    version_added: 4.0.0
  isWirelessPool:
  ...
  vlanId:
    ...
    type: str
  vlanName:
    description: Vlan name represent the segment name, if empty, vlanName would be
...
notes:
  - SDK Method used are sda.Sda.add_ip_pool_in_sda_virtual_network_v1, sda.Sda.delete_ip_pool_from_sda_virtual_network_v1,
  - Paths used are post /dna/intent/api/v1/business/sda/virtualnetwork/ippool, delete
