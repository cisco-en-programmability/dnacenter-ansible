...
description:
  ...
  - >
    User can configure multiple access points with required options using this intent
    API. This API does not support
    configuration of CleanAir or SI for IOS-XE devices with version greater than or
    equal to 17.9.
version_added: '3.1.0'
  ...
  radioConfigurations:
    ...
    suboptions:
      ...
      channelWidth:
        ...
        type: int
      cleanAirSI:
        description: Configure CleanAir or Spectrum Intelligence on the specified
          radio for an access point. Set this parameter's value to "0" to disable
          the feature or "1" to enable it.
        type: int
      configureAdminStatus:
      ...
      configureChannelWidth:
        ...
        type: bool
      configureCleanAirSI:
        description: To enable or disable either CleanAir or Spectrum Intelligence
          on the specified radio for an access point, set this parameter's value to
          "true".
        type: bool
      configurePower:
...
notes:
  - SDK Method used are wireless.Wireless.configure_access_points_v1,
