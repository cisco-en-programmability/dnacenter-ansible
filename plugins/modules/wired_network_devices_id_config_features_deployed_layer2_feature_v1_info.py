...
DOCUMENTATION = r"""
---
module: wired_network_devices_id_config_features_deployed_layer2_feature_v1_info
short_description: Information module for Wired Network Devices Id Config Features
  Deployed Layer2 Feature V1
description:
  - Get Wired Network Devices Id Config Features Deployed Layer2 Feature V1 by id.
...
"""
EXAMPLES = r"""
- name: Get Wired Network Devices Id Config Features Deployed Layer2 Feature V1
    by id
  cisco.dnac.wired_network_devices_id_config_features_deployed_layer2_feature_v1_info:
    dnac_host: "{{dnac_host}}"
