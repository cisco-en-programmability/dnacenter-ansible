...
def main():
    ...
    if (
        ...
        ccc_provision.msg = "The specified version '{0}' does not support the 'provision_workflow_manager' feature. Supported versions start from '2.3.5.3' onwards. ".format(
