...
DOCUMENTATION = r"""
---
module: licenseSetting_info
short_description: Information module for Licensesetting
description:
- Get all Licensesetting.
- >
   Retrieves license setting - Default smart account id and virtual account id for auto registration of devices for
   smart license flow. If default smart account is not configured, 'defaultSmartAccountId' is 'null'. Similarly, if
   auto registration of devices for smart license flow is not enabled, 'autoRegistrationVirtualAccountId' is 'null'.
   For smart proxy connection mode, 'autoRegistrationVirtualAccountId' is always 'null'.
...
EXAMPLES = r"""
- name: Get all Licensesetting
  cisco.dnac.licenseSetting_info:
    dnac_host: "{{dnac_host}}"
