...
DOCUMENTATION = r"""
---
module: sites_dhcp_settings_v1_info
short_description: Information module for Sites Dhcp Settings V1
description:
  - Get all Sites Dhcp Settings V1.
  - >
    Retrieve DHCP settings for a site; `null` values indicate that the setting will
...
seealso:
  - name: Cisco DNA Center documentation for Network Settings RetrieveDHCPSettingsForASiteV1
    ...
    link:
      https://developer.cisco.com/docs/dna-center/#!retrieve-dhcp-settings-for-a-site
notes:
  - SDK Method used are network_settings.NetworkSettings.retrieve_d_h_c_p_settings_for_a_site_v1,
  - Paths used are get /dna/intent/api/v1/sites/{id}/dhcpSettings,
"""
EXAMPLES = r"""
- name: Get all Sites Dhcp Settings V1
  cisco.dnac.sites_dhcp_settings_v1_info:
    dnac_host: "{{dnac_host}}"
