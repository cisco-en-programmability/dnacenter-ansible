...
DOCUMENTATION = r"""
---
module: sda_authentication_profiles_v1_info
short_description: Information module for Sda Authentication Profiles V1
description:
  - Get all Sda Authentication Profiles V1.
...
options:
  ...
  fabricId:
    description:
      - FabricId query parameter. ID of the fabric the authentication profile is assigned
        to.
    type: str
  authenticationProfileName:
    description:
      - >
        AuthenticationProfileName query parameter. Return only the authentication
        profiles with this specified name.
        Note that 'No Authentication' is not a valid option for this parameter.
    type: str
  isGlobalAuthenticationProfile:
    description:
      - >
        IsGlobalAuthenticationProfile query parameter. Set to true to return only
        global authentication profiles, or
        set to false to hide them. IsGlobalAuthenticationProfile must not be true
        when fabricId is provided.
    type: bool
  offset:
    description:
