...
DOCUMENTATION = r"""
---
module: network_device_images_validations_v1
short_description: Resource module for Network Device Images Validations V1
description:
  - Manage operation create of the resource Network Device Images Validations V1.
  - >
    Custom network device validation refers to the tailored process of verifying and
    assessing the configurations of
    network devices based on specific organizational requirements and unique network
    environments. Unlike standard
    validations, custom network device validations are designed to address the distinctive
    needs and challenges of a
    particular network infrastructure, ensuring that devices operate optimally within
    the defined parameters. Upon
    task completion, the task API response's `resultLocation` attribute will provide
    the URL to retrieve the
    validation id.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.network_device_images_validations_v1:
    dnac_host: "{{dnac_host}}"
