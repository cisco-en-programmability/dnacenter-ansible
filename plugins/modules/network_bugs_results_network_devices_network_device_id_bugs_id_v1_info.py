...
short_description: Information module for Network Bugs Results Network Devices Network Device Id Bugs Id V1
description:
...
EXAMPLES = r"""
- name: Get Network Bugs Results Network Devices Network Device Id Bugs Id V1 by id
