...
DOCUMENTATION = r"""
---
module: wireless_accesspoint_configuration_create_v2
short_description: Resource module for Wireless Accesspoint Configuration Create V2
description:
- Manage operation create of the resource Wireless Accesspoint Configuration Create V2.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.wireless_accesspoint_configuration_create_v2:
    dnac_host: "{{dnac_host}}"
