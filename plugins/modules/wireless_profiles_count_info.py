...
DOCUMENTATION = r"""
---
module: wirelessProfiles_count_info
short_description: Information module for Wirelessprofiles Count
description:
- Get all Wirelessprofiles Count.
...
EXAMPLES = r"""
- name: Get all Wirelessprofiles Count
  cisco.dnac.wirelessProfiles_count_info:
    dnac_host: "{{dnac_host}}"
