...
DOCUMENTATION = r"""
---
module: network_bugs_results_network_devices_v1_info
short_description: Information module for Network Bugs Results Network Devices V1
description:
  - Get all Network Bugs Results Network Devices V1.
...
notes:
  - SDK Method used are compliance.Compliance.get_network_bug_devices_v1,
  - Paths used are get /dna/intent/api/v1/networkBugs/results/networkDevices,
"""
EXAMPLES = r"""
- name: Get all Network Bugs Results Network Devices V1
  cisco.dnac.network_bugs_results_network_devices_v1_info:
    dnac_host: "{{dnac_host}}"
