...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Site Design RetrieveANetworkProfileForSitesById
...
- name: Cisco DNA Center documentation for Site Design RetrievesTheListOfNetworkProfilesForSites
...
- name: Get all Networkdevices Networkprofilesforsites
  cisco.dnac.networkDevices_networkProfilesForSites_info:
    dnac_host: "{{dnac_host}}"
