...
DOCUMENTATION = r"""
---
module: sda_fabricDevices_layer2Handoffs_ipTransits_count_info
short_description: Information module for Sda Fabricdevices
  Layer2handoffs Iptransits Count
description:
  - Get all Sda Fabricdevices Layer2handoffs Iptransits
    Count.
  - Returns the count of layer 3 handoffs with ip transit
...
seealso:
  - name: Cisco DNA Center documentation for SDA GetFabricDevicesLayer3HandoffsWithIpTransitCount
    description: Complete reference of the GetFabricDevicesLayer3HandoffsWithIpTransitCount
      API.
...
- name: Get all Sda Fabricdevices Layer2handoffs Iptransits
    Count
  cisco.dnac.sda_fabricDevices_layer2Handoffs_ipTransits_count_info:
    dnac_host: "{{dnac_host}}"
