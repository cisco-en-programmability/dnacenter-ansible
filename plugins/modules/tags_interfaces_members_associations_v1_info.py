...
DOCUMENTATION = r"""
---
module: tags_interfaces_members_associations_v1_info
short_description: Information module for Tags Interfaces Members Associations V1
description:
- Get all Tags Interfaces Members Associations V1.
- >
   Fetches the tags associated with the interfaces. Interfaces that don't have any tags associated will not be
   included in the response. A tag is a user-defined or system-defined construct to group resources. When an
   interface is tagged, it is called a member of the tag.
...
- name: Cisco DNA Center documentation for Tag RetrieveTagsAssociatedWithTheInterfacesV1
  ...
  link: https://developer.cisco.com/docs/dna-center/#!retrieve-tags-associated-with-the-interfaces-v-1
notes:
  - SDK Method used are
...
EXAMPLES = r"""
- name: Get all Tags Interfaces Members Associations V1
  cisco.dnac.tags_interfaces_members_associations_v1_info:
    dnac_host: "{{dnac_host}}"
