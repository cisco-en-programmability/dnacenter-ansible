...
DOCUMENTATION = r"""
---
module: wirelessControllers_ssidDetails_info
short_description: Information module for Wirelesscontrollers Ssiddetails
description:
- Get all Wirelesscontrollers Ssiddetails.
...
options:
  ...
  ssidName:
    description:
    - >
      SsidName query parameter. Employ this query parameter to obtain the details of the SSID corresponding to the
      provided SSID name.
    type: str
  adminStatus:
    description:
    - >
      ...
      value signifies that the admin status of the SSID is enabled, while a 'false' value indicates that the admin
...
EXAMPLES = r"""
- name: Get all Wirelesscontrollers Ssiddetails
  cisco.dnac.wirelessControllers_ssidDetails_info:
    dnac_host: "{{dnac_host}}"
