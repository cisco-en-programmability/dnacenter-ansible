...
description: |
  ...
  - This module provides comprehensive management of Layer 2 wired network configurations in Cisco Catalyst Center.
  - Configure VLANs, STP, CDP, LLDP, VTP, DHCP Snooping, IGMP/MLD Snooping, authentication, port channels, and interface settings.
            ...
            suboptions:
              ...
              stp_portfast_mode:
                description: |
                  ...
                  - Advanced portfast modes (EDGE, NETWORK, TRUNK) are only supported on Catalyst 9600 Series and specific Catalyst 9500 Series models (C9500-32C, C9500-32QC, C9500-48Y4C, C9500-24Y4C, C9500X-28C8D).
                type: str
                required: false
            ...
            suboptions:
              vtp_mode:
                description: |
                  ...
                  - If extended range VLANs are configured on the device, VTP mode must be set to TRANSPARENT or OFF.
                type: str
                required: false
              ...
              vtp_configuration_file_name:
                description: |
                  ...
                  - NOTE Due to API limitations, this parameter does not support empty string values ("") for resetting to default.
                  - To reset this parameter, the entire VTP configuration has to be reset using the "deleted" state.
                type: str
                required: false
            ...
            suboptions:
              ...
              dhcp_snooping_vlans:
                description: |
                  ...
                  - All VLANs specified in "dhcp_snooping_proxy_bridge_vlans" must also be included in this list.
                type: list
                elements: int
                required: false
              dhcp_snooping_glean:
              ...
              dhcp_snooping_database_agent_url:
                description: |
                  ...
                  - The URL must start with one of the following protocol prefixes "bootflash:", "crashinfo:", "flash:", "ftp:", "http:", "https:", "rcp:", "scp:", "sftp:", or "tftp:"
                  - Examples of valid URLs tftp URL "tftp://192.168.1.100/dhcp_bindings.db", ftp URL "ftp://server.example.com/backups/dhcp_bindings.db", flash URL "flash:dhcp_bindings.db", bootflash URL "bootflash:dhcp_bindings.db"
                type: str
                required: false
            ...
            suboptions:
              ...
              port_channel_load_balancing_method:
                description: |
                  ...
                  - SRC_MAC, DST_MAC, SRC_DST_MAC - Based on MAC addresses.
                  - SRC_IP, DST_IP, SRC_DST_IP - Based on IP addresses.
                  - SRC_PORT, DST_PORT, SRC_DST_PORT - Based on TCP/UDP ports.
                ...
                type: str
                required: false
                choices: [SRC_MAC, DST_MAC, SRC_DST_MAC, SRC_IP, DST_IP, SRC_DST_IP, SRC_PORT, DST_PORT, SRC_DST_PORT, SRC_DST_MIXED_IP_PORT, SRC_MIXED_IP_PORT, DST_MIXED_IP_PORT, VLAN_SRC_IP, VLAN_DST_IP, VLAN_SRC_DST_IP, VLAN_SRC_MIXED_IP_PORT, VLAN_DST_MIXED_IP_PORT, VLAN_SRC_DST_MIXED_IP_PORT]
                default: SRC_DST_IP
              port_channels:
                description: |
...
EXAMPLES = r"""
---
# Example 1: Create and manage VLANs
...
# Example 2: Update existing VLAN configuration
...
# Example 3: Delete specific VLANs
- name: Delete VLANs
  cisco.dnac.wired_campus_automation_workflow_manager:
    dnac_host: "{{ dnac_host }}"
    dnac_username: "{{ dnac_username }}"
...
# Example 4: Configure CDP with comprehensive settings
...
# Example 5: Configure LLDP with custom parameters
...
# Example 6: Configure STP with global settings and instances
...
# Example 7: Configure VTP (VLAN Trunking Protocol)
...
# Example 8: Configure DHCP Snooping security feature
...
# Example 9: Configure IGMP Snooping with VLAN-specific settings
...
# Example 10: Configure MLD Snooping for IPv6 multicast
...
# Example 11: Configure 802.1X Authentication
...
# Example 12: Configure Port Channels (Logical Ports)
...
# Example 13: Configure Access Port with comprehensive settings
...
# Example 14: Configure Trunk Port with VLAN settings
...
# Example 15: Comprehensive configuration with all features
...
# Example 16: Reset protocols to default settings (delete operation)
...
# Example 17: Reset LLDP to default settings
...
# Example 18: Delete specific STP instances
...
# Example 19: Comprehensive cleanup - Reset all features to defaults
...
# Example 20: Using hostname instead of IP address
...
class WiredCampusAutomation(DnacBase):
        ...
        self.temp_spec = {
            ...
            "layer2_configuration": {
                ...
                "dhcp_snooping": {
                    ...
                    "dhcp_snooping_proxy_bridge_vlans": {"type": "list", "elements": "int"}
                },
                "igmp_snooping": {
                    "type": "dict",
                    ...
                    "igmp_snooping_vlans": {
                        ...
                        "suboptions": {
                            ...
                            "igmp_snooping_querier_version": {"type": "str"},
                            "igmp_snooping_querier_query_interval": {"type": "int"},
                            "igmp_snooping_mrouter_port_list": {"type": "list", "elements": "str"},
                        }
                    }
                },
                "mld_snooping": {
                    ...
                    "mld_snooping_vlans": {
                        ...
                        "suboptions": {
                            ...
                            "mld_snooping_querier_version": {"type": "str"},
                            "mld_snooping_querier_query_interval": {"type": "int"},
                            "mld_snooping_mrouter_port_list": {"type": "list", "elements": "str"},
                        }
                    }
                },
                "authentication": {
                ...
                "port_configuration": {
                    ...
                    "suboptions": {
                        ...
                        "dot1x_interface_config": {
                            ...
                            "dot1x_interface_enable_inactivity_timer_from_server": {"type": "bool"},
                            "dot1x_interface_inactivity_timer": {"type": "int"},
                            "dot1x_interface_authentication_order": {"type": "list", "elements": "str"},
                            "dot1x_interface_enable_reauth": {"type": "bool"},
                            "dot1x_interface_port_control": {"type": "str"},
                            "dot1x_interface_priority": {"type": "list", "elements": "str"},
                            "dot1x_interface_max_reauth_requests": {"type": "int"},
                            "dot1x_interface_enable_reauth_timer_from_server": {"type": "bool"},
                        ...
                        "stp_interface_config": {
                            ...
                            "stp_interface_priority": {"range": (0, 240), "multiple_of": 16, "required": False},
                            "stp_interface_per_vlan_cost": {
                                "type": "dict",
                                "priority": {"type": "int"},
            ...
            "config_verification_wait_time": {"type": "int", "required": False, "default": 10},
        }
    ...
    def get_device_list_params(self, ip_address, hostname):
        ...
        if ip_address:
            self.log("Using IP address '{0}' for device list parameters".format(ip_address), "DEBUG")
            return {"management_ip_address": ip_address}
        
        # Return a dictionary with 'hostname' if hostname is provided
        if hostname:
            self.log("Using hostname '{0}' for device list parameters".format(hostname), "DEBUG")
            return {"hostname": hostname}
        
        # Return an empty dictionary if neither is provided
        self.log("No IP address or hostname provided, returning empty parameters", "DEBUG")
        return {}
    ...
    def get_layer2_configuration_validation_rules(self):
        ...
        return {
            ...
            "cdp": {
                ...
                "cdp_timer": {"type": "int", "range": (5, 254), "required": False},  # Added type: int
            ...
            "lldp": {
                ...
                "lldp_hold_time": {"type": "int", "range": (0, 32767), "required": False},  # Added type: int
                "lldp_timer": {"type": "int", "range": (5, 32767), "required": False},  # Added type: int
                "lldp_reinitialization_delay": {"type": "int", "range": (2, 5), "required": False},  # Added type: int
            },
            "stp": {
                "stp_mode": {"type": "str", "choices": ["PVST", "RSTP", "MST"], "required": False},
                "stp_portfast_mode": {"type": "str", "choices": ["ENABLE", "DISABLE", "EDGE", "NETWORK", "TRUNK"], "required": False},
                ...
                "stp_transmit_hold_count": {"type": "int", "range": (1, 20), "required": False},  # Added type: int
                "stp_uplinkfast": {"type": "bool", "required": False},
                "stp_uplinkfast_max_update_rate": {"type": "int", "range": (0, 32000), "required": False},  # Added type: int
                "stp_etherchannel_guard": {"type": "bool", "required": False},
                "stp_instances": {"type": "list", "required": False},
            },
            "stp_instance": {
                "stp_instance_vlan_id": {"type": "int", "range": (1, 4094), "required": True},  # Added type: int
                "stp_instance_priority": {"type": "int", "range": (0, 61440), "multiple_of": 4096, "required": False},  # Added type: int
                "enable_stp": {"type": "bool", "required": False},
                "stp_instance_max_age_timer": {"type": "int", "range": (6, 40), "required": False},  # Added type: int
                "stp_instance_hello_interval_timer": {"type": "int", "range": (1, 10), "required": False},  # Added type: int
                "stp_instance_forward_delay_timer": {"type": "int", "range": (4, 30), "required": False},  # Added type: int
            },
            "vtp": {
                "vtp_mode": {"type": "str", "choices": ["SERVER", "CLIENT", "TRANSPARENT", "OFF"], "required": False},
                "vtp_version": {"type": "str", "choices": ["VERSION_1", "VERSION_2", "VERSION_3"], "required": False},
                "vtp_domain_name": {"type": "str", "maxLength": 32, "required": False},
                "vtp_pruning": {"type": "bool", "required": False},
                "vtp_configuration_file_name": {"type": "str", "maxLength": 244, "required": False},
                "vtp_source_interface": {"type": "str", "required": False},
            },
            "dhcp_snooping": {
                "dhcp_admin_status": {"type": "bool", "required": False},
                "dhcp_snooping_vlans": {"type": "list", "elements": "int", "vlan_range": (1, 4094), "required": False},
                "dhcp_snooping_glean": {"type": "bool", "required": False},
                "dhcp_snooping_database_agent_url": {"type": "str", "minLength": 0, "maxLength": 227, "required": False},
                "dhcp_snooping_database_timeout": {"type": "int", "range": (0, 86400), "required": False},  # Added type: int
                "dhcp_snooping_database_write_delay": {"type": "int", "range": (15, 86400), "required": False},  # Added type: int
                "dhcp_snooping_proxy_bridge_vlans": {"type": "list", "elements": "int", "vlan_range": (1, 4094), "required": False},
            },
            "igmp_snooping": {
                ...
                "igmp_snooping_querier_version": {"type": "str", "choices": ["VERSION_1", "VERSION_2", "VERSION_3"], "required": False},
                "igmp_snooping_querier_query_interval": {"type": "int", "range": (1, 18000), "required": False},  # Added type: int
                "igmp_snooping_vlans": {"type": "list", "required": False},
            },
            "igmp_snooping_vlan": {
                "igmp_snooping_vlan_id": {"type": "int", "range": (1, 4094), "required": True},  # Added type: int
                "enable_igmp_snooping": {"type": "bool", "required": False},
            ...
            "mld_snooping": {
                ...
                "mld_snooping_querier_version": {"type": "str", "choices": ["VERSION_1", "VERSION_2"], "required": False},
                "mld_snooping_querier_query_interval": {"type": "int", "range": (1, 18000), "required": False},  # Added type: int
                "mld_snooping_listener": {"type": "bool", "required": False},
                "mld_snooping_vlans": {"type": "list", "required": False},
            },
            "mld_snooping_vlan": {
                "mld_snooping_vlan_id": {"type": "int", "range": (1, 4094), "required": True},  # Added type: int
                "enable_mld_snooping": {"type": "bool", "required": False},
                "mld_snooping_enable_immediate_leave": {"type": "bool", "required": False},
                "mld_snooping_querier": {"type": "bool", "required": False},
                "mld_snooping_querier_address": {"type": "str", "required": False},
                "mld_snooping_querier_version": {"type": "str", "choices": ["VERSION_1", "VERSION_2"], "required": False},
                "mld_snooping_querier_query_interval": {"type": "int", "range": (1, 18000), "required": False},  # Added type: int
            ...
            "authentication": {
                ...
                "authentication_config_mode": {"type": "str", "choices": ["LEGACY", "NEW_STYLE"], "required": False},
            },
            "logical_ports": {
                "port_channel_auto": {"type": "bool", "required": False},
                "port_channel_lacp_system_priority": {"type": "int", "range": (0, 65535), "required": False},  # Added type: int
                "port_channel_load_balancing_method": {
                    "type": "str", 
                    "choices": [
                        "SRC_MAC", "DST_MAC", "SRC_DST_MAC", "SRC_IP", "DST_IP", "SRC_DST_IP", 
                        "SRC_PORT", "DST_PORT", "SRC_DST_PORT", "SRC_DST_MIXED_IP_PORT",
            ...
            "port_channel": {
                "port_channel_protocol": {"type": "str", "choices": ["LACP", "PAGP", "NONE"], "required": True},
                "port_channel_name": {"type": "str", "minLength": 13, "maxLength": 15, "required": False},
                "port_channel_min_links": {"type": "int", "range": (2, 8), "required": False},  # Added type: int
                "port_channel_members": {"type": "list", "required": True},
            },
            "port_channel_member_lacp": {
                "port_channel_interface_name": {"type": "str", "required": False},
                "port_channel_mode": {"type": "str", "choices": ["ACTIVE", "PASSIVE"], "required": False},
                "port_channel_port_priority": {"type": "int", "range": (0, 65535), "required": False},  # Added type: int
                "port_channel_rate": {"type": "int", "range": (1, 30), "required": False},  # Added type: int
            },
            "port_channel_member_pagp": {
                "port_channel_interface_name": {"type": "str", "required": True},
                "port_channel_mode": {"type": "str", "choices": ["AUTO", "AUTO_NON_SILENT", "DESIRABLE", "DESIRABLE_NON_SILENT"], "required": False},
                "port_channel_port_priority": {"type": "int", "range": (0, 255), "required": False},  # Added type: int
                "port_channel_learn_method": {"type": "str", "choices": ["AGGREGATION_PORT", "PHYSICAL_PORT"], "required": False},
            },
            "port_channel_member_none": {
                "port_channel_interface_name": {"type": "str", "required": True},
                "port_channel_mode": {"type": "str", "choices": ["ON"], "required": False},
            },
            "switchport_interface_config": {
                "switchport_description": {"type": "str", "maxLength": 230, "required": False},
                "switchport_mode": {"type": "str", "choices": ["ACCESS", "TRUNK", "DYNAMIC_AUTO", "DYNAMIC_DESIRABLE", "DOT1Q_TUNNEL"], "required": False},
                "access_vlan": {"type": "int", "range": (1, 4094), "required": False},  # Added type: int
                "voice_vlan": {"type": "int", "range": (1, 4094), "required": False},  # Added type: int
                "admin_status": {"type": "bool", "required": False},
                "allowed_vlans": {"type": "list", "elements": "int", "vlan_range": (1, 4094), "required": False},
                "native_vlan_id": {"type": "int", "range": (1, 4094), "required": False},  # Added type: int
            },
            "vlan_trunking_interface_config": {
                "enable_dtp_negotiation": {"type": "bool", "required": False},
                "protected": {"type": "bool", "required": False},
                "pruning_vlan_ids": {"type": "list", "elements": "int", "required": False},
            },
            "dot1x_interface_config": {
                "dot1x_interface_authentication_mode": {"type": "str", "choices": ["OPEN", "CLOSED"], "required": False},
                "dot1x_interface_pae_type": {"type": "str", "choices": ["NONE", "AUTHENTICATOR", "SUPPLICANT", "BOTH"], "required": False},
                "dot1x_interface_control_direction": {"type": "str", "choices": ["IN", "BOTH"], "required": False},
                "dot1x_interface_host_mode": {"type": "str", "choices": ["MULTI_AUTHENTICATION", "MULTI_HOST", "SINGLE_HOST", "MULTI_DOMAIN"], "required": False},
                "dot1x_interface_inactivity_timer_from_server": {"type": "bool", "required": False},
                "dot1x_interface_inactivity_timer": {"type": "int", "range": (0, 65535), "required": False},  # Added type: int
                "dot1x_interface_authentication_order": {"type": "list", "elements": "str", "choices": ["DOT1X", "MAB", "WEBAUTH"], "max_items": 3, "required": False},
                "dot1x_interface_reauthentication": {"type": "bool", "required": False},
                "dot1x_interface_port_control": {"type": "str", "choices": ["AUTO", "FORCE_AUTHORIZED", "FORCE_UNAUTHORIZED"], "required": False},
                "dot1x_interface_priority": {"type": "list", "elements": "str", "choices": ["DOT1X", "MAB", "WEBAUTH"], "required": False},
                "dot1x_interface_max_reauth_requests": {"type": "int", "range": (1, 10), "required": False},  # Added type: int
                "dot1x_interface_reauth_timer_from_server": {"type": "bool", "required": False},
                "dot1x_interface_reauth_timer": {"type": "int", "range": (1, 1073741823), "required": False},  # Added type: int
                "dot1x_interface_tx_period": {"type": "int", "range": (1, 65535), "required": False}  # Added type: int
            },
            "mab_interface_config": {
                "enable_mab": {"type": "bool", "required": False},
            },
            "stp_interface_config": {
                "stp_interface_portfast_mode": {"type": "str", "choices": ["NONE", "DISABLE", "EDGE", "EDGE_TRUNK", "NETWORK", "TRUNK"], "required": False},
                "stp_interface_bpdu_filter": {"type": "bool", "required": False},
                "stp_interface_bpdu_guard": {"type": "bool", "required": False},
                "stp_interface_cost": {"type": "int", "range": (1, 20000000), "required": False},  # Added type: int
                "stp_interface_guard": {"type": "str", "choices": ["LOOP", "ROOT", "NONE"], "required": False},
                "stp_interface_priority":  {"type": "int", "range": (0, 240), "multiple_of": 16, "required": False},  # Added type: int
            },
            "dhcp_snooping_interface_config": {
                "dhcp_snooping_interface_rate": {"type": "int", "range": (1, 2048), "required": False},  # Added type: int
                "dhcp_snooping_interface_trust": {"type": "bool", "required": False},
            },
            "cdp_interface_config": {
                "cdp_interface_admin_status": {"type": "bool", "required": False},
                "cdp_interface_log_duplex_mismatch": {"type": "bool", "required": False},
            },
            "lldp_interface_config": {
                "lldp_interface_receive_transmit": {"type": "str", "choices": ["TRANSMIT_ONLY", "RECEIVE_ONLY", "TRANSMIT_AND_RECEIVE", "DISABLED"], "required": False},
            },
            "vtp_interface_config": {
                "vtp_interface_admin_status": {"type": "bool", "required": False},
            },
            "stp_interface_per_vlan_cost": {
                "priority": {"type": "int", "range": (1, 20000000), "required": False},  # Added type: int
                "vlan_ids": {"type": "list", "elements": "int", "vlan_range": (1, 4094), "required": False},
            },
            "stp_interface_per_vlan_priority": {
                "priority": {"type": "int", "range": (0, 240), "multiple_of": 16, "required": False},  # Added type: int
                "vlan_ids": {"type": "list", "elements": "int", "vlan_range": (1, 4094), "required": False},
            },
        }
    ...
    def validate_config_against_rules(self, config_name, config_values, rules):
        ...
        """
        self.log("Starting validation for configuration '{0}'.".format(config_name), "INFO")
        ...
        for param, rule in rules.items():
            ...
            self.log("Validating parameter '{0}' with value '{1}' against rule '{2}'.".format(param, value, rule), "DEBUG")
            ...
            if value is None:
                self.log("Parameter '{0}' has None value and is not required. Skipping validation.".format(param), "DEBUG")
                continue
            ...
            if "type" in rule and value is not None:
                ...
                if expected_type == "bool" and not isinstance(value, bool):
                    ...
                    self.fail_and_exit(self.msg)
                elif expected_type == "int" and (isinstance(value, bool) or not isinstance(value, int)):
            ...
            if "choices" in rule and value is not None:
                ...
                valid_choices = [choice.upper() if isinstance(choice, str) else choice for choice in rule["choices"]]
                    ...
                    for i, item in enumerate(value):
                        ...
                        if item_upper not in valid_choices:
                            self.msg = "Item '{0}' at index {1} in parameter '{2}' of configuration '{3}' must be one of {4}. Provided value: '{5}'. Full configuration: {6}".format(
                                item, i, param, config_name, rule["choices"], value, config_values
                            )
                            self.fail_and_exit(self.msg)
                else:
            ...
            if "elements" in rule and rule["elements"] == "int" and "vlan_range" in rule and isinstance(value, list):
                ...
                for i, item in enumerate(value):
                    if not isinstance(item, int) or not (min_vlan <= item <= max_vlan):
                        self.msg = "Item {0} in list parameter '{1}' of configuration '{2}' must be an integer between {3} and {4}. Provided value: '{5}'. Full configuration: {6}".format(
                            i, param, config_name, min_vlan, max_vlan, item, config_values
                        )
                        self.fail_and_exit(self.msg)

            self.log("Parameter '{0}' passed validation.".format(param), "DEBUG")

        self.log("Validation for configuration '{0}' completed successfully.".format(config_name), "INFO")
    ...
    def _validate_vlans_config(self, vlan_config, rules):
        ...
        """
        self.log("Starting validation for VLAN configurations list with {0} items".format(len(vlan_config)), "INFO")
        
        # Iterate over each VLAN configuration in the list
        for index, vlan in enumerate(vlan_config):
            self.log("Processing VLAN configuration at index {0}".format(index), "DEBUG")
            
            # Validate that each VLAN configuration is a dictionary
            if not isinstance(vlan, dict):
                self.msg = "Each VLAN configuration must be a dictionary. Found: {0}".format(
                    type(vlan).__name__
                )
                self.log("VLAN configuration type validation failed at index {0}".format(index), "ERROR")
                self.fail_and_exit(self.msg)
            ...
            self.log("VLAN configuration at index {0} validated successfully".format(index), "DEBUG")
    ...
    def _validate_stp_config(self, stp_config, rules):
        ...
        self.log("Extracted STP instances for separate validation: {0}".format(bool(stp_instances)), "DEBUG")
    ...
    def _validate_stp_instances(self, stp_instances):
        ...
        if not isinstance(stp_instances, list):
            ...
            self.log("STP instances type validation failed - expected list but got {0}".format(type(stp_instances).__name__), "ERROR")
            self.fail_and_exit(self.msg)
        
        self.log("STP instances list contains {0} items".format(len(stp_instances)), "DEBUG")
        
        # Get validation rules for STP instance
        rules = self.get_layer2_configuration_validation_rules().get("stp_instance")
        self.log("Validation rules for STP instance configurations: {0}".format(rules), "DEBUG")
        ...
        for index, instance in enumerate(stp_instances):
            ...
            if not isinstance(instance, dict):
                ...
                self.log("STP instance type validation failed at index {0} - expected dict but got {1}".format(index, type(instance).__name__), "ERROR")
                self.fail_and_exit(self.msg)
            
            self.log("Validating STP instance configuration: {0}".format(instance), "DEBUG")
            ...
            self.log("STP instance at index {0} validated successfully".format(index), "DEBUG")
    ...
    def _validate_dhcp_snooping_config(self, dhcp_snooping_config, rules):
        ...
        self.log("Validating DHCP Snooping configuration: {0}".format(dhcp_snooping_config), "DEBUG")
        ...
        for param in vlan_params:
            ...
            if value:
                self.log("Validating VLAN parameter '{0}' with value: {1}".format(param, value), "DEBUG")
                ...
                self.log("VLAN parameter '{0}' validated successfully with {1} VLAN IDs".format(param, len(value)), "DEBUG")
        ...
        self.log("DHCP Snooping configuration validation completed successfully", "INFO")
    ...
    def _validate_igmp_snooping_config(self, igmp_snooping_config, rules):
        ...
        self.log("Validating IGMP Snooping configuration: {0}".format(igmp_snooping_config), "DEBUG")
        ...
        self.log("Extracted IGMP Snooping VLANs for separate validation: {0}".format(bool(igmp_snooping_vlans)), "DEBUG")
        ...
        self.log("IGMP Snooping global configuration validation completed successfully", "DEBUG")
        ...
        if igmp_snooping_vlans:
            ...
            self.log("IGMP Snooping VLAN settings validation completed successfully", "DEBUG")
        else:
            self.log("No IGMP Snooping VLAN settings found to validate", "DEBUG")
        
        self.log("IGMP Snooping configuration validation completed successfully", "INFO")
    ...
    def _validate_igmp_snooping_vlans(self, igmp_snooping_vlans):
        ...
        if not isinstance(igmp_snooping_vlans, list):
            ...
            self.log("IGMP Snooping VLANs type validation failed - expected list but got {0}".format(type(igmp_snooping_vlans).__name__), "ERROR")
            self.fail_and_exit(self.msg)
        
        self.log("IGMP Snooping VLANs list contains {0} items".format(len(igmp_snooping_vlans)), "DEBUG")
        
        # Get validation rules for IGMP Snooping VLAN
        rules = self.get_layer2_configuration_validation_rules().get("igmp_snooping_vlan")
        self.log("Validation rules for IGMP Snooping VLAN configurations: {0}".format(rules), "DEBUG")
        
        # Iterate over each IGMP Snooping VLAN configuration in the list
        for index, vlan_config in enumerate(igmp_snooping_vlans):
            self.log("Processing IGMP Snooping VLAN configuration at index {0}".format(index), "DEBUG")
            ...
            if not isinstance(vlan_config, dict):
                ...
                self.log("IGMP Snooping VLAN configuration type validation failed at index {0} - expected dict but got {1}".format(index, type(vlan_config).__name__), "ERROR")
                self.fail_and_exit(self.msg)
            
            self.log("Validating IGMP Snooping VLAN configuration: {0}".format(vlan_config), "DEBUG")
            ...
            self.log("IGMP Snooping VLAN configuration at index {0} validated successfully".format(index), "DEBUG")
    ...
    def _validate_mld_snooping_config(self, mld_snooping_config, rules):
        ...
        self.log("Validating MLD Snooping configuration: {0}".format(mld_snooping_config), "DEBUG")
        ...
        self.log("Extracted MLD Snooping VLANs for separate validation: {0}".format(bool(mld_snooping_vlans)), "DEBUG")
        ...
        self.log("MLD Snooping global configuration validation completed successfully", "DEBUG")
        ...
        if mld_snooping_vlans:
            ...
            self.log("MLD Snooping VLAN settings validation completed successfully", "DEBUG")
        else:
    ...
    def _validate_mld_snooping_vlans(self, mld_snooping_vlans):
        ...
        if not isinstance(mld_snooping_vlans, list):
            ...
            self.log("MLD Snooping VLANs type validation failed - expected list but got {0}".format(type(mld_snooping_vlans).__name__), "ERROR")
            self.fail_and_exit(self.msg)
        
        self.log("MLD Snooping VLANs list contains {0} items".format(len(mld_snooping_vlans)), "DEBUG")
        
        # Get validation rules for MLD Snooping VLAN
        rules = self.get_layer2_configuration_validation_rules().get("mld_snooping_vlan")
        self.log("Validation rules for MLD Snooping VLAN configurations: {0}".format(rules), "DEBUG")
        
        # Iterate over each MLD Snooping VLAN configuration in the list
        for index, vlan_config in enumerate(mld_snooping_vlans):
            self.log("Processing MLD Snooping VLAN configuration at index {0}".format(index), "DEBUG")
            ...
            if not isinstance(vlan_config, dict):
                ...
                self.log("MLD Snooping VLAN configuration type validation failed at index {0} - expected dict but got {1}".format(index, type(vlan_config).__name__), "ERROR")
                self.fail_and_exit(self.msg)
            
            self.log("Validating MLD Snooping VLAN configuration: {0}".format(vlan_config), "DEBUG")
            ...
            self.log("MLD Snooping VLAN configuration at index {0} validated successfully".format(index), "DEBUG")
    ...
    def _validate_authentication_config(self, authentication_config, rules):
        ...
        self.log("Validating authentication configuration: {0}".format(authentication_config), "DEBUG")
        
        # Validate the authentication configuration against the provided validation rules
        self.validate_config_against_rules("authentication", authentication_config, rules)
        
        self.log("Authentication configuration validation completed successfully", "INFO")
    ...
    def _validate_logical_ports_config(self, logical_ports_config, rules):
        ...
        self.log("Validating logical ports configuration: {0}".format(logical_ports_config), "DEBUG")

        # Check if logical_ports_config is a dictionary
        if not isinstance(logical_ports_config, dict):
            msg = "logical_ports configuration must be of type dict, got {0}".format(type(logical_ports_config).__name__)
            self.log(msg, "ERROR")
        ...
        self.log("Extracted port channels for separate validation: {0}".format(bool(port_channels)), "DEBUG")
        
        # Validate the logical ports global configuration against the provided rules
        self.validate_config_against_rules("logical_ports", logical_ports_global_config, rules)
        
        self.log("Logical ports global configuration validation completed successfully", "DEBUG")
        ...
        self.log("Logical ports configuration validation completed successfully", "INFO")
    ...
    def _validate_port_channels(self, port_channels):
        ...
        if not isinstance(port_channels, list):
            ...
            self.log("Port channels type validation failed - expected list but got {0}".format(type(port_channels).__name__), "ERROR")
            self.fail_and_exit(self.msg)
        
        self.log("Port channels list contains {0} items".format(len(port_channels)), "DEBUG")
        
        # Get validation rules for port channel
        port_channel_rules = self.get_layer2_configuration_validation_rules().get("port_channel")
        self.log("Validation rules for port channel configurations: {0}".format(port_channel_rules), "DEBUG")
        
        # Iterate over each port channel configuration in the list
        for index, channel in enumerate(port_channels):
            self.log("Processing port channel configuration at index {0}".format(index), "DEBUG")
            ...
            if not isinstance(channel, dict):
                ...
                self.log("Port channel type validation failed at index {0} - expected dict but got {1}".format(index, type(channel).__name__), "ERROR")
                self.fail_and_exit(self.msg)
            
            self.log("Validating port channel configuration: {0}".format(channel), "DEBUG")
            
            # Validate the port channel configuration against rules
            self.validate_config_against_rules("port_channel", channel, port_channel_rules)
            ...
            if port_channel_members:
                self.log("Validating port channel members for protocol {0}".format(protocol), "DEBUG")
                self._validate_port_channel_members(port_channel_members, protocol)
                self.log("Port channel members validation completed for index {0}".format(index), "DEBUG")
            else:
                self.log("No port channel members found at index {0}".format(index), "DEBUG")
            
            self.log("Port channel configuration at index {0} validated successfully".format(index), "DEBUG")
    ...
    def _validate_port_channel_members(self, port_channel_members, protocol):
        ...
        Raises:
            Exception: If the validation fails, an exception is raised with a descriptive message.
        """
        self.log("Starting validation for port channel members with protocol {0}".format(protocol), "INFO")
        self.log("Port channel members to validate: {0}".format(port_channel_members), "DEBUG")
        ...
        if not isinstance(port_channel_members, list):
            ...
            self.log("Port channel members type validation failed - expected list but got {0}".format(type(port_channel_members).__name__), "ERROR")
            self.fail_and_exit(self.msg)
        
        self.log("Port channel members list contains {0} items".format(len(port_channel_members)), "DEBUG")
        ...
        if not rule_set_name:
            self.msg = "Invalid port channel protocol: '{0}'. Must be one of {1}.".format(
                protocol, list(protocol_rule_map.keys())
            )
            self.log("Invalid protocol specified: {0}".format(protocol), "ERROR")
            self.fail_and_exit(self.msg)
        
        self.log("Using validation rule set: {0} for protocol {1}".format(rule_set_name, protocol), "DEBUG")
        
        # Get validation rules for the specific protocol's member ports
        member_rules = self.get_layer2_configuration_validation_rules().get(rule_set_name)
        self.log("Validation rules for {0} port channel member configurations: {1}".format(protocol, member_rules), "DEBUG")
        ...
        if protocol == "LACP" and len(port_channel_members) > 16:
            ...
            self.log("LACP member limit exceeded: {0} members found".format(len(port_channel_members)), "ERROR")
            self.fail_and_exit(self.msg)
        
        # Iterate over each port channel member in the list
        for index, member in enumerate(port_channel_members):
            self.log("Processing port channel member at index {0}".format(index), "DEBUG")
            ...
            if not isinstance(member, dict):
                ...
                self.log("Port channel member type validation failed at index {0} - expected dict but got {1}".format(index, type(member).__name__), "ERROR")
                self.fail_and_exit(self.msg)
            
            self.log("Validating {0} port channel member configuration: {1}".format(protocol, member), "DEBUG")
            ...
            if protocol == "LACP" and "port_channel_rate" in member:
                ...
                self.log("Validating LACP port_channel_rate parameter: {0}".format(rate_value), "DEBUG")
                ...
                if isinstance(rate_value, int):
                    ...
                    if rate_value != 1 and rate_value != 30:
                        ...
                        self.log("Invalid LACP rate value: {0}".format(rate_value), "ERROR")
                        self.fail_and_exit(self.msg)
                    ...
                    self.log("LACP rate value type validation failed: expected int but got {0}".format(type(rate_value).__name__), "ERROR")
                    self.fail_and_exit(self.msg)
            ...
            self.log("Port channel member at index {0} validated successfully".format(index), "DEBUG")
        
        self.log("All port channel members validated successfully for protocol {0}".format(protocol), "INFO")
    ...
    def _validate_port_configurations(self, port_configurations, rules=None):
        ...
        for port_config in port_configurations:
            if not isinstance(port_config, dict):
                self.msg = "Each port configuration must be a dictionary. Found: {0}".format(
            ...
            self.log("Validating port configuration for interface: {0}".format(interface_name), "DEBUG")
            ...
            for config_type in config_types:
                if config_type in port_config:
                    ...
                    self.log("Validating {0} for interface {1}".format(config_type, interface_name), "DEBUG")
                    
                    # Special handling for certain config types
                    if config_type == "stp_interface_config":
                        self._validate_stp_interface_config(interface_name, config_value, config_rules)
                    else:
                        # Standard validation for most config types
                        self.validate_config_against_rules(config_type, config_value, config_rules)
    ...
    def _validate_stp_interface_config(self, interface_name, config, rules):
        ...
        Raises:
            Exception: If the validation fails, an exception is raised with a descriptive message.
        """
        self.log("Validating STP interface configuration for {0}: {1}".format(interface_name, config), "DEBUG")
        ...
        per_vlan_priority = stp_interface_config.pop("stp_interface_per_vlan_priority", None)
        
        self.log("Extracted per-VLAN cost settings: {0}".format(bool(per_vlan_cost)), "DEBUG")
        self.log("Extracted per-VLAN priority settings: {0}".format(bool(per_vlan_priority)), "DEBUG")
        
        # Validate the standard STP interface configuration
        self.validate_config_against_rules("stp_interface_config", stp_interface_config, rules)
        
        self.log("Standard STP interface configuration validation completed successfully", "DEBUG")
        ...
        if per_vlan_cost:
            self.log("Validating per-VLAN cost settings for interface {0}".format(interface_name), "DEBUG")
            self.validate_config_against_rules(
                "stp_interface_per_vlan_cost", 
                per_vlan_cost, 
                validation_rules.get("stp_interface_per_vlan_cost")
            )
            self.log("Per-VLAN cost settings validation completed successfully", "DEBUG")
        else:
        ...
        if per_vlan_priority:
            self.log("Validating per-VLAN priority settings for interface {0}".format(interface_name), "DEBUG")
            self.validate_config_against_rules(
                "stp_interface_per_vlan_priority", 
                per_vlan_priority, 
                validation_rules.get("stp_interface_per_vlan_priority")
            )
            self.log("Per-VLAN priority settings validation completed successfully", "DEBUG")
        else:
            self.log("No per-VLAN priority settings found to validate", "DEBUG")
        
        self.log("STP interface configuration validation completed successfully for interface {0}".format(interface_name), "INFO")
    ...
    def validate_layer2_config_params(self, layer2_configuration):
        ...
        for config_name, config_values in layer2_configuration.items():
            self.log("Validating Layer 2 configuration: {0}".format(config_name), "DEBUG")
            
            # Handle None values (when user specifies "cdp:" without a value)
            if config_values is None:
                self.log("Configuration '{0}' has None value. Treating as empty configuration and skipping validation.".format(config_name), "INFO")
                continue
            
            # Handle empty dictionaries or lists
            if not config_values:
                self.log("Configuration '{0}' is empty. Skipping validation.".format(config_name), "INFO")
                continue
            
            # Get validation rules for this feature
            validation_rules = self.get_layer2_configuration_validation_rules().get(config_name)
            ...
            if validator:
                ...
                self.msg = "No validator available for feature '{0}'.".format(config_name)
                self.fail_and_exit(self.msg)
    ...
    def validate_params(self, config, state):
        ...
        if layer2_configuration:
            ...
            self.log("No Layer 2 configurations provided. Skipping Layer 2 validation.", "INFO")
    ...
    def _map_parameters(self, user_config, mapping_schema):
        ...
        processing_strategy = self._determine_processing_strategy(user_config, mapping_schema)
        ...
        if processing_strategy == "list_input":
            ...
            self.log("Unknown processing strategy: {0}".format(processing_strategy), "ERROR")
    ...
    def _initialize_mapped_config(self, mapping_schema):
        ...
        self.log("Initialized base mapped configuration: {0}".format(mapped_config), "DEBUG")
        return mapped_config
    ...
    def _determine_processing_strategy(self, user_config, mapping_schema):
        ...
        self.log("Input analysis - is_list_input: {0}, input_is_list: {1}, has_param_path: {2}".format(
            is_list_input, input_is_list, has_param_path), "DEBUG")
    ...
    def _process_list_input(self, user_config, mapping_schema, mapped_config):
        ...
        """
        self.log("Processing list input configuration with {0} items".format(len(user_config)), "INFO")
        ...
        self.log("List processing parameters - path: {0}, config_type: {1}".format(
            list_path, item_config_type), "DEBUG")
        
        # Process each item in the list
        items_list = []
        for index, item in enumerate(user_config):
            mapped_item = self._map_single_item(item, param_mapping, item_config_type, index)
    ...
    def _process_dict_with_path(self, user_config, mapping_schema, mapped_config):
        ...
        self.log("Path processing parameters - path: {0}, config_type: {1}".format(
            param_path, item_config_type), "DEBUG")
        
        # Navigate to the target location
        target_container = self._navigate_and_create_path(mapped_config, param_path, item_config_type)
        
        # Map parameters to the target container
        mapped_count = self._apply_parameter_mapping(user_config, param_mapping, target_container)
        
        self.log("Mapped {0} parameters using parameter path".format(mapped_count), "INFO")
    ...
    def _process_flat_dict(self, user_config, mapping_schema, mapped_config):
        ...
        mapped_count = self._apply_parameter_mapping(user_config, param_mapping, mapped_config)
        
        self.log("Mapped {0} parameters using flat mapping".format(mapped_count), "INFO")
    ...
    def _map_single_item(self, item, param_mapping, config_type, item_index=None):
        ...
        self.log("Mapped {0} parameters for item{1}".format(mapped_count, index_str), "DEBUG")
    ...
    def _apply_parameter_mapping(self, source_config, param_mapping, target_container):
        ...
        for user_param, api_param in param_mapping.items():
            if user_param in source_config:
                ...
                transformed_value = self._transform_parameter_value(user_param, original_value, api_param)
                
                target_container[api_param] = transformed_value
                mapped_count += 1
                
                self.log("Mapped parameter '{0}' -> '{1}' with value: {2}".format(
                    user_param, api_param, transformed_value), "DEBUG")
            else:
                self.log("Parameter '{0}' not found in source config, skipping".format(user_param), "DEBUG")
    ...
    def _transform_parameter_value(self, user_param, original_value, api_param):
        ...
        """
        self.log("Starting parameter value transformation for parameter: {0}".format(user_param), "DEBUG")
        self.log("Original value: {0} (type: {1})".format(original_value, type(original_value).__name__), "DEBUG")
        ...
        if user_param in boolean_to_string_mappings:
            self.log("Applying boolean to string transformation for parameter: {0}".format(user_param), "DEBUG")
            transformed_value = boolean_to_string_mappings[user_param](original_value)
            self.log("Boolean value {0} transformed to: {1}".format(original_value, transformed_value), "DEBUG")
            return transformed_value
        
        # Return original value if no transformation needed
        self.log("No transformation required for parameter: {0}".format(user_param), "DEBUG")
    ...
    def _navigate_and_create_path(self, base_config, path_list, final_config_type=""):
        ...
        return self._get_or_create_final_container(current, final_key, final_config_type)

    def _navigate_to_path_component(self, current_container, path_component, path_index):
        """
        ...
        """
        self.log("Navigating to path component {0}: '{1}'".format(path_index, path_component), "DEBUG")
        ...
        if path_component not in current_container:
            ...
            self.log("Path section '{0}' already exists".format(path_component), "DEBUG")
    ...
    def _get_or_create_final_container(self, parent_container, final_key, config_type):
        ...
        if final_key not in parent_container:
            ...
            parent_container[final_key] = [{"configType": config_type}] if config_type else [{}]
            self.log("Created final container '{0}' with configType '{1}'".format(
                final_key, config_type), "DEBUG")
        else:
    ...
    def _place_items_at_path(self, base_config, path_list, items_list):
        ...
        self.log("Placing {0} items at path: {1}".format(len(items_list), path_list), "DEBUG")
        ...
        self.log("Successfully placed items at path key '{0}'".format(final_key), "INFO")
    ...
    def _convert_vlan_list_to_string(self, vlan_list):
        ...
        if not vlan_list:
            self.log("Empty or None VLAN list provided, returning empty string", "DEBUG")
            return ""
    ...
    def _map_stp_config(self, stp_config):
        ...
        self.log("Extracted {0} STP instances for separate processing".format(len(stp_instances)), "DEBUG")
        self.log("Main STP global config parameters: {0}".format(main_stp_config), "DEBUG")
        ...
        if stp_instances:
            self.log("Processing {0} STP instances for integration".format(len(stp_instances)), "DEBUG")
            ...
            for instance in stp_instances:
                self.log("Processing STP instance for VLAN {0}".format(instance.get("stp_instance_vlan_id")), "DEBUG")
                ...
                if "stp_instance_priority" in instance:
                    ...
                    self.log("Added priority {0} for VLAN {1}".format(
                        instance.get("stp_instance_priority"), instance.get("stp_instance_vlan_id")), "DEBUG")
                ...
                if "enable_stp" in instance:
                    ...
                    self.log("Set STP enabled status to {0} for VLAN {1}".format(
                        instance.get("enable_stp"), instance.get("stp_instance_vlan_id")), "DEBUG")
                ...
                if has_timer_params:
                    self.log("Timer parameters found for VLAN {0}, creating timers configuration".format(
                        instance.get("stp_instance_vlan_id")), "DEBUG")
                    
                    # Create the timers configuration (without isStpEnabled)
                    timers = {
                        "configType": "STP_TIMERS"
                    }
                    ...
                    for user_param, api_param in timer_mapping.items():
                        if user_param in instance:
                            ...
                            self.log("Mapped timer parameter {0} to {1} with value {2}".format(
                                user_param, api_param, instance.get(user_param)), "DEBUG")
                    
                    # Add timers to the instance
                    instance_item["timers"] = timers
                    self.log("Added timers configuration to VLAN {0} instance".format(
                        instance.get("stp_instance_vlan_id")), "DEBUG")
                else:
                    self.log("No timer parameters found for VLAN {0}, skipping timers configuration".format(
                        instance.get("stp_instance_vlan_id")), "DEBUG")
                
                # Add the instance to the instances list
                stp_item["stpInstances"]["items"].append(instance_item)
                self.log("Successfully added STP instance for VLAN {0} to instances list".format(
                    instance.get("stp_instance_vlan_id")), "DEBUG")
            
            self.log("Completed processing all {0} STP instances".format(len(stp_instances)), "DEBUG")
        else:
    ...
    def _map_dhcp_snooping_config(self, dhcp_snooping_config):
        ...
        """
        self.log("Mapping DHCP Snooping configuration: {0}".format(dhcp_snooping_config), "DEBUG")
        ...
        self.log("Extracted {0} database parameters for separate processing".format(len(database_params)), "DEBUG")
        ...
        for param in vlan_params:
            if param in dhcp_config and isinstance(dhcp_config[param], list):
                ...
                self.log("Converted VLAN parameter '{0}' from list to comma-separated string".format(param), "DEBUG")
        ...
        if database_params:
            self.log("Processing database agent configuration with {0} parameters".format(len(database_params)), "DEBUG")
            
            # Create the database agent mapping schema
            db_mapping_schema = {
                "output_structure": {
                    "configType": "DHCP_SNOOPING_DATABASE_AGENT"
                },
                "param_mapping": {
            ...
            if mapped_config and "dhcpSnoopingGlobalConfig" in mapped_config and "items" in mapped_config["dhcpSnoopingGlobalConfig"]:
                mapped_config["dhcpSnoopingGlobalConfig"]["items"][0]["databaseAgent"] = mapped_db_config
                self.log("Database agent configuration added to main DHCP Snooping config", "DEBUG")
        else:
            self.log("No database parameters found, skipping database agent configuration", "DEBUG")
        
        self.log("DHCP Snooping configuration mapping completed successfully", "INFO")
        self.log("Final mapped DHCP Snooping configuration: {0}".format(mapped_config), "DEBUG")
    ...
    def _map_igmp_snooping_config(self, igmp_snooping_config):
        ...
        """
        self.log("Mapping IGMP Snooping configuration: {0}".format(igmp_snooping_config), "DEBUG")
        ...
        self.log("Extracted {0} IGMP Snooping VLANs for separate processing".format(len(igmp_snooping_vlans)), "DEBUG")
        ...
        if igmp_snooping_vlans:
            self.log("Processing {0} IGMP Snooping VLANs for integration".format(len(igmp_snooping_vlans)), "DEBUG")
            
            # Get the reference to the global config item to add VLAN settings
            if mapped_config and "igmpSnoopingGlobalConfig" in mapped_config and "items" in mapped_config["igmpSnoopingGlobalConfig"]:
                global_config_item = mapped_config["igmpSnoopingGlobalConfig"]["items"][0]
                ...
                self.log("Created IGMP Snooping VLAN settings container structure", "DEBUG")
                
                # Process each VLAN configuration
                for vlan_index, vlan_config in enumerate(igmp_snooping_vlans):
                    self.log("Processing IGMP Snooping VLAN configuration at index {0}".format(vlan_index), "DEBUG")
                    ...
                    for user_param, api_param in vlan_param_mapping.items():
                        if user_param in vlan_config:
                            ...
                            self.log("Mapped VLAN parameter '{0}' to '{1}' with value: {2}".format(
                                user_param, api_param, vlan_config.get(user_param)), "DEBUG")
                    
                    # Handle mrouter port list if present
                    mrouter_ports = vlan_config.get("igmp_snooping_mrouter_port_list", [])
                    if mrouter_ports:
                        self.log("Processing {0} mrouter ports for VLAN {1}".format(
                            len(mrouter_ports), vlan_config.get("igmp_snooping_vlan_id")), "DEBUG")
                        ...
                        for port_index, port in enumerate(mrouter_ports):
                            ...
                            vlan_item["igmpSnoopingVlanMrouters"]["items"].append(mrouter_item)
                            self.log("Added mrouter port '{0}' at index {1} for VLAN {2}".format(
                                port, port_index, vlan_config.get("igmp_snooping_vlan_id")), "DEBUG")
                    else:
                        self.log("No mrouter ports found for VLAN {0}".format(
                            vlan_config.get("igmp_snooping_vlan_id")), "DEBUG")
                    
                    # Add the VLAN config to the VLAN settings items list
                    global_config_item["igmpSnoopingVlanSettings"]["items"].append(vlan_item)
                    self.log("Successfully added IGMP Snooping VLAN {0} configuration to settings list".format(
                        vlan_config.get("igmp_snooping_vlan_id")), "DEBUG")
                
                self.log("Completed processing all {0} IGMP Snooping VLANs".format(len(igmp_snooping_vlans)), "DEBUG")
            else:
                self.log("Unable to add VLAN settings - global config structure not found", "WARNING")
        else:
        ...
        self.log("Final mapped IGMP Snooping configuration: {0}".format(mapped_config), "DEBUG")
    ...
    def _map_mld_snooping_config(self, mld_snooping_config):
        ...
        """
        self.log("Mapping MLD Snooping configuration: {0}".format(mld_snooping_config), "DEBUG")
        ...
        self.log("Extracted {0} MLD Snooping VLANs for separate processing".format(len(mld_snooping_vlans)), "DEBUG")
        ...
        if mld_snooping_vlans:
            self.log("Processing {0} MLD Snooping VLANs for integration".format(len(mld_snooping_vlans)), "DEBUG")
            
            # Get the reference to the global config item to add VLAN settings
            if mapped_config and "mldSnoopingGlobalConfig" in mapped_config and "items" in mapped_config["mldSnoopingGlobalConfig"]:
                global_config_item = mapped_config["mldSnoopingGlobalConfig"]["items"][0]
                ...
                self.log("Created MLD Snooping VLAN settings container structure", "DEBUG")
                
                # Process each VLAN configuration
                for vlan_index, vlan_config in enumerate(mld_snooping_vlans):
                    self.log("Processing MLD Snooping VLAN configuration at index {0}".format(vlan_index), "DEBUG")
                    ...
                    mrouter_ports = vlan_config.get("mld_snooping_mrouter_port_list", [])
                    ...
                    for port_index, port in enumerate(mrouter_ports):
                        ...
                        vlan_item["mldSnoopingVlanMrouters"]["items"].append(mrouter_item)
                        self.log("Added mrouter port '{0}' at index {1} for VLAN {2}".format(
                            port, port_index, vlan_config.get("mld_snooping_vlan_id")), "DEBUG")
                    
                    # Add the VLAN config to the VLAN settings items list
                    global_config_item["mldSnoopingVlanSettings"]["items"].append(vlan_item)
                    self.log("Successfully added MLD Snooping VLAN {0} configuration to settings list".format(
                        vlan_config.get("mld_snooping_vlan_id")), "DEBUG")
                
                self.log("Completed processing all {0} MLD Snooping VLANs".format(len(mld_snooping_vlans)), "DEBUG")
            else:
                self.log("Unable to add VLAN settings - global config structure not found", "WARNING")
        else:
        ...
        self.log("Final mapped MLD Snooping configuration: {0}".format(mapped_config), "DEBUG")
    ...
    def _map_authentication_config(self, authentication_config):
        ...
        """
        self.log("Mapping Authentication configuration: {0}".format(authentication_config), "DEBUG")
    ...
    def _map_logical_ports_config(self, logical_ports_config):
        ...
        """
        self.log("Mapping logical ports configuration: {0}".format(logical_ports_config), "DEBUG")
        ...
        self.log("Extracted {0} port channels for separate processing".format(len(port_channels)), "DEBUG")
        ...
        if port_channels and mapped_config and "portchannelConfig" in mapped_config and "items" in mapped_config["portchannelConfig"]:
            self.log("Processing {0} port channels for integration".format(len(port_channels)), "DEBUG")
            ...
            for channel_index, channel in enumerate(port_channels):
                self.log("Processing port channel at index {0}".format(channel_index), "DEBUG")
                
                protocol = channel.get("port_channel_protocol")
                
                # Skip if protocol is missing
                if not protocol:
                    self.log("Skipping port channel without protocol: {0}".format(channel), "WARNING")
                    continue
                
                self.log("Processing port channel with protocol: {0}".format(protocol), "DEBUG")
                ...
                if protocol == "LACP":
                    ...
                    if "port_channel_min_links" in channel:
                        ...
                        self.log("Added min links parameter: {0}".format(channel.get("port_channel_min_links")), "DEBUG")
                    
                    # Handle member ports
                    member_ports = channel.get("port_channel_members", [])
                    if member_ports:
                        self.log("Processing {0} LACP member ports".format(len(member_ports)), "DEBUG")
                        channel_item["memberPorts"] = {
                            "configType": "SET",
                            "items": []
                        }
                        
                        for member_index, member in enumerate(member_ports):
                            self.log("Processing LACP member port at index {0}".format(member_index), "DEBUG")
                            member_item = {
                                "configType": "LACP_PORTCHANNEL_MEMBER_PORT_CONFIG",
                                "interfaceName": member.get("port_channel_interface_name")
                            }
                            
                            # Map optional member parameters
                            if "port_channel_mode" in member:
                                member_item["mode"] = member.get("port_channel_mode")
                                self.log("Added LACP mode parameter: {0}".format(member.get("port_channel_mode")), "DEBUG")
                            if "port_channel_port_priority" in member:
                                member_item["portPriority"] = member.get("port_channel_port_priority")
                                self.log("Added LACP port priority: {0}".format(member.get("port_channel_port_priority")), "DEBUG")
                            if "port_channel_rate" in member:
                                member_item["rate"] = member.get("port_channel_rate")
                                self.log("Added LACP rate parameter: {0}".format(member.get("port_channel_rate")), "DEBUG")
                    ...
                    member_ports = channel.get("port_channel_members", [])
                    if member_ports:
                        self.log("Processing {0} PAGP member ports".format(len(member_ports)), "DEBUG")
                        channel_item["memberPorts"] = {
                            "configType": "SET",
                            "items": []
                        }
                        ...
                        for member_index, member in enumerate(member_ports):
                            self.log("Processing PAGP member port at index {0}".format(member_index), "DEBUG")
                            member_item = {
                            ...
                            if "port_channel_mode" in member:
                                member_item["mode"] = member.get("port_channel_mode")
                                self.log("Added PAGP mode parameter: {0}".format(member.get("port_channel_mode")), "DEBUG")
                            if "port_channel_port_priority" in member:
                                member_item["portPriority"] = member.get("port_channel_port_priority")
                                self.log("Added PAGP port priority: {0}".format(member.get("port_channel_port_priority")), "DEBUG")
                            if "port_channel_learn_method" in member:
                                member_item["learnMethod"] = member.get("port_channel_learn_method")
                                self.log("Added PAGP learn method: {0}".format(member.get("port_channel_learn_method")), "DEBUG")
                            
                            channel_item["memberPorts"]["items"].append(member_item)
                    
                elif protocol == "NONE":
                    self.log("Creating EtherChannel configuration for static aggregation", "DEBUG")
                    channel_item = {
                    ...
                    member_ports = channel.get("port_channel_members", [])
                    if member_ports:
                        self.log("Processing {0} EtherChannel member ports".format(len(member_ports)), "DEBUG")
                        channel_item["memberPorts"] = {
                            "configType": "SET",
                            "items": []
                        }
                        ...
                        for member_index, member in enumerate(member_ports):
                            self.log("Processing EtherChannel member port at index {0}".format(member_index), "DEBUG")
                            member_item = {
                            ...
                            if "port_channel_mode" in member:
                                member_item["mode"] = member.get("port_channel_mode")
                                self.log("Added EtherChannel mode parameter: {0}".format(member.get("port_channel_mode")), "DEBUG")
                            
                            channel_item["memberPorts"]["items"].append(member_item)
                
                else:
                    self.log("Unsupported port channel protocol: {0}".format(protocol), "WARNING")
                    continue
                
                # Add the port channel item directly to the items list
                global_config_item["portchannels"]["items"].append(channel_item)
                self.log("Successfully added port channel '{0}' with protocol {1}".format(
                    channel.get("port_channel_name"), protocol), "DEBUG")
            
            self.log("Completed processing all {0} port channels".format(len(port_channels)), "DEBUG")
        else:
            self.log("No port channels found to process or configuration structure incomplete", "DEBUG")
        
        if mapped_config and "portchannelConfig" in mapped_config:
            self.log("Returning portchannelConfig structure for SDK 'payload' parameter", "DEBUG")
    ...
    def _process_switchport_interface_config(self, mapped_config, interface_name, switchport_config):
        """
        ...
        self.log("Processing switchport configuration for {0}: {1}".format(interface_name, switchport_config), "DEBUG")
        
        # Initialize the switchport interface config section if it doesn't exist
        if "switchportInterfaceConfig" not in mapped_config:
            mapped_config["switchportInterfaceConfig"] = {
                "items": []
            }
            self.log("Initialized switchportInterfaceConfig section in mapped configuration", "DEBUG")
        ...
        self.log("Created switchport item structure for interface {0}".format(interface_name), "DEBUG")
        ...
        for user_param, api_param in param_mapping.items():
            if user_param in switchport_config:
                ...
                self.log("Mapped parameter {0} to {1} with value {2}".format(user_param, api_param, switchport_config[user_param]), "DEBUG")
        
        # Special handling for admin_status (bool to enum)
        if "admin_status" in switchport_config:
            switchport_item["adminStatus"] = "UP" if switchport_config["admin_status"] else "DOWN"
            self.log("Applied admin status transformation: {0} -> {1}".format(switchport_config["admin_status"], switchport_item["adminStatus"]), "DEBUG")
        
        # Special handling for allowed_vlans (list to string)
        if "allowed_vlans" in switchport_config and isinstance(switchport_config["allowed_vlans"], list):
            # Convert list of integers to simple comma-separated string or ranges
            allowed_vlans = switchport_config["allowed_vlans"]
            if allowed_vlans:
                switchport_item["trunkAllowedVlans"] = self._convert_vlan_list_to_string(allowed_vlans)
                self.log("Converted allowed VLANs list to string: {0}".format(switchport_item["trunkAllowedVlans"]), "DEBUG")
        
        # Add the item to the items list
        mapped_config["switchportInterfaceConfig"]["items"].append(switchport_item)
        self.log("Successfully added switchport configuration for interface {0} to mapped config".format(interface_name), "DEBUG")

    def _process_vlan_trunking_interface_config(self, mapped_config, interface_name, trunk_config):
        """
        ...
        self.log("Processing VLAN trunking configuration for {0}: {1}".format(interface_name, trunk_config), "DEBUG")
        
        # Initialize the trunk interface config section if it doesn't exist
        if "trunkInterfaceConfig" not in mapped_config:
            mapped_config["trunkInterfaceConfig"] = {
                "items": []
            }
            self.log("Initialized trunkInterfaceConfig section in mapped configuration", "DEBUG")
        
        # Create the new item for this interface
        trunk_item = {
            "configType": "TRUNK_INTERFACE",
            "interfaceName": interface_name
        }
        self.log("Created trunk item structure for interface {0}".format(interface_name), "DEBUG")
        
        # Map the protected parameter
        if "protected" in trunk_config:
            trunk_item["isProtected"] = trunk_config["protected"]
            self.log("Mapped protected parameter: {0}".format(trunk_config["protected"]), "DEBUG")
        
        # Updated logic for enable_dtp_negotiation (boolean parameter)
        if "enable_dtp_negotiation" in trunk_config:
            trunk_item["isDtpNegotiationEnabled"] = trunk_config["enable_dtp_negotiation"]
            self.log("Mapped DTP negotiation parameter: {0}".format(trunk_config["enable_dtp_negotiation"]), "DEBUG")
        
        # Handle pruning VLAN IDs
        if "pruning_vlan_ids" in trunk_config and isinstance(trunk_config["pruning_vlan_ids"], list):
            pruning_vlans = trunk_config["pruning_vlan_ids"]
            if pruning_vlans:
                trunk_item["pruneEligibleVlans"] = self._convert_vlan_list_to_string(pruning_vlans)
                self.log("Converted pruning VLAN IDs list to string: {0}".format(trunk_item["pruneEligibleVlans"]), "DEBUG")
            else:
                self.log("Empty pruning VLAN IDs list found, skipping conversion", "DEBUG")
        
        # Add the item to the items list
        mapped_config["trunkInterfaceConfig"]["items"].append(trunk_item)
        self.log("Successfully added VLAN trunking configuration for interface {0} to mapped config".format(interface_name), "DEBUG")

    def _process_dot1x_interface_config(self, mapped_config, interface_name, dot1x_config):
        """
        ...
        self.log("Processing 802.1x configuration for {0}: {1}".format(interface_name, dot1x_config), "DEBUG")
        ...
        if "dot1xInterfaceConfig" not in mapped_config:
            ...
            self.log("Initialized dot1xInterfaceConfig section in mapped configuration", "DEBUG")
        ...
        self.log("Created dot1x item structure for interface {0}".format(interface_name), "DEBUG")
        ...
        for user_param, api_param in basic_param_mapping.items():
            if user_param in dot1x_config:
                ...
                self.log("Mapped basic parameter '{0}' to '{1}' with value: {2}".format(
                    user_param, api_param, dot1x_config[user_param]), "DEBUG")
        ...
        for user_param, api_param in boolean_param_mapping.items():
            if user_param in dot1x_config:
                dot1x_item[api_param] = dot1x_config[user_param]
                self.log("Mapped boolean parameter '{0}' to '{1}' with value: {2}".format(
                    user_param, api_param, dot1x_config[user_param]), "DEBUG")
        ...
        if "dot1x_interface_authentication_order" in dot1x_config:
            ...
            if auth_order:  # Only add if not empty
                ...
                self.log("Added authentication order with {0} items: {1}".format(
                    len(auth_order), auth_order), "DEBUG")
            else:
        ...
        if "dot1x_interface_priority" in dot1x_config:
            ...
            if priority_order:  # Only add if not empty
                ...
                self.log("Added priority order with {0} items: {1}".format(
                    len(priority_order), priority_order), "DEBUG")
            else:
                self.log("Skipping empty priority order list", "DEBUG")
        
        # Add the item to the items list
        mapped_config["dot1xInterfaceConfig"]["items"].append(dot1x_item)
        self.log("Successfully added 802.1x configuration for interface {0} to mapped config".format(interface_name), "DEBUG")
    ...
    def _process_mab_interface_config(self, mapped_config, interface_name, mab_config):
        ...
        self.log("Processing MAB configuration for {0}: {1}".format(interface_name, mab_config), "DEBUG")
        
        # Initialize the mab interface config section if it doesn't exist
        if "mabInterfaceConfig" not in mapped_config:
            mapped_config["mabInterfaceConfig"] = {
                "items": []
            }
            self.log("Initialized mabInterfaceConfig section in mapped configuration", "DEBUG")
        
        # Create the new item for this interface
        mab_item = {
            "configType": "MAB_INTERFACE",
            "interfaceName": interface_name
        }
        self.log("Created MAB item structure for interface {0}".format(interface_name), "DEBUG")
        
        # Map the parameters
        if "enable_mab" in mab_config:
            mab_item["isMabEnabled"] = mab_config["enable_mab"]
            self.log("Mapped enable_mab parameter to isMabEnabled with value: {0}".format(mab_config["enable_mab"]), "DEBUG")
        
        # Add the item to the items list
        mapped_config["mabInterfaceConfig"]["items"].append(mab_item)
        self.log("Successfully added MAB configuration for interface {0} to mapped config".format(interface_name), "DEBUG")
    ...
    def _process_stp_interface_config(self, mapped_config, interface_name, stp_config):
        ...
        self.log("Processing STP configuration for {0}: {1}".format(interface_name, stp_config), "DEBUG")
        
        # Initialize the STP interface config section if it doesn't exist
        if "stpInterfaceConfig" not in mapped_config:
            mapped_config["stpInterfaceConfig"] = {
                "items": []
            }
            self.log("Initialized stpInterfaceConfig section in mapped configuration", "DEBUG")
        
        # Create the new item for this interface
        stp_item = {
            "configType": "STP_INTERFACE",
            "interfaceName": interface_name
        }
        self.log("Created STP item structure for interface {0}".format(interface_name), "DEBUG")
        ...
        for user_param, api_param in param_mapping.items():
            if user_param in stp_config:
                ...
                self.log("Mapped parameter {0} to {1} with value {2}".format(user_param, api_param, stp_config[user_param]), "DEBUG")
        
        # Special handling for boolean to string enum conversions
        if "stp_interface_bpdu_filter" in stp_config:
            stp_item["bpduFilter"] = "ENABLE" if stp_config["stp_interface_bpdu_filter"] else "DISABLE"
            self.log("Applied BPDU filter transformation: {0} -> {1}".format(stp_config["stp_interface_bpdu_filter"], stp_item["bpduFilter"]), "DEBUG")
        
        if "stp_interface_bpdu_guard" in stp_config:
            stp_item["bpduGuard"] = "ENABLE" if stp_config["stp_interface_bpdu_guard"] else "DISABLE"
            self.log("Applied BPDU guard transformation: {0} -> {1}".format(stp_config["stp_interface_bpdu_guard"], stp_item["bpduGuard"]), "DEBUG")
        
        # Handle per-VLAN cost settings
        per_vlan_cost = stp_config.get("stp_interface_per_vlan_cost")
        if per_vlan_cost and "priority" in per_vlan_cost and "vlan_ids" in per_vlan_cost:
                ...
                "items": [
                    {
                        ...
                        "vlans": self._convert_vlan_list_to_string(per_vlan_cost["vlan_ids"])
                    }
                ]
            }
            self.log("Added per-VLAN cost settings with cost {0} for VLANs: {1}".format(per_vlan_cost["priority"], per_vlan_cost["vlan_ids"]), "DEBUG")
        
        # Handle per-VLAN priority settings
        per_vlan_priority = stp_config.get("stp_interface_per_vlan_priority")
        if per_vlan_priority and "priority" in per_vlan_priority and "vlan_ids" in per_vlan_priority:
                ...
                "items": [
                    {
                        ...
                        "vlans": self._convert_vlan_list_to_string(per_vlan_priority["vlan_ids"])
                    }
                ]
            }
            self.log("Added per-VLAN priority settings with priority {0} for VLANs: {1}".format(per_vlan_priority["priority"], per_vlan_priority["vlan_ids"]), "DEBUG")
        
        # Add the item to the items list
        mapped_config["stpInterfaceConfig"]["items"].append(stp_item)
        self.log("Successfully added STP configuration for interface {0} to mapped config".format(interface_name), "DEBUG")

    def _process_dhcp_snooping_interface_config(self, mapped_config, interface_name, dhcp_config):
        """
        ...
        self.log("Processing DHCP Snooping configuration for {0}: {1}".format(interface_name, dhcp_config), "DEBUG")
        ...
        if "dhcpSnoopingInterfaceConfig" not in mapped_config:
            mapped_config["dhcpSnoopingInterfaceConfig"] = {
                "items": []
            }
            self.log("Initialized dhcpSnoopingInterfaceConfig section in mapped configuration", "DEBUG")
        ...
        self.log("Created DHCP snooping item structure for interface {0}".format(interface_name), "DEBUG")
        
        # Map the parameters
        if "dhcp_snooping_interface_trust" in dhcp_config:
            dhcp_item["isTrustedInterface"] = dhcp_config["dhcp_snooping_interface_trust"]
            self.log("Mapped dhcp_snooping_interface_trust parameter: {0}".format(dhcp_config["dhcp_snooping_interface_trust"]), "DEBUG")
        
        if "dhcp_snooping_interface_rate" in dhcp_config:
            dhcp_item["messageRateLimit"] = dhcp_config["dhcp_snooping_interface_rate"]
            self.log("Mapped dhcp_snooping_interface_rate parameter: {0}".format(dhcp_config["dhcp_snooping_interface_rate"]), "DEBUG")
        
        # Add the item to the items list
        mapped_config["dhcpSnoopingInterfaceConfig"]["items"].append(dhcp_item)
        self.log("Successfully added DHCP Snooping configuration for interface {0} to mapped config".format(interface_name), "DEBUG")
    ...
    def _process_cdp_interface_config(self, mapped_config, interface_name, cdp_config):
        ...
        self.log("Processing CDP configuration for {0}: {1}".format(interface_name, cdp_config), "DEBUG")
        ...
        if "cdpInterfaceConfig" not in mapped_config:
            ...
            self.log("Initialized cdpInterfaceConfig section in mapped configuration", "DEBUG")
        
        # Create the new item for this interface
        cdp_item = {
            "configType": "CDP_INTERFACE",
            "interfaceName": interface_name
        }
        self.log("Created CDP item structure for interface {0}".format(interface_name), "DEBUG")
        
        # Map the parameters
        if "cdp_interface_admin_status" in cdp_config:
            cdp_item["isCdpEnabled"] = cdp_config["cdp_interface_admin_status"]
            self.log("Mapped cdp_interface_admin_status parameter: {0}".format(cdp_config["cdp_interface_admin_status"]), "DEBUG")
        
        if "cdp_interface_log_duplex_mismatch" in cdp_config:
            cdp_item["isLogDuplexMismatchEnabled"] = cdp_config["cdp_interface_log_duplex_mismatch"]
            self.log("Mapped cdp_interface_log_duplex_mismatch parameter: {0}".format(cdp_config["cdp_interface_log_duplex_mismatch"]), "DEBUG")
        
        # Add the item to the items list
        mapped_config["cdpInterfaceConfig"]["items"].append(cdp_item)
        self.log("Successfully added CDP configuration for interface {0} to mapped config".format(interface_name), "DEBUG")

    def _process_lldp_interface_config(self, mapped_config, interface_name, lldp_config):
        """
        ...
        self.log("Processing LLDP configuration for {0}: {1}".format(interface_name, lldp_config), "DEBUG")
        
        # Initialize the lldp interface config section if it doesn't exist
        if "lldpInterfaceConfig" not in mapped_config:
            mapped_config["lldpInterfaceConfig"] = {
                "items": []
            }
            self.log("Initialized lldpInterfaceConfig section in mapped configuration", "DEBUG")
        
        # Create the new item for this interface
        lldp_item = {
            "configType": "LLDP_INTERFACE",
            "interfaceName": interface_name
        }
        self.log("Created LLDP item structure for interface {0}".format(interface_name), "DEBUG")
        ...
        if "lldp_interface_receive_transmit" in lldp_config:
            ...
            self.log("Mapped lldp_interface_receive_transmit parameter: {0}".format(lldp_config["lldp_interface_receive_transmit"]), "DEBUG")
        
        # Add the item to the items list
        mapped_config["lldpInterfaceConfig"]["items"].append(lldp_item)
        self.log("Successfully added LLDP configuration for interface {0} to mapped config".format(interface_name), "DEBUG")
    ...
    def _process_vtp_interface_config(self, mapped_config, interface_name, vtp_config):
        ...
        self.log("Processing VTP configuration for {0}: {1}".format(interface_name, vtp_config), "DEBUG")
        ...
        if "vtpInterfaceConfig" not in mapped_config:
            ...
            self.log("Initialized vtpInterfaceConfig section in mapped configuration", "DEBUG")
        
        # Create the new item for this interface
        vtp_item = {
            "configType": "VTP_INTERFACE",
            "interfaceName": interface_name
        }
        self.log("Created VTP item structure for interface {0}".format(interface_name), "DEBUG")
        
        # Map the parameters
        if "vtp_interface_admin_status" in vtp_config:
            vtp_item["isVtpEnabled"] = vtp_config["vtp_interface_admin_status"]
            self.log("Mapped vtp_interface_admin_status parameter: {0}".format(vtp_config["vtp_interface_admin_status"]), "DEBUG")
        
        # Add the item to the items list
        mapped_config["vtpInterfaceConfig"]["items"].append(vtp_item)
        self.log("Successfully added VTP configuration for interface {0} to mapped config".format(interface_name), "DEBUG")
    ...
    def _map_port_configuration(self, port_configurations):
        ...
        self.log("Processing {0} port configurations for interface mapping".format(len(port_configurations)), "DEBUG")
        
        # Process each interface configuration sequentially
        for port_index, port_config in enumerate(port_configurations):
            self.log("Processing port configuration at index {0}".format(port_index), "DEBUG")
            
            interface_name = port_config.get("interface_name")
            
            if not interface_name:
                self.log("Skipping port configuration without interface_name", "WARNING")
                continue
            
            self.log("Processing interface configurations for: {0}".format(interface_name), "DEBUG")
            
            # Process each feature configuration for this interface in the same order as temp_spec
            self._process_switchport_interface_config(mapped_config, interface_name, 
                                                    port_config.get("switchport_interface_config"))
            
            self._process_vlan_trunking_interface_config(mapped_config, interface_name, 
                                                        port_config.get("vlan_trunking_interface_config"))
            
            self._process_dot1x_interface_config(mapped_config, interface_name, 
                                                port_config.get("dot1x_interface_config"))
            
            self._process_mab_interface_config(mapped_config, interface_name, 
                                            port_config.get("mab_interface_config"))
            
            self._process_stp_interface_config(mapped_config, interface_name, 
                                            port_config.get("stp_interface_config"))
            
            self._process_dhcp_snooping_interface_config(mapped_config, interface_name, 
                                                        port_config.get("dhcp_snooping_interface_config"))
            
            self._process_cdp_interface_config(mapped_config, interface_name, 
                                            port_config.get("cdp_interface_config"))
            
            self._process_lldp_interface_config(mapped_config, interface_name, 
                                            port_config.get("lldp_interface_config"))
            
            self._process_vtp_interface_config(mapped_config, interface_name, 
                                            port_config.get("vtp_interface_config"))
            
            self.log("Completed processing all feature configurations for interface: {0}".format(interface_name), "DEBUG")
        
        self.log("Port configuration mapping completed successfully", "INFO")
        self.log("Final mapped configuration contains {0} feature sections".format(len(mapped_config)), "DEBUG")
    ...
    def get_mapped_layer2_config_params(self, feature_name, config_data):
        ...
        if mapper:
            self.log("Found mapping function for feature '{0}', executing transformation".format(feature_name), "DEBUG")
            
            # Call the specific mapper with the config data
            mapped_config = mapper(config_data)
            
            self.log(
                "Mapped configuration for '{0}': {1}".format(feature_name, mapped_config),
                "DEBUG",
            )
            
            self.log("Configuration mapping completed successfully for feature '{0}'".format(feature_name), "INFO")
            
            return mapped_config
        else:
            # This should never happen if our feature_mappers dictionary is complete
            self.msg = "No parameter mapper available for feature '{0}'.".format(feature_name)
            self.log("Configuration mapping failed - no mapper found for feature '{0}'".format(feature_name), "ERROR")
            self.fail_and_exit(self.msg)
    ...
    def get_intended_layer2_feature_configuration(self, network_device_id, feature):
        ...
        try:
            # Execute the API call to get the intended layer 2 feature configuration
            api_function = "get_configurations_for_an_intended_layer2_feature_on_a_wired_device"
            api_family = "wired"
            ...
            error_str = str(e)
            self.log("Error retrieving intended configuration for feature '{0}': {1}".format(feature, error_str), "DEBUG")
            ...
            if ("404" in error_str or "Not Found" in error_str or 
                "argument of type 'NoneType' is not iterable" in error_str):
                self.log("No intended configuration exists for feature '{0}' - this is normal for features that haven't been configured yet".format(feature), "INFO")
    ...
    def get_deployed_layer2_feature_configuration(self, network_device_id, feature):
        ...
        return self.execute_get_request(
            "wired", "get_configurations_for_a_deployed_layer2_feature_on_a_wired_device", api_params
        )

    def create_layer2_feature_configuration(self, network_device_id, feature, config_params):
        """
        ...
        self.log("Final API parameters for create intent operation: {0}".format(api_params), "DEBUG")
        ...
        return self.get_taskid_post_api_call(
            "wired", "create_configurations_for_an_intended_layer2_feature_on_a_wired_device", api_params
        )

    def update_layer2_feature_configuration(self, network_device_id, feature, config_params):
        """
        ...
        self.log("Final API parameters for udpate intent operation: {0}".format(api_params), "DEBUG")
    
        # Execute the API call to update the layer 2 feature configuration and return the task ID
        return self.get_taskid_post_api_call(
            "wired", "update_configurations_for_an_intended_layer2_feature_on_a_wired_device", api_params
        )
    ...
    def delete_layer2_feature_configuration(self, network_device_id, feature):
        ...
        return self.get_taskid_post_api_call(
            "wired", "delete_configurations_for_an_intended_layer2_feature_on_a_wired_device", api_params
        )
    ...
    def deploy_intended_configurations(self, network_device_id):
        ...
        """
        self.log(
            "Initiating deployment of intended configurations on device {0}".format(network_device_id),
            "INFO",
        )
        # Prepare the API parameters
        api_params = {
        ...
        return self.get_taskid_post_api_call(
            "wired", "deploy_the_intended_configuration_features_on_a_wired_device", api_params
        )
    ...
    def get_current_configs_for_features(self, network_device_id, features):
        ...
        """
        self.log("Starting retrieval of current configurations for {0} features".format(len(features)), "INFO")
        ...
        for feature in features:
            self.log("Retrieving configurations for feature: {0}".format(feature), "DEBUG")
            
            try:
                # Fetch deployed configuration
                self.log("Fetching deployed configuration for feature: {0}".format(feature), "DEBUG")
                deployed = self.get_deployed_layer2_feature_configuration(network_device_id, feature)
                
                if deployed:
                    deployed_configs[feature] = deployed
                    self.log("Successfully retrieved deployed config for {0}".format(feature), "DEBUG")
                    self.log("Deployed config structure for {0}: {1}".format(feature, deployed), "DEBUG")
                else:
                    self.log("No deployed configuration found for feature: {0}".format(feature), "DEBUG")
                
                # Fetch intended configuration
                self.log("Fetching intended configuration for feature: {0}".format(feature), "DEBUG")
                intended = self.get_intended_layer2_feature_configuration(network_device_id, feature)
                
                if intended:
                    intended_configs[feature] = intended
                    self.log("Successfully retrieved intended config for {0}".format(feature), "DEBUG")
                    self.log("Intended config structure for {0}: {1}".format(feature, intended), "DEBUG")
                else:
                    self.log("No intended configuration found for feature: {0}".format(feature), "DEBUG")
                    
            except Exception as e:
                self.log("Error retrieving configurations for feature {0}: {1}".format(feature, str(e)), "WARNING")
                # Continue with other features even if one fails
                continue
        
        self.log("Successfully retrieved configurations for {0} features".format(len(features)), "INFO")
        self.log("Deployed configs retrieved for features: {0}".format(list(deployed_configs.keys())), "DEBUG")
        self.log("Intended configs retrieved for features: {0}".format(list(intended_configs.keys())), "DEBUG")
    ...
    def extract_layer2_feature_mappings(self, config):
        ...
        """
        self.log("Starting extraction of Layer2 feature mappings from user configuration", "INFO")
        ...
        if not layer2_config:
            self.log("No layer2_configuration found in config, skipping feature mapping", "INFO")
            return discovered_features, feature_mappings
        
        self.log("Found layer2_configuration with {0} features".format(len(layer2_config)), "DEBUG")
        self.log("Layer2 features to process: {0}".format(list(layer2_config.keys())), "DEBUG")
        ...
        for feature_name, feature_config in layer2_config.items():
            ...
            try:
                self.log("Mapping configuration parameters for feature: {0}".format(feature_name), "DEBUG")
                mapped_config = self.get_mapped_layer2_config_params(feature_name, feature_config)
                ...
                if mapped_config:
                    ...
                    self.log("Successfully mapped feature '{0}' to {1} API features: {2}".format(
                        feature_name, len(api_features), api_features), "INFO")
                    self.log("Mapped configuration for '{0}': {1}".format(
                        feature_name, mapped_config), "DEBUG")
                else:
                    self.log("No mapping returned for feature: {0}".format(feature_name), "WARNING")
                    
            except Exception as e:
                self.log("Error mapping feature '{0}': {1}".format(feature_name, str(e)), "ERROR")
                # Continue with other features even if one fails
                continue
        
        self.log("Feature mapping extraction completed successfully", "INFO")
        self.log("Total discovered API features: {0}".format(len(discovered_features)), "INFO")
        self.log("Discovered API feature names: {0}".format(list(discovered_features)), "DEBUG")
        self.log("User features mapped: {0}".format(list(feature_mappings.keys())), "DEBUG")
    ...
    def _analyze_configuration_differences(self):
        ...
        self.log("Analyzing {0} user feature mappings".format(len(want_feature_mappings)), "DEBUG")
        ...
        for user_feature_name, user_feature_config in want_feature_mappings.items():
            ...
            for api_feature_name, api_feature_config in user_feature_config.items():
                ...
                if feature_operation:
                    analysis_results["features_to_process"][api_feature_name] = feature_operation
        ...
        self.log("Configuration analysis completed: {0}".format(analysis_results["summary"]), "INFO")
        return analysis_results

    def _determine_feature_operation(self, api_feature_name, desired_config, deployed_config, intended_config):
        """
        ...
        """
        self.log("Determining operation for feature: {0}".format(api_feature_name), "DEBUG")
        self.log("Desired config: {0}".format(desired_config), "DEBUG")
        self.log("Deployed config exists: {0}".format(bool(deployed_config.get("response", {}).get(api_feature_name, {}).get("items"))), "DEBUG")
        self.log("Intended config exists: {0}".format(bool(intended_config.get("response", {}).get(api_feature_name, {}).get("items"))), "DEBUG")
        
        # Extract actual configurations from API response format
        deployed_feature_config = deployed_config.get("response", {}).get(api_feature_name, {})
        intended_feature_config = intended_config.get("response", {}).get(api_feature_name, {})
        ...
        if not config_operation_result:
            self.log("No configuration changes needed for feature: {0}".format(api_feature_name), "DEBUG")
            return None
        ...
        intent_operation = self._determine_intent_operation(
            intended_config, api_feature_name, desired_config  # Pass intended_config (full), not intended_feature_config
        )
        ...
        operation_details = {
            ...
            "config_operation": config_operation_result["operation"],  # "create" or "update"
        ...
        self.log("Operation determined for {0}: config_op={1}, intent_op={2}".format(
            api_feature_name, operation_details["config_operation"], operation_details["intent_operation"]), "INFO")
        
        return operation_details

    def _determine_config_operation(self, api_feature_name, desired_config, deployed_config):
        """
        ...
        self.log("Config operation analysis for {0}: deployed_items={1}, desired_items={2}".format(
            api_feature_name, len(deployed_items), len(desired_items)), "DEBUG")
        
        # Handle different feature types based on their specific requirements
        if self._is_vlan_feature(api_feature_name):
            self.log("Processing VLAN feature operation analysis for {0}".format(api_feature_name), "DEBUG")
            return self._determine_vlan_config_operation(desired_items, deployed_items)
        elif self._is_global_feature(api_feature_name):
            self.log("Processing global feature operation analysis for {0}".format(api_feature_name), "DEBUG")
            return self._determine_global_config_operation(desired_items, deployed_items)
        elif self._is_interface_feature(api_feature_name):
            self.log("Processing interface feature operation analysis for {0}".format(api_feature_name), "DEBUG")
            return self._determine_interface_config_operation(desired_items, deployed_items)
        else:
            # Default handling for other features that don't fit standard categories
            self.log("Processing default feature operation analysis for {0}".format(api_feature_name), "DEBUG")
            return self._determine_default_config_operation(desired_items, deployed_items)
        ...
        for desired_vlan in desired_vlans:
            ...
            if not deployed_vlan:
                ...
                if self._config_needs_update(desired_vlan, deployed_vlan):
                    ...
                    updated_vlan.update({k: v for k, v in desired_vlan.items() if k != "configType"})
    ...
    def _determine_global_config_operation(self, desired_items, deployed_items):
        ...
        """
        self.log("Analyzing global configuration operation with nested instance support", "DEBUG")
        ...
        if self._has_nested_instances(desired_item):
            self.log("Detected global feature with nested instances, using specialized comparison", "DEBUG")
            needs_update = self._global_config_with_instances_needs_update(desired_item, deployed_item)
        else:
        ...
        if needs_update:
            ...
            if config_type in ["IGMP_SNOOPING_GLOBAL", "MLD_SNOOPING_GLOBAL", "PORTCHANNEL"]:
                self.log("Using desired config as-is for feature type: {0}".format(config_type), "DEBUG")
    ...
    def _global_config_with_instances_needs_update(self, desired_item, deployed_item):
        ...
        for key, desired_value in desired_item.items():
            ...
            if desired_value != current_value:
                self.log("Global parameter '{0}' differs: desired='{1}', current='{2}'".format(
                    key, desired_value, current_value), "DEBUG")
                return True
        ...
        for instance_key in instance_keys:
            if instance_key in desired_item:
                ...
                if self._nested_instances_need_update(desired_instances, current_instances, instance_key):
                    self.log("Nested instances '{0}' differ - update needed".format(instance_key), "DEBUG")
                    return True
        
        self.log("Global configuration with instances matches - no update needed", "DEBUG")
        return False
    ...
    def _deep_merge_config(self, base_config, new_config):
        ...
        self.log("Base configuration keys: {0}".format(list(base_config.keys())), "DEBUG")
        ...
        for key, value in new_config.items():
            ...
            if key in merged and isinstance(merged[key], dict) and isinstance(value, dict):
                self.log("Found nested dictionary for key '{0}', performing recursive merge".format(key), "DEBUG")
                ...
                if original_nested != merged_nested:
                    ...
                    changes_made += 1
                    self.log("Updated nested dictionary for key '{0}' due to detected changes".format(key), "DEBUG")
                else:
                    self.log("No changes detected in nested dictionary for key '{0}' - keeping original".format(key), "DEBUG")
            else:
                ...
                if key in merged:
                    ...
                    if current_value != value:
                        merged[key] = value
                        changes_made += 1
                        self.log("Updated parameter '{0}': changed from '{1}' to '{2}' (values differ)".format(
                            key, current_value, value), "DEBUG")
                    else:
                        self.log("Parameter '{0}' already has desired value '{1}' - no update needed".format(
                            key, value), "DEBUG")
                else:
                    # New key - add it
                    merged[key] = value
                    changes_made += 1
                    self.log("Added new key '{0}' to merged configuration with value '{1}'".format(key, value), "DEBUG")
    ...
    def _has_nested_instances(self, config_item):
        ...
        for key in instance_keys:
            if key in config_item and isinstance(config_item[key], dict) and config_item[key].get("items"):
                self.log("Found nested instances in key '{0}' for config type '{1}'".format(key, config_type), "DEBUG")
                return True
        
        return False

    def _nested_instances_need_update(self, desired_instances, current_instances, instance_type):
        """
        ...
        Returns:
            bool: True if update is needed, False otherwise
        """
        self.log("Comparing {0} nested instances: desired={1}, current={2}".format(
            instance_type, len(desired_instances), len(current_instances)), "DEBUG")
        
        # Use different comparison strategies based on instance type
        if instance_type in ["stpInstances", "igmpSnoopingVlanSettings", "mldSnoopingVlanSettings"]:
            return self._compare_vlan_based_instances(desired_instances, current_instances, instance_type)
        elif instance_type == "portchannels":
            return self._compare_portchannel_instances(desired_instances, current_instances)
        else:
    ...
    def _deep_compare_instances(self, desired_instance, current_instance):
        ...
        for key, desired_value in desired_instance.items():
            ...
            if isinstance(desired_value, dict) and isinstance(current_value, dict):
                ...
                if desired_value != current_value:
                    self.log("Parameter '{0}' differs: desired='{1}', current='{2}'".format(
                        key, desired_value, current_value), "DEBUG")
                    return True
    ...
    def _compare_portchannel_instances(self, desired_instances, current_instances):
        ...
        Returns:
            bool: True if update is needed, False otherwise
        """
        self.log("Performing enhanced port channel instance comparison with memberPorts support", "DEBUG")
        ...
        for desired_instance in desired_instances:
            ...
            if not current_instance:
                self.log("Port channel '{0}' not found in current instances - update needed".format(name), "DEBUG")
                return True
            
            # Enhanced comparison that handles memberPorts specifically
            if self._deep_compare_portchannel_instance(desired_instance, current_instance):
                self.log("Port channel '{0}' instance differs - update needed".format(name), "DEBUG")
                return True
    ...
    def _deep_compare_portchannel_instance(self, desired_instance, current_instance):
        ...
        Returns:
            bool: True if instances differ, False if they match
        """
        self.log("Performing deep port channel instance comparison with memberPorts support", "DEBUG")
        ...
        for key, desired_value in desired_instance.items():
            ...
            current_value = current_instance.get(key)
            if desired_value != current_value:
                self.log("Port channel parameter '{0}' differs: desired='{1}', current='{2}'".format(
                    key, desired_value, current_value), "DEBUG")
                return True
        ...
        if "memberPorts" in desired_instance:
            ...
            current_member_ports = current_instance.get("memberPorts", {}).get("items", [])
    ...
    def _compare_member_ports(self, desired_members, current_members):
        ...
        """
        self.log("Comparing member ports: desired={0}, current={1}".format(
            len(desired_members), len(current_members)), "DEBUG")
        ...
        for desired_member in desired_members:
            ...
            if not current_member:
                self.log("Member port '{0}' not found in current members - update needed".format(interface_name), "DEBUG")
                return True
            
            # Compare member port parameters
            if self._deep_compare_instances(desired_member, current_member):
                self.log("Member port '{0}' differs - update needed".format(interface_name), "DEBUG")
                return True
        
        return False

    def _compare_vlan_based_instances(self, desired_instances, current_instances, instance_type):
        """
        ...
        Returns:
            bool: True if update is needed, False otherwise
        """
        self.log("Performing enhanced VLAN-based instance comparison for {0}".format(instance_type), "DEBUG")
        ...
        for desired_instance in desired_instances:
            ...
            if not current_instance:
                self.log("VLAN {0} not found in current instances - update needed".format(vlan_id), "DEBUG")
                return True
            ...
            if instance_type == "stpInstances":
                if self._deep_compare_stp_instance(desired_instance, current_instance):
                    self.log("STP VLAN {0} instance differs - update needed".format(vlan_id), "DEBUG")
                    return True
            elif instance_type in ["igmpSnoopingVlanSettings", "mldSnoopingVlanSettings"]:
                if self._deep_compare_snooping_vlan_instance(desired_instance, current_instance, instance_type):
                    self.log("{0} VLAN {1} instance differs - update needed".format(instance_type, vlan_id), "DEBUG")
                    return True
            else:
                # Fallback to standard deep comparison
                if self._deep_compare_instances(desired_instance, current_instance):
                    self.log("VLAN {0} instance differs - update needed".format(vlan_id), "DEBUG")
                    return True
    ...
    def _deep_compare_stp_instance(self, desired_instance, current_instance):
        ...
        for key, desired_value in desired_instance.items():
            ...
            current_value = current_instance.get(key)
            if desired_value != current_value:
                self.log("STP parameter '{0}' differs: desired='{1}', current='{2}'".format(
                    key, desired_value, current_value), "DEBUG")
                return True
    ...
    def _deep_compare_snooping_vlan_instance(self, desired_instance, current_instance, instance_type):
        """
        ...
        Returns:
            bool: True if instances differ, False if they match
        """
        self.log("Performing deep {0} instance comparison with mrouters support".format(instance_type), "DEBUG")
        
        # Determine the mrouter key based on instance type
        mrouter_key = "igmpSnoopingVlanMrouters" if "igmp" in instance_type.lower() else "mldSnoopingVlanMrouters"
        ...
        for key, desired_value in desired_instance.items():
            ...
            current_value = current_instance.get(key)
            if desired_value != current_value:
                self.log("Snooping parameter '{0}' differs: desired='{1}', current='{2}'".format(
                    key, desired_value, current_value), "DEBUG")
                return True
    ...
    def _compare_mrouter_ports(self, desired_mrouters, current_mrouters):
        ...
        """
        self.log("Comparing mrouter ports: desired={0}, current={1}".format(
            len(desired_mrouters), len(current_mrouters)), "DEBUG")
        ...
        for desired_mrouter in desired_mrouters:
            ...
            if not current_mrouter:
                self.log("Mrouter port '{0}' not found in current mrouters - update needed".format(interface_name), "DEBUG")
                return True
            
            # Compare mrouter parameters
            if self._deep_compare_instances(desired_mrouter, current_mrouter):
                self.log("Mrouter port '{0}' differs - update needed".format(interface_name), "DEBUG")
                return True
    ...
    def _compare_name_based_list(self, desired_list, current_list):
        ...
        Returns:
            bool: True if lists differ, False if they match
        """
        current_by_name = {item.get("name"): item for item in current_list if item.get("name")}
    ...
    def _determine_interface_config_operation(self, desired_items, deployed_items):
        ...
        for desired_interface in desired_items:
            ...
            if not deployed_interface:
                ...
                self.log("Interface {0} config needs creation".format(interface_name), "DEBUG")
            else:
                ...
                if self._config_needs_update(desired_interface, deployed_interface):
                    ...
                    updated_interface.update({k: v for k, v in desired_interface.items() 
                                            if k not in ["configType", "interfaceName"]})
                    interfaces_to_process.append(updated_interface)
                    operation_type = "update"
                    self.log("Interface {0} config needs update".format(interface_name), "DEBUG")
    ...
    def _determine_default_config_operation(self, desired_items, deployed_items):
        ...
        if not deployed_items:
            # No deployed config - needs creation
            self.log("No deployed configuration found - operation needs creation", "DEBUG")
            return {
                "operation": "create",
        ...
        for i, desired_item in enumerate(desired_items):
            if i < len(deployed_items):
                ...
                self.log("Comparing desired item {0} with deployed item {1}".format(i, i), "DEBUG")
                ...
                if self._config_needs_update(desired_item, deployed_item):
                    ...
                    updated_item.update({k: v for k, v in desired_item.items() if k != "configType"})
                    updated_items.append(updated_item)
                    changes_needed = True
                    self.log("Item {0} requires update - parameters differ from deployed state".format(i), "DEBUG")
                else:
                    # Keep existing item as no changes needed
                    updated_items.append(deployed_item)
                    self.log("Item {0} matches deployed state - no changes needed".format(i), "DEBUG")
            else:
                # Add new item that doesn't exist in deployed config
                updated_items.append(desired_item)
                changes_needed = True
                self.log("Item {0} is new - will be added to configuration".format(i), "DEBUG")
        
        if not changes_needed:
            self.log("No configuration changes detected - operation not needed", "DEBUG")
            return None
    ...
    def _determine_intent_operation(self, intended_config, api_feature_name=None, desired_config=None):
        """
        ...
        """
        if not intended_config or not intended_config.get("response", {}).get(api_feature_name, {}).get("items"):
        ...
        if api_feature_name and desired_config and "items" in desired_config:
            existing_intended = intended_config.get("response", {}).get(api_feature_name, {}).get("items", [])
            desired_interfaces = [item.get("interfaceName") for item in desired_config["items"] if item.get("interfaceName")]
            existing_interfaces = [item.get("interfaceName") for item in existing_intended if item.get("interfaceName")]
            
            # If any desired interface doesn't exist in intended config, we need update (not create)
            if any(interface not in existing_interfaces for interface in desired_interfaces):
                self.log("Some interfaces not in intended config - intent needs update", "DEBUG")
                return "update"
    ...
    def _is_interface_feature(self, api_feature_name):
        ...
        """
        self.log("Checking if API feature '{0}' is an interface-specific feature".format(api_feature_name), "DEBUG")
        ...
        self.log("Feature '{0}' classification result: {1}".format(api_feature_name, "interface feature" if is_interface else "not an interface feature"), "DEBUG")
        
        return is_interface

    def _prepare_final_config(self, api_feature_name, config_to_apply, intended_config, intent_operation, deployed_config=None):
        """
        ...
        if intent_operation == "create":
            ...
            self.log("Using update operation - merging with existing intended configuration", "DEBUG")
            ...
            if api_feature_name == "igmpSnoopingGlobalConfig":
                self.log("Merging IGMP snooping configuration with special VLAN handling", "DEBUG")
                final_config = self._merge_igmp_snooping_config(config_to_apply, intended_config)
            elif api_feature_name == "mldSnoopingGlobalConfig":
                self.log("Merging MLD snooping configuration with special VLAN handling", "DEBUG")
                final_config = self._merge_mld_snooping_config(config_to_apply, intended_config)
            elif api_feature_name == "portchannelConfig":
                self.log("Merging port channel configuration with special handling", "DEBUG")
                final_config = self._merge_port_channel_config(config_to_apply, intended_config)
            elif self._is_interface_feature(api_feature_name):
                self.log("Merging interface feature configuration", "DEBUG")
                final_config = self._merge_interface_configs(api_feature_name, config_to_apply, intended_config)
            elif self._is_vlan_feature(api_feature_name):
                self.log("Merging VLAN feature configuration", "DEBUG")
                final_config = self._merge_vlan_configs(api_feature_name, config_to_apply, intended_config)
            elif api_feature_name == "stpGlobalConfig":
                # Special handling for STP to merge instances properly
                self.log("Merging STP global configuration with special instance handling", "DEBUG")
                final_config = self._merge_stp_global_config(config_to_apply, intended_config)
            else:
                # For global features, replace the configuration
                self.log("Replacing global feature configuration", "DEBUG")
                final_config = config_to_apply.copy()
        
        self.log("Final config prepared for {0}: {1}".format(api_feature_name, final_config), "DEBUG")
        
        # Prepare the full API payload structure
        final_merged_config = {api_feature_name: final_config}
        self.log("Final merged config for {0}: {1}".format(api_feature_name, final_merged_config), "DEBUG")
    ...
    def _merge_stp_global_config(self, new_config, existing_intended):
        ...
        if not existing_items:
            ...
            self.log("No existing STP configuration found, using new configuration as-is", "DEBUG")
            return new_config
        
        if not new_items:
            # No new config, return existing
            self.log("No new STP configuration provided, returning existing configuration", "DEBUG")
        ...
        self.log("Processing STP global configuration merge for single configuration item", "DEBUG")
        
        # Update global parameters (everything except stpInstances)
        for key, value in new_item.items():
            if key != "stpInstances":
                existing_item[key] = value
                self.log("Updated STP global parameter '{0}' with value: {1}".format(key, value), "DEBUG")
        ...
        if "stpInstances" in new_item:
            ...
            merged_instances = self._merge_stp_instances(existing_instances, new_instances)
            existing_item["stpInstances"] = merged_instances
            
            self.log("Merged STP instances: {0} total instances".format(
                len(merged_instances.get("items", []))), "DEBUG")
        else:
    ...
    def _merge_stp_instances(self, current_instances, desired_instances):
        ...
        try:
            ...
            current_items = current_instances.get('items', []) if current_instances else []
            desired_items = desired_instances.get('items', []) if desired_instances else []
            ...
            for item in current_items:
                ...
                if vlan_id:
                    ...
                    self.log("Added current instance for VLAN {0} to lookup".format(vlan_id), "DEBUG")
            
            # Start with all current instances
            merged_by_vlan = current_by_vlan.copy()
            self.log("Initialized merged instances with {0} current instances".format(len(merged_by_vlan)), "DEBUG")
            ...
            for desired_item in desired_items:
                ...
                if vlan_id:
                    if vlan_id in merged_by_vlan:
                        ...
                        self.log("Updated STP instance for VLAN {0}".format(vlan_id), "DEBUG")
                    else:
                        # Add new instance
                        merged_by_vlan[vlan_id] = desired_item
                        self.log("Added new STP instance for VLAN {0}".format(vlan_id), "DEBUG")
            
            # Convert back to list and sort by VLAN ID for consistency
            merged_instances['items'] = sorted(
                merged_by_vlan.values(),
                key=lambda x: x.get('vlanId', 0)
            )
            
            self.log("Merged STP instances: {0} total instances".format(len(merged_instances['items'])), "DEBUG")
    ...
    def _merge_interface_configs(self, api_feature_name, new_config, existing_intended):
        ...
        self.log("Found {0} existing interfaces in intended config".format(len(existing_items_by_interface)), "DEBUG")
        ...
        for new_item in new_items:
            ...
            if interface_name:
                ...
                self.log("Updated/added config for interface: {0}".format(interface_name), "DEBUG")
        ...
        self.log("Merged config contains {0} total interfaces".format(len(merged_items)), "DEBUG")
    ...
    def _merge_igmp_snooping_config(self, desired_config, existing_config):
        ...
        self.log("Existing config type: {0}, keys: {1}".format(type(existing_config).__name__, list(existing_config.keys()) if existing_config else "None"), "DEBUG")
        self.log("Desired config type: {0}, keys: {1}".format(type(desired_config).__name__, list(desired_config.keys()) if desired_config else "None"), "DEBUG")
        
        # Get the items from both configs
        existing_items = existing_config.get("items", [])
        self.log("Existing IGMP items: {0}".format(existing_items), "DEBUG")
        self.log("Extracted {0} existing items from configuration".format(len(existing_items)), "DEBUG")
        desired_items = desired_config.get("items", [])
        self.log("Desired IGMP items: {0}".format(desired_items), "DEBUG")
        self.log("Extracted {0} desired items from configuration".format(len(desired_items)), "DEBUG")
        ...
        # If no existing config, return desired
        if not existing_items:
            self.log("No existing configuration found, returning desired configuration as-is", "DEBUG")
            self.log("Early exit: Only desired configuration exists with {0} items".format(len(desired_items)), "DEBUG")
            return desired_config
        
        # If no desired config, return existing  
        if not desired_items:
            self.log("No desired configuration found, returning existing configuration as-is", "DEBUG")
            self.log("Early exit: Only existing configuration exists with {0} items".format(len(existing_items)), "DEBUG")
            return existing_config
        
        # Start main merge process
        self.log("Both configurations exist - proceeding with merge operation", "DEBUG")
        self.log("Merge operation will process {0} existing items and {1} desired items".format(len(existing_items), len(desired_items)), "DEBUG")
        ...
        for existing_item_index, existing_item in enumerate(existing_items):
            self.log("Processing existing item {0} of {1}".format(existing_item_index + 1, len(existing_items)), "DEBUG")
            self.log("Existing item structure: {0}".format(existing_item), "DEBUG")
            
            existing_config_type = existing_item.get("configType")
            self.log("Existing item configType: {0}".format(existing_config_type), "DEBUG")
            ...
            if existing_config_type == "IGMP_SNOOPING_GLOBAL":
                ...
                final_intended_item = copy.deepcopy(existing_item)
                self.log("Final intended IGMP item initialized from existing: {0}".format(final_intended_item), "DEBUG")
                self.log("Created deep copy of existing item with {0} keys".format(len(final_intended_item.keys())), "DEBUG")
                # Find corresponding desired item
                self.log("Searching for corresponding desired item with IGMP_SNOOPING_GLOBAL configType", "DEBUG")
                desired_item = None
                desired_item_found_index = None
                
                for d_item_index, d_item in enumerate(desired_items):
                    d_item_config_type = d_item.get("configType")
                    self.log("Checking desired item {0}: configType = {1}".format(d_item_index, d_item_config_type), "DEBUG")
                    
                    if d_item_config_type == "IGMP_SNOOPING_GLOBAL":
                        desired_item = d_item
                        desired_item_found_index = d_item_index
                        self.log("Found matching desired item at index {0}".format(d_item_index), "DEBUG")
                        break
                
                if desired_item:
                    self.log("Successfully found corresponding desired item for merge", "DEBUG")
                    self.log("Desired item structure: {0}".format(desired_item), "DEBUG")
                    self.log("Desired item contains {0} keys for processing".format(len(desired_item.keys())), "DEBUG")
                    
                    # Process global parameters (non-VLAN settings)
                    self.log("Starting global parameters merge (excluding VLAN settings)", "DEBUG")
                    ...
                    for key, value in desired_item.items():
                        if key != "igmpSnoopingVlanSettings" and key != "configType":
                            ...
                            self.log("Updating global parameter '{0}' from '{1}' to '{2}'".format(
                                key, old_value, value), "DEBUG")
                            final_intended_item[key] = value
                            global_params_updated += 1
                        else:
                            self.log("Skipping parameter '{0}' (will be handled separately)".format(key), "DEBUG")
                    
                    self.log("Global parameters merge completed: {0} parameters updated".format(global_params_updated), "DEBUG")
                    
                    # Handle VLAN settings merge with correct three-category approach
                    self.log("Starting VLAN settings extraction and validation", "DEBUG")
                    current_vlan_settings = existing_item.get("igmpSnoopingVlanSettings", {})
                    desired_vlan_settings = desired_item.get("igmpSnoopingVlanSettings", {})
                    
                    self.log("Current VLAN settings type: {0}".format(type(current_vlan_settings).__name__), "DEBUG")
                    self.log("Desired VLAN settings type: {0}".format(type(desired_vlan_settings).__name__), "DEBUG")
                    
                    current_vlan_items = current_vlan_settings.get("items", [])
                    desired_vlan_items = desired_vlan_settings.get("items", [])
                    
                    self.log("Current VLAN settings structure: {0}".format(current_vlan_settings), "DEBUG")
                    self.log("Desired VLAN settings structure: {0}".format(desired_vlan_settings), "DEBUG")
                    if desired_vlan_settings:
                        self.log("VLAN settings found in desired configuration - proceeding with VLAN merge", "DEBUG")
                        self.log("Merging IGMP VLAN settings - current intended has {0} VLANs, user desires {1} VLANs".format(
                            len(current_vlan_items), 
                            len(desired_vlan_items)), "DEBUG")
                        
                        self.log("Calling _merge_igmp_vlan_settings with parameters:", "DEBUG")
                        self.log("  - Current VLAN settings: {0} items".format(len(current_vlan_items)), "DEBUG")
                        self.log("  - Desired VLAN settings: {0} items".format(len(desired_vlan_items)), "DEBUG")
                        
                        # Apply the three-category logic: current -> desired -> final
                        merged_vlan_settings = self._merge_igmp_vlan_settings(current_vlan_settings, desired_vlan_settings)
                        
                        self.log("VLAN settings merge function returned successfully", "DEBUG")
                        self.log("Merged VLAN settings structure: {0}".format(merged_vlan_settings), "DEBUG")
                        
                        merged_vlan_items = merged_vlan_settings.get("items", [])
                        self.log("Final merged VLAN settings contain {0} items".format(len(merged_vlan_items)), "DEBUG")
                        
                        final_intended_item["igmpSnoopingVlanSettings"] = merged_vlan_settings
                        self.log("Successfully applied merged VLAN settings to final intended item", "DEBUG")
                        self.log("IGMP VLAN settings merge completed", "DEBUG")
                    else:
                        self.log("No desired VLAN settings found in user configuration", "DEBUG")
                        self.log("VLAN settings will remain unchanged from current intended configuration", "DEBUG")
                        self.log("Current VLAN settings preserved: {0} items".format(len(current_vlan_items)), "DEBUG")
                    
                    self.log("Global item merge completed successfully", "DEBUG")
                    self.log("Final intended item contains {0} keys".format(len(final_intended_item.keys())), "DEBUG")
                    
                else:
                    self.log("No corresponding desired item found with IGMP_SNOOPING_GLOBAL configType", "DEBUG")
                    self.log("Existing item will be preserved without changes", "DEBUG")
                
                # Add the processed item to merged results
                merged_items.append(final_intended_item)
                self.log("Added final intended item to merged results (item {0})".format(len(merged_items)), "DEBUG")
                
            else:
                self.log("Existing item has non-global configType '{0}', preserving as-is".format(existing_config_type), "DEBUG")
                merged_items.append(existing_item)
                self.log("Added non-global item to merged results (item {0})".format(len(merged_items)), "DEBUG")
        ...
        self.log("Final merged configuration structure: {0}".format(final_result), "DEBUG")
        self.log("Returning merged configuration with {0} items".format(len(merged_items)), "DEBUG")
    ...
    def _merge_igmp_vlan_settings(self, current_vlan_settings, desired_vlan_settings):
        ...
        """
        self.log("Starting IGMP VLAN settings merge using three-category approach", "DEBUG")
        ...
        self.log("Current intended VLANs count: {0}".format(len(current_vlans)), "DEBUG")
        ...
        for current_vlan in current_vlans:
            ...
            if vlan_id:
                ...
                self.log("Copied current intended VLAN {0} to final config".format(vlan_id), "DEBUG")
        
        self.log("Copied {0} current intended VLANs to final config".format(len(final_vlan_dict)), "DEBUG")
        ...
        for desired_vlan in desired_vlans:
            ...
            if vlan_id:
                ...
                if vlan_id in final_vlan_dict:
                    ...
                    self.log("VLAN {0} exists in current intended config - updating with user's desired values".format(vlan_id), "DEBUG")
                    
                    # Update ONLY the parameters provided by the user
                    igmp_vlan_params = [
                        "isIgmpSnoopingEnabled", "isImmediateLeaveEnabled", "isQuerierEnabled",
                        "querierAddress", "querierQueryInterval", "querierVersion"
                    ]
                    ...
                    for param in igmp_vlan_params:
                        if param in desired_vlan:
                            ...
                            if old_value != new_value:
                                ...
                                self.log("VLAN {0}: Updated parameter '{1}' from current '{2}' to user's desired '{3}' (values differ)".format(
                                    vlan_id, param, old_value, new_value), "DEBUG")
                            else:
                                self.log("VLAN {0}: Parameter '{1}' already matches desired value '{2}' - no update needed".format(
                                    vlan_id, param, new_value), "DEBUG")
                    
                    # Handle mrouter configuration if provided by user
                    if "igmpSnoopingVlanMrouters" in desired_vlan:
                        final_vlan["igmpSnoopingVlanMrouters"] = copy.deepcopy(desired_vlan["igmpSnoopingVlanMrouters"])
                        self.log("VLAN {0}: Applied user's mrouter configuration".format(vlan_id), "DEBUG")
                    elif "igmpSnoopingVlanMrouters" not in final_vlan:
                        final_vlan["igmpSnoopingVlanMrouters"] = {"configType": "SET", "items": []}
                        self.log("VLAN {0}: Added default mrouter structure".format(vlan_id), "DEBUG")
                    
                else:
                    # VLAN doesn't exist in current intended config - ADD new VLAN
                    self.log("VLAN {0} does not exist in current intended config - adding new VLAN".format(vlan_id), "DEBUG")
                    ...
                    if "igmpSnoopingVlanMrouters" not in new_vlan_config:
                        new_vlan_config["igmpSnoopingVlanMrouters"] = {"configType": "SET", "items": []}
                    
                    final_vlan_dict[vlan_id] = new_vlan_config
                    self.log("Added new VLAN {0} to final intended config".format(vlan_id), "DEBUG")
        ...
        self.log("IGMP VLAN settings merge completed with {0} total VLANs in final config".format(len(final_vlans)), "DEBUG")
    ...
    def _merge_mld_snooping_config(self, desired_config, existing_config):
        ...
        # Early exit conditions with detailed logging
        if not existing_items and not desired_items:
            self.log("No existing or desired MLD items found, returning desired config", "DEBUG")
            self.log("Early exit: Both configurations are empty", "DEBUG")
            return desired_config
        ...
        for existing_item_index, existing_item in enumerate(existing_items):
            ...
            if existing_config_type == "MLD_SNOOPING_GLOBAL":
                ...
                # Start with existing global config as the final intended config
                final_intended_item = copy.deepcopy(existing_item)
                self.log("Final intended MLD item initialized from existing: {0}".format(final_intended_item), "DEBUG")
                self.log("Created deep copy of existing item with {0} keys".format(len(final_intended_item.keys())), "DEBUG")
                
                # Find corresponding desired item
                self.log("Searching for corresponding desired item with MLD_SNOOPING_GLOBAL configType", "DEBUG")
                desired_item = None
                desired_item_found_index = None
                ...
                if desired_item:
                    ...
                    # Handle VLAN settings merge with correct three-category approach
                    self.log("Starting VLAN settings extraction and validation", "DEBUG")
                    current_vlan_settings = existing_item.get("mldSnoopingVlanSettings", {})
                    desired_vlan_settings = desired_item.get("mldSnoopingVlanSettings", {})
                    ...
                    if desired_vlan_settings:
                        self.log("VLAN settings found in desired configuration - proceeding with VLAN merge", "DEBUG")
                        self.log("Merging MLD VLAN settings - current intended has {0} VLANs, user desires {1} VLANs".format(
                            len(current_vlan_items), 
                            len(desired_vlan_items)), "DEBUG")
                        
                        self.log("Calling _merge_mld_vlan_settings with parameters:", "DEBUG")
                        self.log("  - Current VLAN settings: {0} items".format(len(current_vlan_items)), "DEBUG")
                        self.log("  - Desired VLAN settings: {0} items".format(len(desired_vlan_items)), "DEBUG")
                        
                        # Apply the three-category logic: current -> desired -> final
                        merged_vlan_settings = self._merge_mld_vlan_settings(current_vlan_settings, desired_vlan_settings)
                        ...
                        final_intended_item["mldSnoopingVlanSettings"] = merged_vlan_settings
                        self.log("Successfully applied merged VLAN settings to final intended item", "DEBUG")
                    ...
                    self.log("No corresponding desired item found with MLD_SNOOPING_GLOBAL configType", "DEBUG")
                    self.log("Existing item will be preserved without changes", "DEBUG")
    ...
    def _merge_mld_vlan_settings(self, current_vlan_settings, desired_vlan_settings):
        ...
        Returns:
            dict: Final VLAN settings with user's desired values applied to current intended config.
        """
        self.log("Starting MLD VLAN settings merge using three-category approach", "DEBUG")
        ...
        for desired_vlan in desired_vlans:
            ...
            if vlan_id:
                ...
                if vlan_id in final_vlan_dict:
                    ...
                    # Update ONLY the parameters provided by the user
                    mld_vlan_params = [
                        "isMldSnoopingEnabled", "isImmediateLeaveEnabled", "isQuerierEnabled",
                        "querierAddress", "querierQueryInterval", "querierVersion"
                    ]
                    ...
                    for param in mld_vlan_params:
                        if param in desired_vlan:
                            ...
                            if param == "querierAddress" and not new_value and not desired_vlan.get("isQuerierEnabled", False):
                                # Remove empty querierAddress when querier is disabled
                                if param in final_vlan:
                                    del final_vlan[param]
                                self.log("Removed empty querierAddress for VLAN {0} (querier disabled)".format(vlan_id), "DEBUG")
                                continue
                    ...
                    if "mldSnoopingVlanMrouters" in desired_vlan:
                        final_vlan["mldSnoopingVlanMrouters"] = copy.deepcopy(desired_vlan["mldSnoopingVlanMrouters"])
                        self.log("VLAN {0}: Applied user's mrouter configuration".format(vlan_id), "DEBUG")
                    elif "mldSnoopingVlanMrouters" not in final_vlan:
                        final_vlan["mldSnoopingVlanMrouters"] = {"configType": "SET", "items": []}
                        self.log("VLAN {0}: Added default mrouter structure".format(vlan_id), "DEBUG")
                    ...
                    if ("querierAddress" in new_vlan_config and 
                        not new_vlan_config["querierAddress"] and 
                        not new_vlan_config.get("isQuerierEnabled", False)):
                        del new_vlan_config["querierAddress"]
                        self.log("Removed empty querierAddress from new VLAN {0} (querier disabled)".format(vlan_id), "DEBUG")
                    
                    if "mldSnoopingVlanMrouters" not in new_vlan_config:
                        new_vlan_config["mldSnoopingVlanMrouters"] = {"configType": "SET", "items": []}
        ...
        self.log("MLD VLAN settings merge completed with {0} total VLANs in final config".format(len(final_vlans)), "DEBUG")
        self.log("Total parameters updated: {0}".format(parameters_updated), "DEBUG")
    ...
    def _merge_port_channel_config(self, desired_config, existing_config):
        ...
        if not existing_items or not desired_items:
            self.log("Missing items in existing or desired config, returning desired config", "DEBUG")
            return desired_config
        ...
        for key, value in desired_item.items():
            if key not in ["portchannels", "configType"]:
                ...
                self.log("Updated global parameter '{0}': {1}".format(key, value), "DEBUG")
        ...
        self.log("Current intended port channels count: {0}".format(len(existing_portchannels)), "DEBUG")
        self.log("User desired port channels count: {0}".format(len(desired_portchannels)), "DEBUG")
        ...
        self.log("Port channel merge completed. Final count: {0}".format(len(updated_portchannels)), "DEBUG")
        return merged_config
    ...
    def _merge_single_port_channel(self, current_pc, desired_pc):
        ...
        """
        self.log("Merging port channel: {0}".format(current_pc.get("name", "Unknown")), "DEBUG")
        ...
        for key, value in desired_pc.items():
            if key not in ["memberPorts", "configType"]:
                merged_pc[key] = value
                self.log("Updated port channel parameter '{0}': {1}".format(key, value), "DEBUG")
        ...
        for interface_name, member_config in current_member_map.items():
            ...
            if not is_being_updated:
                ...
                self.log("Preserving existing member: {0}".format(interface_name), "DEBUG")
        ...
        for desired_member in desired_members:
            ...
            if interface_name in current_member_map:
                self.log("Updating existing member: {0}".format(interface_name), "DEBUG")
        ...
        if updated_members:
            merged_pc["memberPorts"] = {
                "configType": "SET",
                "items": updated_members
            }
        
        self.log("Port channel merge completed. Members: {0}".format(len(updated_members)), "DEBUG")
        return merged_pc
    ...
    def _config_needs_update(self, desired_config, current_config):
        ...
        Returns:
            bool: True if update is needed, False otherwise
        """
        self.log("Starting configuration comparison to determine update necessity", "DEBUG")
        self.log("Desired configuration keys: {0}".format(list(desired_config.keys())), "DEBUG")
        self.log("Current configuration keys: {0}".format(list(current_config.keys())), "DEBUG")
        ...
        for key, desired_value in desired_config.items():
            ...
            self.log("Comparing parameter '{0}': desired='{1}', current='{2}'".format(key, desired_value, current_value), "DEBUG")
            
            if current_value != desired_value:
                self.log("Parameter {0} differs: desired={1}, current={2}".format(
                    key, desired_value, current_value), "DEBUG")
                self.log("Configuration update is required due to parameter differences", "DEBUG")
                return True
            else:
                self.log("Parameter '{0}' matches between desired and current configuration".format(key), "DEBUG")
        
        self.log("All parameters match between desired and current configuration", "DEBUG")
    ...
    def _is_vlan_feature(self, api_feature_name):
        ...
        """
        self.log("Checking if API feature '{0}' is VLAN-related".format(api_feature_name), "DEBUG")
        
        # Check if the feature name matches the VLAN configuration identifier
        is_vlan = api_feature_name == "vlanConfig"
        
        self.log("VLAN feature check result for '{0}': {1}".format(api_feature_name, is_vlan), "DEBUG")
    ...
    def _is_global_feature(self, api_feature_name):
        ...
        """
        self.log("Checking if API feature '{0}' is a global configuration feature".format(api_feature_name), "DEBUG")
        
        # Define the list of global configuration features that configure device-wide settings
        global_features = [
            "cdpGlobalConfig", "lldpGlobalConfig", "stpGlobalConfig", "vtpGlobalConfig",
            "dhcpSnoopingGlobalConfig", "igmpSnoopingGlobalConfig", "mldSnoopingGlobalConfig",
            "dot1xGlobalConfig", "portchannelConfig", "udldGlobalConfig"
        ]
        
        # Check if the feature is in the global features list
        is_global = api_feature_name in global_features
        
        self.log("Global feature check result for '{0}': {1}".format(api_feature_name, "global feature" if is_global else "not a global feature"), "DEBUG")
    ...
    def _is_interface_feature(self, api_feature_name):
        ...
        """
        self.log("Checking if API feature '{0}' is an interface configuration feature".format(api_feature_name), "DEBUG")
        ...
        self.log("Interface feature check result for '{0}': {1}".format(api_feature_name, "interface configuration feature" if is_interface else "not an interface configuration feature"), "DEBUG")
    ...
    def _execute_api_operations(self, diff_analysis):
        ...
        if not features_to_process:
            self.msg = "No Layer 2 configuration changes required for device {0}. Current configuration is already up-to-date.".format(device_identifier)
            self.set_operation_result("success", False, self.msg, "INFO")
            return {
                "executed_operations": {},
        ...
        self.log("Executing API operations for {0} features".format(len(features_to_process)), "INFO")
        ...
        for api_feature_name, operation_details in features_to_process.items():
            ...
            self.log("Executing operation for feature: {0} (user: {1})".format(api_feature_name, user_feature_name), "INFO")
            
            try:
                operation_result = self._execute_single_feature_operation(
                    network_device_id, api_feature_name, operation_details, user_feature_name
                )
                ...
                if operation_result.get("status") == "success":
                    ...
                    self.log("Successfully executed operation for feature: {0}".format(user_feature_name), "INFO")
                else:
                    failed_operations += 1
                    ...
                    self.log("Failed to execute operation for feature: {0}".format(user_feature_name), "ERROR")
                    
            except Exception as e:
                error_msg = "Exception during operation for feature {0}: {1}".format(user_feature_name, str(e))
        ...
        if failed_operations > 0:
            failure_details = self._build_detailed_failure_message(failed_features, device_identifier, "intent configuration")
        ...
        if successful_operations > 0:
            self.log("All intent operations successful. Attempting to deploy configurations to device", "INFO")
            try:
                deployment_result = self._deploy_configurations(network_device_id, device_identifier)
                ...
                error_msg = "Exception during deployment for device {0}: {1}".format(device_identifier, str(e))
                self.log(error_msg, "ERROR")
                self.msg = error_msg
                self.set_operation_result("failed", True, self.msg, "ERROR")
                self.fail_and_exit(self.msg)
        ...
        self.log("API operations execution completed: {0}".format(operation_results["summary"]), "INFO")
        return operation_results

    def _execute_single_feature_operation(self, network_device_id, api_feature_name, operation_details, user_feature_name):
        """
        ...
        self.log("Executing {0} intent operation for feature {1}".format(intent_operation, user_feature_name), "DEBUG")
        ...
        try:
            if intent_operation == "create":
                ...
                success_msg = "Successfully created {0} intent configuration".format(user_feature_name)
                ...
                success_msg = "Successfully updated {0} intent configuration".format(user_feature_name)
            else:
                raise ValueError("Invalid intent operation: {0}".format(intent_operation))
            
            # Debug: Log the task response structure and type
            self.log("DEBUG: task_response type: {0}".format(type(task_response)), "DEBUG")
            ...
            if task_response and isinstance(task_response, str):
                ...
                self.log("Task initiated for {0} operation on {1}, task ID: {2}".format(
                    intent_operation, user_feature_name, task_id), "INFO")
                ...
                error_msg = "Invalid task response format for {0} operation on {1}. Expected string task ID, got: {2} (type: {3})".format(
                    intent_operation, user_feature_name, task_response, type(task_response).__name__)
                self.log(error_msg, "ERROR")
                return {
                    "status": "failed",
                    "error": error_msg,
            ...
            error_msg = "Failed to execute {0} operation for {1}: {2}".format(intent_operation, user_feature_name, str(e))
            self.log(error_msg, "ERROR")
            self.log("Exception details: {0}".format(str(e)), "DEBUG")
            
            # DEBUG: Add full traceback
            import traceback
            self.log("DEBUG: Full exception traceback: {0}".format(traceback.format_exc()), "DEBUG")
    ...
    def _deploy_configurations(self, network_device_id, device_identifier):
        ...
        """
        self.log("Initiating deployment of configurations to device {0}".format(device_identifier), "INFO")
        
        try:
            deploy_response = self.deploy_intended_configurations(network_device_id)
            
            # Debug: Log the deploy response structure and type
            self.log("DEBUG: deploy_response type: {0}".format(type(deploy_response)), "DEBUG")
            self.log("DEBUG: deploy_response content: {0}".format(deploy_response), "DEBUG")
            ...
            if deploy_response and isinstance(deploy_response, str):
                ...
                success_msg = "Successfully deployed Wired Campus Automation configuration to device {0}".format(device_identifier)
                self.log("Deployment task initiated, task ID: {0}".format(task_id), "INFO")
            ...
            error_msg = "Failed to deploy configurations to device {0}: {1}".format(device_identifier, str(e))
            self.log(error_msg, "ERROR")
            return {
                "status": "failed",
                "error": error_msg,
    ...
    def _build_detailed_failure_message(self, failed_features, device_identifier, operation_type):
        """
        ...
        if not failed_features:
            return "Unknown failure occurred during {0} for device {1}".format(operation_type, device_identifier)
        ...
        for i, failure in enumerate(failed_features, 1):
            ...
            failure_msg += "{0}. {1} ({2} operation): {3}\n".format(i, feature_name, operation, error)
            self.log("Processing failure {0}: Feature '{1}', Operation '{2}', Error '{3}'".format(
                i, feature_name, operation, error), "DEBUG")
        
        self.log("Built detailed failure message for {0} failed features during {1}".format(
            len(failed_features), operation_type), "DEBUG")
        
        return failure_msg.rstrip()

    def _log_configuration_state(self, state_label, want_feature_mappings, deployed_configs):
        """
        ...
        for user_feature_name, user_feature_config in want_feature_mappings.items():
            ...
            for api_feature_name in user_feature_config.keys():
                ...
                if config.get("response", {}).get(api_feature_name, {}).get("items"):
                    ...
                    self.log("  - {0}: {1} items configured".format(user_friendly_name, items_count), "INFO")
                    self.log("    {0} config structure: {1}".format(
                        state_label, config["response"][api_feature_name]), "DEBUG")
                else:
                    self.log("  - {0}: No configuration found".format(user_friendly_name), "INFO")

    def _perform_detailed_verification(self, want_feature_mappings, original_deployed_configs, 
        ...
        for user_feature_name, user_feature_config in want_feature_mappings.items():
            ...
            for api_feature_name, desired_config in user_feature_config.items():
                ...
                self.log("Verifying API feature: {0} ({1})".format(api_feature_name, user_friendly_name), "INFO")
                ...
                verification_summary["detailed_results"][api_feature_name] = feature_verification
    ...
    def _verify_single_feature(self, api_feature_name, user_friendly_name, desired_config, 
                            original_config, post_config):
        """
        ...
        """
        self.log("Performing detailed verification for feature: {0}".format(user_friendly_name), "DEBUG")
        
        # Extract actual configuration items
        original_items = original_config.get("response", {}).get(api_feature_name, {}).get("items", [])
        post_items = post_config.get("response", {}).get(api_feature_name, {}).get("items", [])
        desired_items = desired_config.get("items", [])
        ...
        if not post_items:
            return {
                "status": "not_found",
                "message": "{0} configuration not found after deployment".format(user_friendly_name),
                "details": "Expected configuration items but found none in deployed state"
            }
        
        # Perform feature-type specific verification
        if self._is_vlan_feature(api_feature_name):
            return self._verify_vlan_configuration(user_friendly_name, desired_items, post_items, original_items)
        elif self._is_global_feature(api_feature_name):
            return self._verify_global_configuration(user_friendly_name, desired_items, post_items, original_items)
        elif self._is_interface_feature(api_feature_name):
            return self._verify_interface_configuration(user_friendly_name, desired_items, post_items, original_items)
        else:
            return self._verify_default_configuration(user_friendly_name, desired_items, post_items, original_items)

    def _verify_vlan_configuration(self, user_friendly_name, desired_items, post_items, original_items):
        """
        ...
        for desired_vlan in desired_items:
            ...
            if not post_vlan:
                failed_vlans.append("VLAN {0} not found in deployed configuration".format(vlan_id))
                continue
            ...
            if vlan_verification["success"]:
                ...
                self.log("VLAN {0} verification successful: {1}".format(vlan_id, vlan_verification["details"]), "DEBUG")
            else:
                failed_vlans.append("VLAN {0}: {1}".format(vlan_id, vlan_verification["details"]))
                self.log("VLAN {0} verification failed: {1}".format(vlan_id, vlan_verification["details"]), "DEBUG")
        
        if failed_vlans:
            return {
                "status": "failed",
                "message": "{0} verification failed for VLANs: {1}".format(user_friendly_name, ", ".join(failed_vlans)),
                "details": "Successfully verified: {0}, Failed: {1}".format(len(verified_vlans), len(failed_vlans))
            }
        else:
            return {
                "status": "success",
                "message": "{0} successfully verified for {1} VLANs".format(user_friendly_name, len(verified_vlans)),
                "details": "All requested VLAN configurations match deployed state"
            }

    def _verify_global_configuration(self, user_friendly_name, desired_items, post_items, original_items):
        """
        ...
        Returns:
            dict: Verification result containing status, message, and details
        """
        self.log("Verifying global configuration details for {0}".format(user_friendly_name), "DEBUG")
        
        if not desired_items or not post_items:
            return {
                "status": "failed",
                "message": "{0} verification failed - missing configuration items".format(user_friendly_name),
        ...
        verification_result = self._verify_configuration_parameters(desired_item, post_item)
        
        if verification_result["success"]:
            return {
                "status": "success",
                "message": "{0} successfully verified and deployed".format(user_friendly_name),
                "details": verification_result["details"]
            }
        else:
            return {
                "status": "failed",
                "message": "{0} verification failed: {1}".format(user_friendly_name, verification_result["details"]),
                "details": "Configuration parameters do not match expected values"
            }

    def _verify_interface_configuration(self, user_friendly_name, desired_items, post_items, original_items):
        """
        ...
        Returns:
            dict: Verification result containing status, message, and details
        """
        self.log("Verifying interface configuration details for {0}".format(user_friendly_name), "DEBUG")
        ...
        for desired_interface in desired_items:
            ...
            if not post_interface:
                failed_interfaces.append("Interface {0} not found in deployed configuration".format(interface_name))
                continue
            
            # Verify interface parameters
            interface_verification = self._verify_configuration_parameters(desired_interface, post_interface)
            
            if interface_verification["success"]:
                verified_interfaces.append("Interface {0}".format(interface_name))
                self.log("Interface {0} verification successful: {1}".format(
                    interface_name, interface_verification["details"]), "DEBUG")
            else:
                failed_interfaces.append("Interface {0}: {1}".format(
                    interface_name, interface_verification["details"]))
                self.log("Interface {0} verification failed: {1}".format(
                    interface_name, interface_verification["details"]), "DEBUG")
    ...
    def _verify_default_configuration(self, user_friendly_name, desired_items, post_items, original_items):
        """
        ...
        Returns:
            dict: Verification result containing status, message, and details
        """
        self.log("Verifying default configuration for {0}".format(user_friendly_name), "DEBUG")
        ...
        for i, desired_item in enumerate(desired_items):
            if i < len(post_items):
                ...
                if verification_result["success"]:
                    ...
                    failed_items += 1
                    self.log("Item {0} verification failed: {1}".format(i, verification_result["details"]), "DEBUG")
            else:
                failed_items += 1
                self.log("Item {0} not found in deployed configuration".format(i), "DEBUG")
        
        if failed_items > 0:
            return {
                "status": "failed",
                "message": "{0} verification failed for {1} items".format(user_friendly_name, failed_items),
                "details": "Successfully verified: {0}, Failed: {1}".format(verified_items, failed_items)
            }
        else:
            return {
                "status": "success",
                "message": "{0} successfully verified for all {1} items".format(user_friendly_name, verified_items),
    ...
    def _verify_vlan_parameters(self, desired_vlan, post_vlan):
        ...
        if "name" in desired_vlan:
            ...
            if desired_name != post_name:
                ...
                verification_details.append("Name mismatch: expected '{0}', found '{1}'".format(desired_name, post_name))
                self.log("VLAN name verification failed: expected '{0}', found '{1}'".format(desired_name, post_name), "DEBUG")
            else:
                verification_details.append("Name verified: '{0}'".format(desired_name))
                self.log("VLAN name verification successful: '{0}'".format(desired_name), "DEBUG")
        ...
        if "isVlanEnabled" in desired_vlan:
            ...
            if desired_status != post_status:
                verification_success = False
                verification_details.append("Admin status mismatch: expected {0}, found {1}".format(desired_status, post_status))
                self.log("VLAN admin status verification failed: expected {0}, found {1}".format(desired_status, post_status), "DEBUG")
            else:
                verification_details.append("Admin status verified: {0}".format(desired_status))
                self.log("VLAN admin status verification successful: {0}".format(desired_status), "DEBUG")
        
        self.log("VLAN parameter verification completed: success={0}, details={1}".format(verification_success, len(verification_details)), "DEBUG")
        
        return {
            "success": verification_success,
            "details": "; ".join(verification_details) if verification_details else "All parameters verified"
        }
    ...
    def _verify_configuration_parameters(self, desired_config, post_config):
        ...
        for param, desired_value in desired_config.items():
            ...
            if self._values_match(desired_value, post_value):
                ...
                self.log("Parameter '{0}' verified successfully: {1}".format(param, desired_value), "DEBUG")
            else:
                verification_success = False
                verification_details.append("✗ {0}: expected '{1}', found '{2}'".format(param, desired_value, post_value))
                self.log("Parameter '{0}' verification failed: expected '{1}', found '{2}'".format(
                    param, desired_value, post_value), "DEBUG")
        ...
        self.log("Configuration parameter verification completed: success={0}, verified={1}".format(verification_success, verified_params), "DEBUG")
    ...
    def _values_match(self, desired, current):
        ...
        if type(desired) != type(current):
            self.log("Type mismatch detected: desired={0}, current={1}".format(type(desired).__name__, type(current).__name__), "DEBUG")
            return False
        
        if isinstance(desired, list):
            self.log("Comparing list values with lengths: desired={0}, current={1}".format(len(desired), len(current)), "DEBUG")
            if len(desired) != len(current):
                self.log("List length mismatch: desired={0}, current={1}".format(len(desired), len(current)), "DEBUG")
                return False
            
            # For lists containing dictionaries, we need to handle comparison differently
            if desired and isinstance(desired[0], dict):
                self.log("Found list of dictionaries, using specialized comparison method", "DEBUG")
                return self._compare_dict_lists(desired, current)
            else:
                # For lists of simple types, sort and compare
                try:
                    sorted_comparison = all(self._values_match(d, c) for d, c in zip(sorted(desired), sorted(current)))
                    self.log("Sorted list comparison completed successfully", "DEBUG")
                    return sorted_comparison
                except TypeError:
                    # If sorting fails, compare without sorting (order matters)
                    self.log("Sorting failed, comparing lists in original order", "DEBUG")
                    return all(self._values_match(d, c) for d, c in zip(desired, current))
        
        elif isinstance(desired, dict):
            self.log("Comparing dictionary values with keys: desired={0}, current={1}".format(len(desired), len(current)), "DEBUG")
            if set(desired.keys()) != set(current.keys()):
                self.log("Dictionary key sets differ between desired and current values", "DEBUG")
                return False
            dict_comparison = all(self._values_match(desired[key], current[key]) for key in desired.keys())
            self.log("Dictionary comparison completed: {0}".format(dict_comparison), "DEBUG")
            return dict_comparison
        
        else:
            # Direct comparison for simple types
            simple_comparison = desired == current
            self.log("Simple value comparison result: {0} (desired='{1}', current='{2}')".format(simple_comparison, desired, current), "DEBUG")
    ...
    def _compare_dict_lists(self, desired_list, current_list):
        ...
        """
        if len(desired_list) != len(current_list):
            self.log("List length mismatch: desired={0}, current={1}".format(len(desired_list), len(current_list)), "DEBUG")
            return False
        
        # For STP instances, use vlanId as the key for matching
        if desired_list and 'vlanId' in desired_list[0]:
            self.log("Using vlanId-based matching for STP instances comparison", "DEBUG")
            
            desired_by_vlan = {item['vlanId']: item for item in desired_list}
            current_by_vlan = {item['vlanId']: item for item in current_list}
            
            self.log("Created VLAN lookup tables: desired={0} VLANs, current={1} VLANs".format(
                len(desired_by_vlan), len(current_by_vlan)), "DEBUG")
            
            if set(desired_by_vlan.keys()) != set(current_by_vlan.keys()):
                self.log("VLAN ID sets differ between desired and current lists", "DEBUG")
                return False
            
            # Compare each VLAN's configuration
            for vlan_id in desired_by_vlan.keys():
                if not self._values_match(desired_by_vlan[vlan_id], current_by_vlan[vlan_id]):
                    self.log("VLAN {0} configuration mismatch found".format(vlan_id), "DEBUG")
                    return False
        ...
        for i, desired_item in enumerate(desired_list):
            ...
            for j, current_item in enumerate(current_list_copy):
                if self._values_match(desired_item, current_item):
                    ...
                    found_match = True
                    self.log("Found match for desired item {0} at current position {1}".format(i, j), "DEBUG")
                    break
        ...
        self.log("Content-based comparison completed: remaining unmatched items={0}".format(remaining_items), "DEBUG")
    ...
    def _analyze_deletion_requirements(self, want_feature_mappings):
        ...
        self.log("Available deployed configs: {0}".format(list(deployed_configs.keys())), "DEBUG")
        self.log("Available intended configs: {0}".format(list(intended_configs.keys())), "DEBUG")
        ...
        self.log("Initialized deletion analysis structure for {0} features".format(len(want_feature_mappings)), "DEBUG")
        
        # Process each user feature mapping to determine deletion type and requirements
        for user_feature_name, user_feature_config in want_feature_mappings.items():
            self.log("Analyzing deletion for user feature: {0}".format(user_feature_name), "DEBUG")
            self.log("User feature config structure: {0}".format(user_feature_config), "DEBUG")
            
            # Determine deletion type and process accordingly
            deletion_type = self._determine_deletion_type(user_feature_name, user_feature_config)
            self.log("Determined deletion type '{0}' for feature: {1}".format(deletion_type, user_feature_name), "DEBUG")
            
            if deletion_type == "type1":
                self.log("Processing Type 1 deletion (global reset) for feature: {0}".format(user_feature_name), "DEBUG")
                self._analyze_type1_deletion(user_feature_name, user_feature_config, 
                                        deployed_configs, intended_configs, deletion_analysis)
                deletion_analysis["summary"]["type1_features"] += 1
                
            elif deletion_type == "type2":
                self.log("Processing Type 2 deletion (VLAN deletion) for feature: {0}".format(user_feature_name), "DEBUG")
                self._analyze_type2_deletion(user_feature_name, user_feature_config,
                                        deployed_configs, intended_configs, deletion_analysis)
                deletion_analysis["summary"]["type2_features"] += 1
                
            elif deletion_type == "type3":
                self.log("Processing Type 3 deletion (hybrid feature) for feature: {0}".format(user_feature_name), "DEBUG")
                self._analyze_type3_deletion(user_feature_name, user_feature_config,
                                        deployed_configs, intended_configs, deletion_analysis)
                deletion_analysis["summary"]["type3_features"] += 1
                
            elif deletion_type == "type4":
                self.log("Processing Type 4 deletion (port configuration) for feature: {0}".format(user_feature_name), "DEBUG")
                self._analyze_type4_deletion(user_feature_name, user_feature_config,
                                        deployed_configs, intended_configs, deletion_analysis)
                deletion_analysis["summary"]["type4_features"] += 1
            else:
                self.log("Unknown deletion type '{0}' for feature: {1}".format(deletion_type, user_feature_name), "WARNING")
        
        self.log("Completed deletion analysis for all features", "INFO")
        self.log("Deletion analysis completed: {0}".format(deletion_analysis["summary"]), "INFO")
        self.log("Type 1 features: {0}".format(deletion_analysis["summary"]["type1_features"]), "DEBUG")
        self.log("Type 2 features: {0}".format(deletion_analysis["summary"]["type2_features"]), "DEBUG")
        self.log("Type 3 features: {0}".format(deletion_analysis["summary"]["type3_features"]), "DEBUG")
        self.log("Type 4 features: {0}".format(deletion_analysis["summary"]["type4_features"]), "DEBUG")
    ...
    def _determine_deletion_type(self, user_feature_name, user_feature_config):
        ...
        """
        self.log("Starting deletion type determination for feature: {0}".format(user_feature_name), "DEBUG")
        self.log("Analyzing feature configuration for deletion type classification", "DEBUG")
        ...
        self.log("Checking feature '{0}' against Type 1 features (global reset): {1}".format(user_feature_name, type1_features), "DEBUG")
        if user_feature_name in type1_features:
            self.log("Feature '{0}' classified as Type 1 deletion (global reset)".format(user_feature_name), "DEBUG")
            return "type1"
        
        self.log("Checking feature '{0}' against Type 2 features (VLAN deletion): {1}".format(user_feature_name, type2_features), "DEBUG")
        if user_feature_name in type2_features:
            self.log("Feature '{0}' classified as Type 2 deletion (VLAN deletion)".format(user_feature_name), "DEBUG")
            return "type2"
        
        self.log("Checking feature '{0}' against Type 3 features (hybrid features): {1}".format(user_feature_name, type3_features), "DEBUG")
        if user_feature_name in type3_features:
            self.log("Feature '{0}' classified as Type 3 deletion (hybrid feature)".format(user_feature_name), "DEBUG")
            return "type3"
        
        self.log("Checking feature '{0}' against Type 4 features (port configurations): {1}".format(user_feature_name, type4_features), "DEBUG")
        if user_feature_name in type4_features:
            self.log("Feature '{0}' classified as Type 4 deletion (port configuration)".format(user_feature_name), "DEBUG")
            return "type4"
        
        self.log("Unknown feature type for deletion: {0}".format(user_feature_name), "WARNING")
        self.log("Feature '{0}' does not match any known deletion type patterns".format(user_feature_name), "DEBUG")
        return "unknown"

    def _analyze_type1_deletion(self, user_feature_name, user_feature_config, deployed_configs, 
                            intended_configs, deletion_analysis):
        """
        ...
        """
        self.log("Analyzing Type 1 deletion for feature: {0}".format(user_feature_name), "DEBUG")
        ...
        deployed_items = deployed_config.get("response", {}).get(api_feature_name, {}).get("items", [])
        intended_items = intended_config.get("response", {}).get(api_feature_name, {}).get("items", [])
        
        if not deployed_items:
            self.log("No deployed configuration found for {0}, skipping deletion".format(user_feature_name), "INFO")
            return
        ...
        deletion_analysis["type1_global_resets"][user_feature_name] = {
            ...
            "operation_sequence": self._determine_type1_operation_sequence(bool(deployed_items), bool(intended_items))
        }
    ...
    def _analyze_type2_deletion(self, user_feature_name, user_feature_config, deployed_configs,
        ...
        Args:
            ...
            deletion_analysis (dict): Analysis results to populate
        """
        self.log("Analyzing Type 2 deletion for feature: {0}".format(user_feature_name), "DEBUG")
        ...
        for desired_vlan in desired_vlans:
            ...
            if vlan_id in deployed_vlan_lookup:
                ...
                self.log("VLAN {0} not found in deployed config, skipping deletion".format(vlan_id), "INFO")
        ...
        if vlans_to_delete or vlans_to_skip:
            deletion_analysis["type2_vlan_deletions"][user_feature_name] = {
                ...
                "deployed_config": deployed_config,
                "intended_config": intended_config,
                "operation_sequence": self._determine_type2_operation_sequence(vlans_to_delete, bool(intended_items))
            }
    ...
    def _analyze_type3_deletion(self, user_feature_name, user_feature_config, deployed_configs,
        ...
        Args:
            ...
            deletion_analysis (dict): Analysis results to populate
        """
        self.log("Type 3 deletion requested for feature: {0}".format(user_feature_name), "INFO")
        self.log("DELETION NOT SUPPORTED: Feature '{0}' deletion is not implemented due to beta API limitations".format(user_feature_name), "INFO")
        
        # Get the API feature name for logging purposes
        api_feature_name = list(user_feature_config.keys())[0] if user_feature_config else "unknown"
        ...
        deletion_analysis["type3_hybrid_features"][user_feature_name] = {
            ...
            "message": "Deletion for {0} is not supported due to beta API limitations".format(user_feature_name)
        }

    def _analyze_type4_deletion(self, user_feature_name, user_feature_config, deployed_configs,
                            intended_configs, deletion_analysis):
        """
        ...
        Args:
            ...
            deletion_analysis (dict): Analysis results to populate
        """
        self.log("Type 4 deletion requested for feature: {0}".format(user_feature_name), "INFO")
        self.log("DELETION NOT SUPPORTED: Feature '{0}' deletion is not implemented due to beta API limitations".format(user_feature_name), "INFO")
    ...
    def _determine_type1_operation_sequence(self, has_deployed, has_intended):
        ...
        """
        self.log("Starting operation sequence determination for Type 1 deletion", "DEBUG")
        self.log("Configuration state analysis: deployed={0}, intended={1}".format(has_deployed, has_intended), "DEBUG")
        
        if not has_deployed:
            self.log("No deployed configuration found - skipping deletion operation", "DEBUG")
            self.log("Operation sequence determined: skip_no_deployed", "DEBUG")
            return "skip_no_deployed"
        else:
            self.log("Deployed configuration exists - proceeding with deletion and deployment", "DEBUG")
    ...
    def _determine_type2_operation_sequence(self, vlans_to_delete, has_intended):
        ...
        """
        self.log("Starting operation sequence determination for Type 2 deletion", "DEBUG")
        ...
        if not vlans_to_delete:
            ...
            self.log("Intended configuration exists - updating existing intent to remove VLANs", "DEBUG")
            self.log("Operation sequence determined: update_intent_remove_vlans_and_deploy", "DEBUG")
            return "update_intent_remove_vlans_and_deploy"
        else:
            self.log("No intended configuration found - creating intent, updating, and deploying", "DEBUG")
            self.log("Operation sequence determined: create_intent_update_remove_and_deploy", "DEBUG")
            return "create_intent_update_remove_and_deploy"

    def _execute_deletion_operations(self, deletion_analysis, network_device_id, device_identifier):
        """
        ...
        """
        self.log("Starting execution of deletion operations for device {0}".format(device_identifier), "INFO")
        ...
        if deletion_analysis.get("type1_global_resets"):
            ...
            for feature_name, analysis in deletion_analysis["type1_global_resets"].items():
                try:
                    result = self._execute_type1_deletion(feature_name, analysis, network_device_id)
                    ...
                    if result.get("status") == "success":
                        ...
                        failed_operations.append({"feature": feature_name, "error": result.get("error")})
                        
                except Exception as e:
                    error_msg = "Exception during Type 1 deletion for {0}: {1}".format(feature_name, str(e))
                    self.log(error_msg, "ERROR")
                    failed_operations.append({"feature": feature_name, "error": error_msg})
                    deletion_results["summary"]["failed_operations"] += 1
        ...
        if deletion_analysis.get("type2_vlan_deletions"):
            ...
            for feature_name, analysis in deletion_analysis["type2_vlan_deletions"].items():
                try:
                    result = self._execute_type2_deletion(feature_name, analysis, network_device_id)
                    deletion_results["executed_operations"][feature_name] = result
                    deletion_results["summary"]["total_operations"] += 1
                    ...
                    error_msg = "Exception during Type 2 deletion for {0}: {1}".format(feature_name, str(e))
                    self.log(error_msg, "ERROR")
                    failed_operations.append({"feature": feature_name, "error": error_msg})
                    deletion_results["summary"]["failed_operations"] += 1
        ...
        if deletion_analysis.get("type3_hybrid_features"):
            ...
            for feature_name, analysis in deletion_analysis["type3_hybrid_features"].items():
                try:
                    result = self._execute_type3_deletion(feature_name, analysis, network_device_id)
                    deletion_results["executed_operations"][feature_name] = result
                    deletion_results["summary"]["total_operations"] += 1
                    ...
                    error_msg = "Exception during Type 3 deletion for {0}: {1}".format(feature_name, str(e))
                    self.log(error_msg, "ERROR")
                    failed_operations.append({"feature": feature_name, "error": error_msg})
                    deletion_results["summary"]["failed_operations"] += 1
        ...
        if deletion_analysis.get("type4_port_configurations"):
            ...
            for feature_name, analysis in deletion_analysis["type4_port_configurations"].items():
                try:
                    result = self._execute_type4_deletion(feature_name, analysis, network_device_id)
                    deletion_results["executed_operations"][feature_name] = result
                    deletion_results["summary"]["total_operations"] += 1
                    ...
                    error_msg = "Exception during Type 4 deletion for {0}: {1}".format(feature_name, str(e))
                    self.log(error_msg, "ERROR")
                    failed_operations.append({"feature": feature_name, "error": error_msg})
                    deletion_results["summary"]["failed_operations"] += 1
        ...
        if deletion_results["summary"]["successful_operations"] > 0:
            ...
            no_op_msg = "No Wired Campus Automation configuration changes required for device {0}. Requested configurations were not found or already in desired state.".format(device_identifier)
            self.msg = no_op_msg
            self.set_operation_result("success", False, self.msg, "INFO")
        else:
            no_op_msg = "No Wired Campus Automation configurations required deletion for device {0}.".format(device_identifier)
            self.msg = no_op_msg
            self.set_operation_result("success", False, self.msg, "INFO")
    ...
    def _execute_type1_deletion(self, feature_name, analysis, network_device_id):
        ...
        """
        self.log("Executing Type 1 deletion for feature: {0}".format(feature_name), "INFO")
        
        api_feature_name = analysis["api_feature_name"]
        operation_sequence = analysis["operation_sequence"]
        
        self.log("Processing deletion with API feature name: {0}".format(api_feature_name), "DEBUG")
        self.log("Operation sequence determined: {0}".format(operation_sequence), "DEBUG")
        
        try:
            if operation_sequence == "skip_no_deployed":
                self.log("Skipping deletion operation - no deployed configuration exists", "INFO")
                return {
                    "status": "success",
                    "message": "No deployed configuration found for {0}, skipping deletion".format(feature_name),
                    "operations_performed": []
                }
            
            elif operation_sequence == "delete_intent_and_deploy":
                self.log("Deleting intent for {0} (with automatic intent creation if needed)".format(feature_name), "INFO")
                
                # Execute the delete intent operation
                delete_result = self._execute_delete_intent_operation(network_device_id, api_feature_name, feature_name)
                
                if delete_result["status"] != "success":
                    self.log("Delete intent operation failed for feature: {0}".format(feature_name), "ERROR")
                    return delete_result
                
                self.log("Delete intent operation completed successfully for feature: {0}".format(feature_name), "DEBUG")
                ...
                if not delete_result.get("skipped"):
                    ...
                    if deploy_result["status"] == "success":
                        ...
                        success_message = "Successfully reset {0} configuration".format(feature_name)
                        ...
                        self.log("Deployment operation failed for feature: {0}".format(feature_name), "ERROR")
                        failure_message = "Failed to deploy {0} deletion".format(feature_name)
                    ...
                    self.log("Deployment was skipped during delete intent operation", "DEBUG")
                    return delete_result
            else:
            ...
            error_msg = "Exception during Type 1 deletion for {0}: {1}".format(feature_name, str(e))
            self.log(error_msg, "ERROR")
            self.log("Exception details for Type 1 deletion: {0}".format(str(e)), "DEBUG")
    ...
    def _execute_type2_deletion(self, feature_name, analysis, network_device_id):
        ...
        """
        self.log("Executing Type 2 deletion for feature: {0}".format(feature_name), "INFO")
        ...
        try:
            if operation_sequence == "update_intent_remove_vlans_and_deploy":
                ...
                updated_config = self._remove_vlans_from_intent_config(intended_config, vlans_to_delete, api_feature_name)
                
                self.log("Updating intent to remove VLANs for {0}".format(feature_name), "INFO")
                update_result = self._execute_update_intent_operation(network_device_id, api_feature_name, updated_config, feature_name)
                ...
                return {
                    "status": "success" if deploy_result["status"] == "success" else "failed",
                    "message": "Successfully deleted {0} VLANs from {1}".format(len(vlans_to_delete), feature_name) if deploy_result["status"] == "success" else "Failed to deploy VLAN deletion for {0}".format(feature_name),
                ...
                mapped_config = self._map_deployed_to_intent_config(api_feature_name, deployed_config)
                
                self.log("Creating intent for {0} from deployed config".format(feature_name), "INFO")
                create_result = self._execute_create_intent_operation(network_device_id, api_feature_name, mapped_config, feature_name)
                ...
                if deploy_result1["status"] != "success":
                    return {
                        "status": "failed",
                        "error": "Failed to deploy intent creation for {0}: {1}".format(feature_name, deploy_result1.get("error")),
                        "operations_performed": ["create_intent"]
                    }
                
                # Remove VLANs and update
                updated_config = self._remove_vlans_from_intent_config({"response": {api_feature_name: mapped_config[api_feature_name]}}, vlans_to_delete, api_feature_name)
                ...
                return {
                    "status": "success" if deploy_result2["status"] == "success" else "failed",
                    "message": "Successfully deleted {0} VLANs from {1}".format(len(vlans_to_delete), feature_name) if deploy_result2["status"] == "success" else "Failed to deploy VLAN deletion for {0}".format(feature_name),
                    "operations_performed": ["create_intent", "deploy", "update_intent", "deploy"],
                    "vlans_deleted": [v["vlan_id"] for v in vlans_to_delete],
    ...
    def _execute_type3_deletion(self, feature_name, analysis, network_device_id):
        ...
        """
        self.log("Type 3 deletion execution for feature: {0}".format(feature_name), "INFO")
        self.log("DELETION NOT SUPPORTED: {0}".format(analysis.get("message", "Feature deletion not supported")), "INFO")
        
        return {
            "status": "not_supported",
            "message": analysis.get("message", "Deletion not supported due to beta API limitations"),
    ...
    def _execute_type4_deletion(self, feature_name, analysis, network_device_id):
        ...
        Returns:
            dict: Operation result indicating not supported
        """
        self.log("Type 4 deletion execution for feature: {0}".format(feature_name), "INFO")
        self.log("DELETION NOT SUPPORTED: {0}".format(analysis.get("message", "Feature deletion not supported")), "INFO")
    ...
    def _execute_delete_intent_operation(self, network_device_id, api_feature_name, feature_name):
        """
        ...
        """
        self.log("Checking if intent exists before deletion for {0}".format(feature_name), "DEBUG")
        ...
        intent_exists = bool(intended_config.get("response", {}).get(api_feature_name, {}).get("items"))
        
        self.log("Intent existence check for {0}: {1}".format(feature_name, intent_exists), "DEBUG")
        
        if not intent_exists:
            self.log("No intent exists for {0}, creating intent from deployed config before deletion".format(feature_name), "INFO")
            ...
            if not deployed_config.get("response", {}).get(api_feature_name, {}).get("items"):
                self.log("No deployed configuration found for {0}, skipping deletion".format(feature_name), "INFO")
                return {
                    "status": "success",
                    "message": "No configuration found to delete for {0}".format(feature_name),
                    "skipped": True
                }
            ...
            self.log("Successfully created and deployed intent for {0}, proceeding with deletion".format(feature_name), "INFO")
        
        # Now proceed with the actual deletion
        try:
            task_response = self.delete_layer2_feature_configuration(network_device_id, api_feature_name)
            
            if task_response and isinstance(task_response, str):
                task_id = task_response
                task_name = "Delete {0} Intent Configuration".format(feature_name)
                success_msg = "Successfully deleted {0} intent configuration".format(feature_name)
                
                self.log("Delete task initiated for {0}, task ID: {1}".format(feature_name, task_id), "INFO")
                ...
                return {
                    "status": "failed",
                    "error": "Invalid delete response format for {0}".format(feature_name),
                    "response": task_response
                }
        
        except Exception as e:
            error_msg = "Failed to execute delete operation for {0}: {1}".format(feature_name, str(e))
            self.log(error_msg, "ERROR")
            return {
                "status": "failed",
                "error": error_msg,
    ...
    def _execute_create_intent_operation(self, network_device_id, api_feature_name, config, feature_name):
        """
        ...
        """
        try:
            task_response = self.create_layer2_feature_configuration(network_device_id, api_feature_name, config)
            
            if task_response and isinstance(task_response, str):
                task_id = task_response
                task_name = "Create {0} Intent Configuration".format(feature_name)
                success_msg = "Successfully created {0} intent configuration".format(feature_name)
                
                self.log("Create task initiated for {0}, task ID: {1}".format(feature_name, task_id), "INFO")
                ...
                return {
                    "status": "failed",
                    "error": "Invalid create response format for {0}".format(feature_name),
                    "response": task_response
                }
        
        except Exception as e:
            error_msg = "Failed to execute create operation for {0}: {1}".format(feature_name, str(e))
            self.log(error_msg, "ERROR")
            return {
                "status": "failed",
                "error": error_msg,
    ...
    def _execute_update_intent_operation(self, network_device_id, api_feature_name, config, feature_name):
        """
        ...
        """
        try:
            task_response = self.update_layer2_feature_configuration(network_device_id, api_feature_name, config)
            
            if task_response and isinstance(task_response, str):
                task_id = task_response
                task_name = "Update {0} Intent Configuration".format(feature_name)
                success_msg = "Successfully updated {0} intent configuration".format(feature_name)
                
                self.log("Update task initiated for {0}, task ID: {1}".format(feature_name, task_id), "INFO")
                ...
                return {
                    "status": "failed",
                    "error": "Invalid update response format for {0}".format(feature_name),
                    "response": task_response
                }
        
        except Exception as e:
            error_msg = "Failed to execute update operation for {0}: {1}".format(feature_name, str(e))
            self.log(error_msg, "ERROR")
            return {
                "status": "failed",
                "error": error_msg,
    ...
    def _execute_deployment_operation(self, network_device_id):
        ...
        try:
            ...
            if task_response and isinstance(task_response, str):
                task_id = task_response
                task_name = "Deploy Wired Campus Automation Configuration"
                success_msg = "Successfully deployed Wired Campus Automation configuration"
    ...
    def _map_deployed_to_intent_config(self, api_feature_name, deployed_config):
        ...
        """
        self.log("Starting mapping of deployed configuration to intent format for feature: {0}".format(api_feature_name), "DEBUG")
        self.log("Input deployed configuration structure: {0}".format(deployed_config), "DEBUG")
        
        deployed_items = deployed_config.get("response", {}).get(api_feature_name, {}).get("items", [])
        
        self.log("Extracted {0} deployed items from configuration".format(len(deployed_items)), "DEBUG")
        
        if not deployed_items:
            self.log("No deployed items found, returning empty intent configuration", "DEBUG")
        ...
        self.log("Successfully mapped {0} deployed items to intent format".format(len(intent_items)), "DEBUG")
        
        intent_config = {api_feature_name: {"items": intent_items}}
        
        self.log("Final intent configuration structure: {0}".format(intent_config), "DEBUG")
        self.log("Deployed to intent mapping completed successfully for feature: {0}".format(api_feature_name), "INFO")
    ...
    def _clean_deployed_item_for_intent(self, deployed_item):
        ...
        """
        self.log("Starting cleanup of deployed item for intent configuration compatibility", "DEBUG")
        ...
        fields_to_remove = [
            "id", "deviceId", "deviceName", "lastUpdated", "status", "deploymentId"
        ]
        
        self.log("Removing {0} deployment-specific fields from item".format(len(fields_to_remove)), "DEBUG")
        
        for field in fields_to_remove:
            if field in intent_item:
                del intent_item[field]
                self.log("Removed deployment field '{0}' from intent item".format(field), "DEBUG")
            else:
                self.log("Field '{0}' not present in deployed item, skipping removal".format(field), "DEBUG")
    ...
    def _remove_vlans_from_intent_config(self, intended_config, vlans_to_delete, api_feature_name):
        """
        ...
        for item in intended_items:
            ...
            if vlan_id not in vlan_ids_to_delete:
                ...
                self.log("Removing VLAN {0} from intent configuration".format(vlan_id), "DEBUG")
        
        self.log("Remaining VLANs after deletion: {0}".format(len(remaining_items)), "DEBUG")
    ...
    def get_want(self, config, state):
        ...
        ip_address = config.get("ip_address")
        hostname = config.get("hostname")
        device_collection_status_check = config.get("device_collection_status_check", True)
        config_verification_wait_time = config.get("config_verification_wait_time", 10)

        self.log("Device identifiers - IP: {0}, Hostname: {1}".format(ip_address, hostname), "DEBUG")
        self.log("Verification wait time: {0} seconds".format(config_verification_wait_time), "DEBUG")

        # Extract Layer2 feature mappings from user configuration
        self.log("Extracting Layer2 feature mappings from user configuration", "INFO")
        discovered_features, feature_mappings = self.extract_layer2_feature_mappings(config)
        
        self.log("Feature mapping extraction completed", "DEBUG")
        self.log("Discovered {0} API features for processing".format(len(discovered_features)), "INFO")
        ...
        self.log("Features to be processed: {0}".format(want["total_discovered_features"]), "INFO")
        self.log("API features discovered: {0}".format(want["discovered_api_features"]), "DEBUG")
    ...
    def get_have(self, config, state):
        ...
        self.log("Initiating current state gathering for network device configuration analysis", "DEBUG")
        
        # Ensure want state exists
        if not hasattr(self, 'want') or not self.want:
            self.msg = "No 'want' state found. get_want() must be called before get_have()."
            self.log("Want state validation failed - no want state available for processing", "ERROR")
            self.fail_and_exit(self.msg)
        ...
        self.log("Total discovered features count: {0}".format(len(discovered_features)), "DEBUG")
        ...
        self.log("Initiating device ID resolution using IP address or hostname", "DEBUG")
        mgmt_ip_to_instance_id_map = self.get_network_device_id(ip_address, hostname)
        
        if not mgmt_ip_to_instance_id_map:
            self.msg = "Failed to retrieve network device ID for device: {0}".format(device_identifier)
            self.log("Device ID resolution failed for device: {0}".format(device_identifier), "ERROR")
            self.fail_and_exit(self.msg)
        
        network_device_id = list(mgmt_ip_to_instance_id_map.values())[0]
        resolved_ip_address = list(mgmt_ip_to_instance_id_map.keys())[0]
        
        self.log("Device resolution successful - Network Device ID: {0}".format(network_device_id), "INFO")
        ...
        if discovered_features:
            ...
            self.log("Starting configuration retrieval for {0} discovered features".format(len(discovered_features)), "DEBUG")
            ...
            self.log("Retrieved deployed configs for {0} features".format(len(deployed_configs)), "DEBUG")
            self.log("Retrieved intended configs for {0} features".format(len(intended_configs)), "DEBUG")
            self.log("Configuration data successfully populated from Catalyst Center", "DEBUG")
        else:
            self.log("No features discovered from user configuration, skipping config retrieval", "INFO")
            self.log("Configuration retrieval bypassed due to empty feature list", "DEBUG")
        ...
        self.log("Device: {0} (ID: {1})".format(
            have["device_identifier"], have["network_device_id"]), "INFO")
        self.log("Deployed configs retrieved for: {0} features".format(have["configs_retrieved_for_features"]), "INFO")
        self.log("Total features processed: {0}".format(have["total_features_processed"]), "INFO")
        self.log("Have state processing completed with comprehensive device and configuration data", "DEBUG")
        
        # Debug logging of complete have structure
        self.log("Complete 'have' state structure: {0}".format(str(self.have)), "DEBUG")
        self.log("Have state contains all required components for difference analysis", "DEBUG")
    ...
    def get_diff_merged(self):
        ...
        self.log("Analyzing configuration differences and determining required operations", "INFO")
        ...
        self.log("Configuration difference analysis and API operations completed", "INFO")
        return self
    ...
    def get_diff_deleted(self):
        ...
        Returns:
            self: Returns the instance with updated diff and result attributes
        """
        self.log("Starting 'get_diff_deleted' operation for Layer 2 configuration deletion", "INFO")
        ...
        self.log("Feature mappings to process for deletion: {0}".format(len(want_feature_mappings)), "DEBUG")
        
        if not want_feature_mappings:
            self.log("No feature mappings found for deletion operation", "INFO")
            self.msg = "No Layer 2 configurations specified for deletion from device {0}".format(device_identifier)
            self.set_operation_result("success", False, self.msg, "INFO")
            self.log("Deletion operation completed - no configurations to delete", "INFO")
            return self
        
        self.log("Processing deletion for {0} Layer 2 features on device {1}".format(
            len(want_feature_mappings), device_identifier), "INFO")
        ...
        self.log("Deletion analysis summary: {0}".format(deletion_analysis.get("summary", {})), "DEBUG")
        
        # Execute deletion operations
        self.log("Starting execution of deletion operations", "INFO")
        deletion_results = self._execute_deletion_operations(deletion_analysis, network_device_id, device_identifier)
        self.log("Deletion operations execution completed", "INFO")
        self.log("Deletion results summary: {0}".format(deletion_results.get("summary", {})), "DEBUG")
        
        # Store results for verification
        self.result["deletion_results"] = deletion_results
        self.log("Stored deletion results for potential verification use", "DEBUG")
        
        self.log("Deletion operations completed for device {0}".format(device_identifier), "INFO")
    ...
    def verify_diff_merged(self):
        ...
        """
        self.log("Starting 'verify_diff_merged' operation for configuration verification", "INFO")
        ...
        self.log("Network device ID: {0}".format(network_device_id), "DEBUG")
        self.log("Device identifier: {0}".format(device_identifier), "DEBUG")
        self.log("Want feature mappings count: {0}".format(len(want_feature_mappings)), "DEBUG")
        self.log("Discovered features count: {0}".format(len(discovered_features)), "DEBUG")
        
        # Get pre-operation state from self.have
        pre_operation_deployed_configs = self.have.get("current_deployed_configs", {})
        
        self.log("Retrieved pre-operation deployed configurations from have state", "DEBUG")
        self.log("Pre-operation deployed configs available for {0} features".format(len(pre_operation_deployed_configs)), "DEBUG")
        
        if not want_feature_mappings:
            self.log("No desired configurations found for verification", "INFO")
            self.log("VERIFICATION RESULT: No configuration changes were requested for verification", "INFO")
            return self

        if not network_device_id:
            self.log("Network device ID not found, cannot perform verification", "ERROR")
            self.log("VERIFICATION RESULT: Unable to verify configuration - network device ID not available", "ERROR")
            return self

        # Add configurable wait time before verification
        config_verification_wait_time = self.want.get("config_verification_wait_time", 10)  # Default 10 seconds
        self.log("Waiting {0} seconds for configuration changes to propagate before verification".format(config_verification_wait_time), "INFO")
        ...
        self.log("CONFIGURATION VERIFICATION - PRE-OPERATION vs POST-OPERATION ANALYSIS", "INFO")
        self.log("Device being verified: {0} (ID: {1})".format(device_identifier, network_device_id), "INFO")
        self.log("Total user features to verify: {0}".format(len(want_feature_mappings)), "INFO")
        
        # Log original pre-operation state
        self.log("PRE-OPERATION DEPLOYED CONFIGURATION STATE:", "INFO")
        self.log("Starting pre-operation state logging for verification baseline", "DEBUG")
        self._log_configuration_state("Pre-operation", want_feature_mappings, pre_operation_deployed_configs)
        ...
        self.log("Retrieving current post-operation deployed configurations for verification", "INFO")
        
        try:
            self.log("Initiating post-operation configuration retrieval from Catalyst Center", "DEBUG")
            post_operation_deployed_configs, _ = self.get_current_configs_for_features(
                network_device_id, discovered_features
            )
            
            self.log("Successfully retrieved post-operation configurations for {0} features".format(
                len(post_operation_deployed_configs)), "INFO")
            self.log("Post-operation configuration retrieval completed successfully", "DEBUG")
            
        except Exception as e:
            error_msg = "Failed to retrieve post-operation configurations for verification: {0}".format(str(e))
            self.log(error_msg, "ERROR")
            self.log("Post-operation configuration retrieval failed with exception: {0}".format(str(e)), "DEBUG")
        ...
        self.log("Starting post-operation state logging for verification comparison", "DEBUG")
        self._log_configuration_state("Post-operation", want_feature_mappings, post_operation_deployed_configs)
        ...
        self.log("Verification results structure populated with {0} feature results".format(
            len(verification_results.get("detailed_results", {}))), "DEBUG")
        
        # Log verification summary
        self.log("VERIFICATION SUMMARY:", "INFO")
        self.log("Total features verified: {0}".format(verification_results["total_features_verified"]), "INFO")
        self.log("Features successfully applied: {0}".format(verification_results["features_successfully_applied"]), "INFO")
        self.log("Features with verification failures: {0}".format(verification_results["features_failed_verification"]), "INFO")
        self.log("Features not found post-operation: {0}".format(verification_results["features_not_found"]), "INFO")
        ...
        if verification_results["verification_failed"]:
            self.log("VERIFICATION RESULT: {0}".format(verification_results["failure_message"]), "ERROR")
            self.log("Configuration verification failed - some features did not meet expected state", "DEBUG")
        else:
            self.log("VERIFICATION RESULT: {0}".format(verification_results["success_message"]), "INFO")
            self.log("Configuration verification succeeded - all features verified successfully", "DEBUG")
    ...
    def verify_diff_deleted(self):
        ...
        self.log("DELETION VERIFICATION NOTICE: Verification for deleted configurations is not implemented", "INFO")
        self.log("Reason: The underlying Layer 2 configuration APIs are in beta and verification logic", "INFO") 
        self.log("may not be reliable with beta API responses. Verification will be added when", "INFO")
        self.log("APIs reach general availability (GA) status.", "INFO")
        self.log("VERIFICATION RESULT: Deletion verification skipped for device {0} due to beta API limitations".format(device_identifier), "INFO")
...
def main():
    ...
    for config in ccc_wired_campus_automation.validated_config:
        ...
        if config_verify:
            ccc_wired_campus_automation.verify_diff_state_apply[state]().check_return_status()
