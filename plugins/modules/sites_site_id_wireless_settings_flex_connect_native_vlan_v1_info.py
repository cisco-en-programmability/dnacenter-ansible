...
DOCUMENTATION = r"""
---
module: sites_site_id_wireless_settings_flex_connect_native_vlan_v1_info
short_description: Information module for Sites Site Id Wireless Settings Flex Connect
  Native Vlan V1
description:
  - Get all Sites Site Id Wireless Settings Flex Connect Native Vlan V1.
  - >
    This API allows the user to get all Native VLAN Settings at the given site. The
    default value of the native VLAN
...
"""
EXAMPLES = r"""
- name: Get all Sites Site Id Wireless Settings Flex Connect Native Vlan V1
  cisco.dnac.sites_site_id_wireless_settings_flex_connect_native_vlan_v1_info:
    dnac_host: "{{dnac_host}}"
