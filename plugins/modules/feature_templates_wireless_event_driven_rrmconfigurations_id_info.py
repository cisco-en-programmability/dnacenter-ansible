...
DOCUMENTATION = r"""
---
module: feature_templates_wireless_event_driven_rrmconfigurations_id_info
short_description: Information module for Feature Templates
  Wireless Event Driven Rrmconfigurations Id
description:
  - Get Feature Templates Wireless Event Driven Rrmconfigurations
    Id by id.
...
EXAMPLES = r"""
---
- name: Get Feature Templates Wireless Event Driven
    Rrmconfigurations Id by id
  cisco.dnac.feature_templates_wireless_event_driven_rrmconfigurations_id_info:
    dnac_host: "{{dnac_host}}"
