...
DOCUMENTATION = r"""
---
module: backup_nfs_configurations_v1_info
short_description: Information module for Backup Nfs Configurations V1
description:
  - Get all Backup Nfs Configurations V1.
...
"""
EXAMPLES = r"""
- name: Get all Backup Nfs Configurations V1
  cisco.dnac.backup_nfs_configurations_v1_info:
    dnac_host: "{{dnac_host}}"
