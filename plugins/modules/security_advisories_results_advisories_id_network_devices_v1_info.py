...
short_description: Information module for Security Advisories Results Advisories Id Network Devices V1
description:
...
- name: Cisco DNA Center documentation for Compliance GetSecurityAdvisoryNetworkDevicesForTheSecurityAdvisoryV1
  description: Complete reference of the GetSecurityAdvisoryNetworkDevicesForTheSecurityAdvisoryV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!get-security-advisory-network-devices-for-the-security-advisory
notes:
  - SDK Method used are
    compliance.Compliance.get_security_advisory_network_devices_for_the_security_advisory_v1,

  - Paths used are
    get /dna/intent/api/v1/securityAdvisories/results/advisories/{id}/networkDevices,
