...
DOCUMENTATION = r"""
---
module: healthScoreDefinitions
short_description: Resource module for Healthscoredefinitions
description:
- Manage operation update of the resource Healthscoredefinitions.
...
EXAMPLES = r"""
- name: Update by id
  cisco.dnac.healthScoreDefinitions:
    dnac_host: "{{dnac_host}}"
