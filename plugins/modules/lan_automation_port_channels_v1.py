...
DOCUMENTATION = r"""
---
module: lan_automation_port_channels_v1
short_description: Resource module for Lan Automation Port Channels V1
description:
  - Manage operation create of the resource Lan Automation Port Channels V1.
  - >
    This API creates a Port Channel between two LAN Automation associated devices
    using the PAgP protocol, with a
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.lan_automation_port_channels_v1:
    dnac_host: "{{dnac_host}}"
