...
notes:
  - SDK Method used are compliance.Compliance.get_network_bug_devices_for_the_bug_v1,
  - Paths used are get /dna/intent/api/v1/networkBugs/results/bugs/{id}/networkDevices,
