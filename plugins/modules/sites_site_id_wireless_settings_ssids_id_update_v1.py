...
DOCUMENTATION = r"""
---
module: sites_site_id_wireless_settings_ssids_id_update_v1
short_description: Resource module for Sites Site Id Wireless Settings Ssids Id Update
  V1
description:
  - Manage operation create of the resource Sites Site Id Wireless Settings Ssids
    Id Update V1.
  - This API allows to either update SSID at global 'siteId' or override SSID at given
    non-global 'siteId'.
...
options:
  ...
  basicServiceSetMaxIdleEnable:
    ...
    type: bool
  cckmTsfTolerance:
    description: The default value is the Cckm Timestamp Tolerance (in milliseconds,
  ...
  isRadiusProfilingEnabled:
    description: Enable Radius Profiling. At least one AAA/PSN server is required
      to enable Radius Profiling on WLAN.
    type: bool
  ...
  sleepingClientTimeout:
    description: This refers to the amount of time, measured in minutes, before a
      sleeping (inactive) client is timed out of the network.
    type: int
  ssid:
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Wireless UpdateOrOverrideSSIDV1
    description: Complete reference of the UpdateOrOverrideSSIDV1 API.
    link: https://developer.cisco.com/docs/dna-center/#!update-or-override-ssid
notes:
  - SDK Method used are wireless.Wireless.update_or_overridessid_v1,
  - Paths used are post /dna/intent/api/v1/sites/{siteId}/wirelessSettings/ssids/{id}/update,
"""
EXAMPLES = r"""
- name: Create
  cisco.dnac.sites_site_id_wireless_settings_ssids_id_update_v1:
    dnac_host: "{{dnac_host}}"
