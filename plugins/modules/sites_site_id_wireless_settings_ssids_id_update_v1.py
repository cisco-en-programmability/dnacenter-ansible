...
short_description: Resource module for Sites Site Id Wireless Settings Ssids Id Update V1
description:
- Manage operation create of the resource Sites Site Id Wireless Settings Ssids Id Update V1.
...
options:
  ...
  isRadiusProfilingEnabled:
    description: Enable Radius Profiling. At least one AAA/PSN server is required to
      enable Radius Profiling on WLAN.
    type: bool
...
notes:
  - SDK Method used are
    wireless.Wireless.update_or_overridessid_v1,
