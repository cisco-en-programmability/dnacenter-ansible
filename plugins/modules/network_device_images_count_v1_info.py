...
DOCUMENTATION = r"""
---
module: network_device_images_count_v1_info
short_description: Information module for Network Device Images Count V1
description:
  - Get all Network Device Images Count V1.
...
"""
EXAMPLES = r"""
- name: Get all Network Device Images Count V1
  cisco.dnac.network_device_images_count_v1_info:
    dnac_host: "{{dnac_host}}"
