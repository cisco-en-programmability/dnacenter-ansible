...
DOCUMENTATION = r"""
---
module: field_notices_results_network_devices_network_device_id_notices_id_v1_info
short_description: Information module for Field Notices Results Network Devices Network Device Id Notices Id V1
description:
- Get Field Notices Results Network Devices Network Device Id Notices Id V1 by id.
...
- name: Cisco DNA Center documentation for Compliance GetFieldNoticeAffectingTheNetworkDeviceByDeviceIdAndNoticeIdV1
  description: Complete reference of the GetFieldNoticeAffectingTheNetworkDeviceByDeviceIdAndNoticeIdV1 API.
...
EXAMPLES = r"""
- name: Get Field Notices Results Network Devices Network Device Id Notices Id V1 by id
  cisco.dnac.field_notices_results_network_devices_network_device_id_notices_id_v1_info:
    dnac_host: "{{dnac_host}}"
