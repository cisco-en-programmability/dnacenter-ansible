...
options:
  ...
  payload:
    ...
    suboptions:
      associatedLayer3VirtualNetworkName:
        description: Name of the layer 3 virtual network associated with the layer 2
          virtual network. This field is provided to support requests related to virtual
          network anchoring. The layer 3 virtual network must have already been added
          to the fabric before association. This field must either be present in all
          payload elements or none.
        type: str
      fabricId:
      ...
      vlanId:
        description: ID of the VLAN of the layer 2 virtual network. Allowed VLAN range
          is 2-4093 except for reserved VLANs 1002-1005, and 2046. If deploying on a
          fabric zone, this vlanId must match the vlanId of the corresponding layer
          2 virtual network on the fabric site.
        type: int
      vlanName:
        description: Name of the VLAN of the layer 2 virtual network. Must contain only
...
notes:
  - SDK Method used are
    ...
    sda.Sda.delete_layer2_virtual_network_by_id_v1,
...
RETURN = r"""
dnac_response:
  This alias returns the output of sda_layer2_virtual_networks_v1.
"""
