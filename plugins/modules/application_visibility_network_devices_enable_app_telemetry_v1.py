...
short_description: Resource module for Application Visibility Network Devices Enable App Telemetry V1
description:
- Manage operation create of the resource Application Visibility Network Devices Enable App Telemetry V1.
- >
   This API can be used to enable application telemetry feature on multiple network devices. Request payload should
   include the list of network devices where application telemetry has to be enabled. For wireless controllers, it
