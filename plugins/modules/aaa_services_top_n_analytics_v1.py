...
DOCUMENTATION = r"""
---
module: aaa_services_top_n_analytics_v1
short_description: Resource module for Aaa Services Top N Analytics V1
description:
- Manage operation create of the resource Aaa Services Top N Analytics V1.
- >
...
- name: Cisco DNA Center documentation for Devices GetTopNAnalyticsDataOfAAAServicesForGivenSetOfComplexFiltersV1
  description: Complete reference of the GetTopNAnalyticsDataOfAAAServicesForGivenSetOfComplexFiltersV1 API.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.aaa_services_top_n_analytics_v1:
    dnac_host: "{{dnac_host}}"
