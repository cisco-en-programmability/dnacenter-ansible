...
short_description: Information module for Network Device Images Count Info
description:
  - This module represents an alias of the module network_device_images_count_v1_info
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Software Image Management (SWIM) CountOfNetworkDevicesForTheGivenStatusFiltersV1
    description: Complete reference of the CountOfNetworkDevicesForTheGivenStatusFiltersV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!count-of-network-devices-for-the-given-status-filters
notes:
  - SDK Method used are
    software_image_management_swim.SoftwareImageManagementSwim.count_of_network_devices_for_the_given_status_filters_v1,
  - Paths used are get /dna/intent/api/v1/networkDeviceImages/count,
  - It should be noted that this module is an alias of network_device_images_count_v1_info
"""
EXAMPLES = r"""
- name: Get all Network Device Images Count Info
