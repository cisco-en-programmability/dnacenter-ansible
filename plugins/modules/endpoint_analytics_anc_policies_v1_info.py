...
- name: Cisco DNA Center documentation for AI Endpoint Analytics GetANCPoliciesV1
  ...
  link: https://developer.cisco.com/docs/dna-center/#!get-anc-policies-v-1
notes:
  - SDK Method used are
...
EXAMPLES = r"""
- name: Get all Endpoint Analytics Anc Policies V1
  cisco.dnac.endpoint_analytics_anc_policies_v1_info:
    dnac_host: "{{dnac_host}}"
