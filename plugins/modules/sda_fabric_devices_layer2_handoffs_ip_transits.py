...
options:
  fabricId:
    ...
    type: str
  id:
    description: Id path parameter. ID of the layer 3 handoff with ip transit of a fabric device.
    type: str
  networkDeviceId:
  ...
  payload:
    ...
    suboptions:
      externalConnectivityIpPoolName:
        description: External connectivity ip pool will be used by Catalyst Center to allocate IP address for the connection
          between the border node and peer.
        type: str
      fabricId:
      ...
      interfaceName:
        ...
        type: str
      localIpAddress:
        description: Local ipv4 address for the selected virtual network. Enter the IP addresses and subnet mask in the CIDR
          notation (IP address/prefix-length). Not applicable if you have already provided an external connectivity ip pool
          name.
        type: str
      localIpv6Address:
        description: Local ipv6 address for the selected virtual network. Enter the IP addresses and subnet mask in the CIDR
          notation (IP address/prefix-length). Not applicable if you have already provided an external connectivity ip pool
          name.
        type: str
      networkDeviceId:
        ...
        type: str
      remoteIpAddress:
        description: Remote ipv4 address for the selected virtual network. Enter the IP addresses and subnet mask in the CIDR
          notation (IP address/prefix-length). Not applicable if you have already provided an external connectivity ip pool
          name.
        type: str
      remoteIpv6Address:
        description: Remote ipv6 address for the selected virtual network. Enter the IP addresses and subnet mask in the CIDR
          notation (IP address/prefix-length). Not applicable if you have already provided an external connectivity ip pool
          name.
        type: str
      tcpMssAdjustment:
        description: TCP maximum segment size (mss) value for the layer 3 handoff. Allowed range is 500-1440. TCP MSS Adjustment
          value is applicable for the TCP sessions over both IPv4 and IPv6.
        type: int
      transitNetworkId:
      ...
      virtualNetworkName:
        ...
        type: str
      vlanId:
        description: VLAN number for the Switch Virtual Interface (SVI) used to establish BGP peering with the external domain
          for the virtual network. Allowed VLAN range is 2-4094 except for reserved vlans (1, 1002-1005, 2046, 4094).
        type: int
    type: list
requirements:
  - dnacentersdk >= 2.11.0
