...
DOCUMENTATION = r"""
---
module: iot_network_devices_network_device_id_mrp_rings_count_v1_info
short_description: Information module for Iot Network Devices Network Device Id Mrp
  Rings Count V1
description:
  - Get all Iot Network Devices Network Device Id Mrp Rings Count V1.
  - >
    This API returns the count of MRP rings for the given fields - networkDeviceId
    Network device ID of the MRP ring
...
"""
EXAMPLES = r"""
- name: Get all Iot Network Devices Network Device Id Mrp Rings Count V1
  cisco.dnac.iot_network_devices_network_device_id_mrp_rings_count_v1_info:
    dnac_host: "{{dnac_host}}"
