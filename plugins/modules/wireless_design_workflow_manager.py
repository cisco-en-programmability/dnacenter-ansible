    ...
    suboptions:
      ssids:
        ...
        suboptions:
          ...
          wlan_profile_name:
            description:  
              - WLAN Profile Name.
              - This is an optional parameter. If not provided, an autogenerated profile name will be assigned using the "ssid_name".
              - The WLAN Profile Name will also be used as the Policy Profile Name.
              - Example - If the "ssid_name" is "entssid", the autogenerated WLAN Profile Name will be "entssid_profile".
            type: str          
          radio_policy: 
            description:
              - Configure radio policy settings.
            type: dict
            suboptions:
              radio_bands:
                description:  
                  - Specifies the Radio Bands.
                  - This parameter is optional and defaults to Triple band operation (2.4GHz, 5GHz, and 6GHz).
                  - 6GHz is applicable only for IOS-XE >= 17.7; for other devices/platforms, this will be ignored.
                  - Example - [2.4, 5], [2.4, 6], [5, 6], [2.4], [5], [6], [2.4, 5, 6].
                type: list
                elements: int
                default: [2.4, 5, 6]
              2_dot_4_ghz_band_policy:
                description:  
                  - Specifies the 2.4 GHz Band Policy.
              ...
              band_select:
                description:
                  - Set this parameter to True to enable Band Select, otherwise, set it to False.
                  - Band Select can be activated only when the "radio_bands" selected are one of the following
              ...
              6_ghz_client_steering:
                description:  
                  - Set this parameter to True to enable 6 GHz Client Steering, otherwise, set it to False.
          ...
          ssid_state: 
            description:
              - Configure the SSID state settings.
            type: dict
            suboptions:
              admin_status:
                description:  
                  - Set this parameter to True to enable Admin Status, otherwise, set it to False.
                type: bool 
                default: False
              broadcast_ssid:
                description:  
            ...
            suboptions:        
              l2_auth_type:
                description:  
                  ...
                  - Required parameters based on the L2 Authentication Type:
                    - "WPA2_ENTERPRISE":
          ...
          auth_key_management:
            description:  
              ...
              - WPA2_ENTERPRISE:
                 - When fast transition is ADAPTIVE/DISABLE, AKMs available for each RSN Cipher Suite encryption protocol:
                   - CCMP128 - CCKM/802.1X-SHA1/802.1X-SHA2
                   - GCMP128 - SUITE-B-1X
                   - CCMP256 - SUITE-B-192X
                   - GCMP256 - SUITE-B-192X
                 - When fast transition is ENABLE, AKMs available for each RSN Cipher Suite encryption protocol:
              ...
              - WPA3_PERSONAL: 
                ...
                - When fast transition is DISABLE, AKMs available for each RSN Cipher Suite encryption protocol:
              ...
              - WPA2_WPA3_PERSONAL: 
                ...
                - When fast transition is DISABLE, AKMs available for each RSN Cipher Suite encryption protocol:
                  ...
                  - GCMP256 - SAE-EXT-KEY
              - OPEN-SECURED:
                - AKMs available for each RSN Cipher Suite encryption protocol and allowed combinations:
                  - CCMP128 + OWE
                  - GCMP256 + OWE
              - OPEN:
          ...
          aaa:
            ...
            suboptions:
              ...
              accounting_servers_ip_address_list:
                description:
                  - List of Accounting server IP Addresses.
                type: list
              aaa_override:
                description:
          ...
          bss_transition_support:
            description:
              - Configure BSS Transition Support settings.
            type: dict
            suboptions:
      ...
      power_profiles:
        ...
        suboptions:
          ...
          rules:
            description:  
              - Sequential Ordered List of rules for Power Profile.
            type: list
            elements: dict
            suboptions:
              interface_type: 
              ...
              interface_id:
                description:
                  ...
                  - Valid "interface_id" based on the "interface_type":
              ...
              parameter_type:      
                description:
                  ...
                  - Valid "parameter_type" based on the "interface_type":
              ...
              parameter_value:      
                description:
                  ...
                  - Valid "parameter_value" based on the "interface_type":
        ...
        suboptions:
          ...
          security_settings:
            ...
            suboptions:
              ...
              report_interval:
                description:
                  - Report interval for rogue detection. Value should be in the range of 10 to 300.
                type: int
                default: 10
              pmf_denial:
                description:
          ...
          mesh_settings:
            ...
            suboptions:
              range:
                description:
                  - Range of the mesh network. Value should be between 150 and 132000.
                type: int
                default: 12000
              ...
              bridge_group_name:
                description:
                  ...
                  - The value should be between 0 and 10 characters.
                type: str
                default: "default"
          power_settings:
            description:
        ...
        suboptions:
          radio_frequency_profile_name:
            description:
              ...
              - Required for profile creation and management.
            type: str
            required: True
          default_rf_profile:
            description:
          ...
          radio_bands_5ghz_settings:
            description:
              - Settings specific to the 5 GHz radio band.
            ...
            suboptions:
              ...
              channel_width:
                description:
                  - Channel width for the 5 GHz band.
                  - Defines available bandwidth.
                type: str
                default: "best"
              ...
              zero_wait_dfs:
                description:
                  - Enable or disable zero wait DFS.
                  - DFS allows dynamic frequency selection.
                type: bool
                default: false
              dca_channels_list:
                description:
              ...
              flexible_radio_assignment:
                ...
                suboptions:
                  client_aware:
                    description:
                      - Enable or disable client awareness.
                    type: bool
                    default: false
                  client_select:
                    description:
              ...
              spatial_resuse:
                description:
                  - Spatial reuse settings for the 5 GHz band.
                  - Includes non-SRG and SRG OBSS PD settings.
                type: dict
                suboptions:
                  non_srg_obss_pd:
          ...
          radio_bands_6ghz_settings:
            ...
            suboptions:
              ...
              dca_channels_list:
                ...
                choices: [1, 5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 45, 49, 53, 57, 61, 65, 69, 73, 77, 81, 85, 89, 93, 97, 101, 
              ...
              flexible_radio_assignment:
                description:
                  - Configure Flexible Radio Assignment 6 GHz Properties.
                type: dict
                suboptions:
                  client_reset_count:
                    description:
              ...
              suboptions:
                dot_11ax_parameters:
                  ...
                  suboptions:
                    ofdma_downlink:
                      description:
                        - Set "ofdma_downlink" to true to activate OFDMA Downlink.
                      type: bool
                      default: false
                    ofdma_uplink:
                      description:
                        - Set "ofdma_uplink" to true to activate OFDMA Uplink.
                      type: bool
                      default: false
                    mu_mimo_downlink:
                      description:
                        - Set "mu_mimo_downlink" to true to activate MU-MIMO Uplink.
                      type: bool
                      default: true
                    mu_mimo_uplink:
                      description:
                        - Set "mu_mimo_uplink" to true to activate MU-MIMO Downlink.
                      type: bool
                      default: true
                dot_11be_parameters:
                  description:
                  ...
                  suboptions:
                    ...
                    ofdma_multi_ru:
                      description:
                        - Set "ofdma_multi_ru" to true to activate OFDMA Multi-RU.
                      type: bool
                      default: false
              target_waketime:
                description:
                  - Set "target_waketime" to true to activate Target Wake Time.
                type: bool
                default: false
              twt_broadcast_support:
                description:
                  - Set "twt_broadcast_support" to true to activate TWT Broadcast Support.
                type: bool
                default: false
              spatial_resuse:
                description:
                ...
                suboptions:
                  non_srg_obss_pd:
                    description:
                      - Set "non_srg_obss_pd" to true to Enable non-SRG OBSS PD or set to false to disable non-SRG OBSS PD.
                    type: bool
                    default: false
                  non_srg_obss_pd_max_threshold:
                    description:
                  ...
                  srg_obss_pd:
                    description:
                      - Set "srg_obss_pd" to true to Enable Enable or set to false to disable SRG OBSS PD.
                    type: bool
                    default: false
                  srg_obss_pd_min_threshold:
                    description:
        ...
        suboptions:
          ...
          mobility_anchors:
            ...
            suboptions:
              ...
              device_mac_address:
                description:
                  - Peer Device mobility MAC address.
                type: str
              device_type:
                description:
                  - Indicates whether the peer device mobility belongs to the AireOS or IOS-XE family.
                type: str
...
- name: Add SSIDs, Interfaces, Power Profiles, AP Profiles, RF Profiles, Anchor Groups
  cisco.dnac.wireless_design_workflow_manager:
    dnac_host: "{{dnac_host}}"
    dnac_username: "{{dnac_username}}"
    dnac_password: "{{dnac_password}}"
...
- name: Update SSIDs, Interfaces, Power Profiles, AP Profiles, RF Profiles, Anchor Groups
  cisco.dnac.wireless_design_workflow_manager:
    dnac_host: "{{dnac_host}}"
    dnac_username: "{{dnac_username}}"
    dnac_password: "{{dnac_password}}"
...
- name: Delete SSIDs, Interfaces, Power Profiles, AP Profiles, RF Profiles, Anchor Groups
  cisco.dnac.wireless_design_workflow_manager:
    dnac_host: "{{dnac_host}}"
    dnac_username: "{{dnac_username}}"
    dnac_password: "{{dnac_password}}"
