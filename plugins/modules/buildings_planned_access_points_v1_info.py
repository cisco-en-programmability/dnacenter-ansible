...
DOCUMENTATION = r"""
---
module: buildings_planned_access_points_v1_info
short_description: Information module for Buildings Planned Access Points V1
description:
  - Get all Buildings Planned Access Points V1.
...
notes:
  - SDK Method used are devices.Devices.get_planned_access_points_for_building_v1,
...
- name: Get all Buildings Planned Access Points V1
  cisco.dnac.buildings_planned_access_points_v1_info:
    dnac_host: "{{dnac_host}}"
