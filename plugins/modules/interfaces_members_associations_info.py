...
DOCUMENTATION = r"""
---
module: interfaces_membersAssociations_info
short_description: Information module for Interfaces Membersassociations
description:
- Get all Interfaces Membersassociations.
- >
...
notes:
  ...
  - Paths used are
    get /intent/api/v1/tags/interfaces/membersAssociations,

"""

EXAMPLES = r"""
- name: Get all Interfaces Membersassociations
  cisco.dnac.interfaces_membersAssociations_info:
    dnac_host: "{{dnac_host}}"
