...
DOCUMENTATION = r"""
---
module: topology_layer_3_v1_info
short_description: Information module for Topology Layer 3 V1
description:
  - Get Topology Layer 3 V1 by id.
...
"""
EXAMPLES = r"""
- name: Get Topology Layer 3 V1 by id
  cisco.dnac.topology_layer_3_v1_info:
    dnac_host: "{{dnac_host}}"
