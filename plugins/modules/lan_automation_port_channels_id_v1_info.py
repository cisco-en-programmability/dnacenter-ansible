...
DOCUMENTATION = r"""
---
module: lan_automation_port_channels_id_v1_info
short_description: Information module for Lan Automation Port Channels Id V1
description:
  - Get Lan Automation Port Channels Id V1 by id.
...
"""
EXAMPLES = r"""
- name: Get Lan Automation Port Channels Id V1 by id
  cisco.dnac.lan_automation_port_channels_id_v1_info:
    dnac_host: "{{dnac_host}}"
