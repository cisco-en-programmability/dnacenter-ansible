...
DOCUMENTATION = r"""
---
module: sda_anycast_gateways_v1_info
short_description: Information module for Sda Anycast Gateways V1
description:
  - Get all Sda Anycast Gateways V1.
...
notes:
  - SDK Method used are sda.Sda.get_anycast_gateways_v1,
  - Paths used are get /dna/intent/api/v1/sda/anycastGateways,
"""
EXAMPLES = r"""
- name: Get all Sda Anycast Gateways V1
  cisco.dnac.sda_anycast_gateways_v1_info:
    dnac_host: "{{dnac_host}}"
