...
options:
  ...
  serverIp:
    description:
      - >
        ServerIp query parameter. IP Address of the AAA Server. This parameter supports wildcard (`*`) character
  ...
  deviceSiteHierarchy:
    description:
      - >
        DeviceSiteHierarchy query parameter. The full hierarchical breakdown of the site tree starting from
        Global site name and ending with the specific site name. The Root site is named "Global" (Ex.
        ...
        Hierarchy=Global/AreaName2/BuildingName2/FloorName2` (multiple siteHierarchies requested).
    type: str
