...
DOCUMENTATION = r"""
---
module: wireless_settings_ap_profiles_id
short_description: Resource module for Wireless Settings Ap Profiles Id
description:
  - This module represents an alias of the module wireless_settings_ap_profiles_id_v1
...
options:
  ...
  calendarPowerProfiles:
    description: Wireless Settings Ap Profiles Id's calendarPowerProfiles.
    suboptions:
      duration:
        description: Wireless Settings Ap Profiles Id's duration.
        suboptions:
          schedulerDate:
...
notes:
  ...
  - It should be noted that this module is an alias of wireless_settings_ap_profiles_id_v1
"""
EXAMPLES = r"""
- name: Delete by id
