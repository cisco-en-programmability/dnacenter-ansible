...
description:
  - Manage operations update and delete of the resource
    Wireless Settings Ap Profiles Id.
  - This API allows the user to delete an AP Profile
    by specifying the AP Profile ID.
...
options:
  ...
  calendarPowerProfiles:
    description: Wireless Settings Ap Profiles Id's
      calendarPowerProfiles.
    suboptions:
      duration:
        description: Wireless Settings Ap Profiles Id's
    ...
    suboptions:
      ...
      rapDownlinkBackhaul:
        description: Type of downlink backhaul used.
          Available values 5 GHz, 2.4 GHz.
        type: str
    type: dict
  pmfDenialEnabled:
