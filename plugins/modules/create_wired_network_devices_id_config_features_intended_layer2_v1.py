...
DOCUMENTATION = r"""
---
module: create_wired_network_devices_id_config_features_intended_layer2_v1
short_description: Resource module for Create Wired Network Devices Id Config Features
  Intended Layer2 V1
description:
  - Manage operation create of the resource Create Wired Network Devices Id Config
    Features Intended Layer2 V1.
  - >
    This API creates configurations for the intended features on a wired device, if
    none have been added earlier. Only
    the feature configurations to be changed need to be added to the intended features.
    When the intended features are
    deployed to a device using the API /intent/api/v1/networkDevices/{id}/configFeatures/intended/deploy,
    they are
    applied on top of the existing configurations on the device. Any existing configurations
    on the device which are
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.create_wired_network_devices_id_config_features_intended_layer2_v1:
    dnac_host: "{{dnac_host}}"
