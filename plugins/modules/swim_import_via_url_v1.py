...
DOCUMENTATION = r"""
---
module: swim_import_via_url_v1
short_description: Resource module for Swim Import Via Url V1
description:
  - Manage operation create of the resource Swim Import Via Url V1.
  - >
    Fetches a software image from remote file system using URL for HTTP/FTP and uploads
    to DNA Center. Supported image
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.swim_import_via_url_v1:
    dnac_host: "{{dnac_host}}"
