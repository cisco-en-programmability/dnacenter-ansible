...
DOCUMENTATION = r"""
---
module: sda_port_channels_v1_info
short_description: Information module for Sda Port Channels V1
description:
  - Get all Sda Port Channels V1.
...
"""
EXAMPLES = r"""
- name: Get all Sda Port Channels V1
  cisco.dnac.sda_port_channels_v1_info:
    dnac_host: "{{dnac_host}}"
