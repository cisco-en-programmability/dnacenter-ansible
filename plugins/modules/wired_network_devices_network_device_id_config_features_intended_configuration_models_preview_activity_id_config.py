...
description:
  - Manage operation create of the resource Wired Network
    Devices Network Device Id Config Features Intended
    Configuration Models Preview Activity Id Config.
    - > Generates the device config for the configuration
    model. This API is 'Step 2' in the following workflow
...
seealso:
  - name: Cisco DNA Center documentation for Wired GenerateTheDeviceConfigForTheConfigurationModel
    description: Complete reference of the GenerateTheDeviceConfigForTheConfigurationModel
      API.
