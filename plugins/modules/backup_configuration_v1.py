...
DOCUMENTATION = r"""
---
module: backup_configuration_v1
short_description: Resource module for Backup Configuration V1
description:
  - Manage operation create of the resource Backup Configuration V1.
  - >
    This api is used to create or update backup configuration. Obtain the `mountPath`
    value from the mountPoint
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.backup_configuration_v1:
    dnac_host: "{{dnac_host}}"
