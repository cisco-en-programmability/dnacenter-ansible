...
description:
  - This module represents an alias of the module iot_non_fabric_rep_rings_v1
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Industrial Configuration ConfigureAREPRingOnNONFABRICDeploymentV1
    description: Complete reference of the ConfigureAREPRingOnNONFABRICDeploymentV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!configure-arep-ring-on-nonfabric-deployment
notes:
  - SDK Method used are
    industrial_configuration.IndustrialConfiguration.configure_a_r_e_p_ring_on_n_o_n_f_a_b_r_i_c_deployment_v1,
  - Paths used are post /dna/intent/api/v1/iot/nonFabric/repRings,
  - It should be noted that this module is an alias of iot_non_fabric_rep_rings_v1
"""
EXAMPLES = r"""
- name: Create
