...
short_description: Information module for Wireless Controllers Anchor Managed Ap Locations
  V1
description:
  - Get all Wireless Controllers Anchor Managed Ap Locations V1.
  - Retrieves all the details of Anchor Managed AP locations associated with the specific
    Wireless Controller.
...
seealso:
  - name: Cisco DNA Center documentation for Wireless GetAnchorManagedAPLocationsForSpecificWirelessControllerV1
    description: Complete reference of the GetAnchorManagedAPLocationsForSpecificWirelessControllerV1
      API.
    link:
...
notes:
  ...
  - Paths used are get
    /dna/intent/api/v1/wirelessControllers/{networkDeviceId}/anchorManagedApLocations,
"""
EXAMPLES = r"""
