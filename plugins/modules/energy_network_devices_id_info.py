...
short_description: Information module for Energy Network Devices Id Info
description:
  - This module represents an alias of the module energy_network_devices_id_v1_info
...
options:
  ...
  attribute:
    description:
      - >
        Attribute query parameter. List of attributes. Please refer to `NetworkDeviceEnergyAttribute`
        for supported
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Devices GetDeviceEnergyByIDV1
    description: Complete reference of the GetDeviceEnergyByIDV1 API.
    link: https://developer.cisco.com/docs/dna-center/#!get-device-energy-by-id
notes:
  - SDK Method used are devices.Devices.get_device_energy_by_id_v1,
  - Paths used are get /dna/data/api/v1/energy/networkDevices/{id},
  - It should be noted that this module is an alias of energy_network_devices_id_v1_info
"""
EXAMPLES = r"""
- name: Get Energy Network Devices Id Info by id
