...
DOCUMENTATION = r"""
---
module: provisioningSettings
short_description: Resource module for Provisioningsettings
description:
- Manage operation update of the resource Provisioningsettings.
...
EXAMPLES = r"""
- name: Update all
  cisco.dnac.provisioningSettings:
    dnac_host: "{{dnac_host}}"
