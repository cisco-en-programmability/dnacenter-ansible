...
short_description: Information module for Ipam Global Ip Address Pools Global Ip Address Pool Id Subpools Count Info
description:
...
EXAMPLES = r"""
- name: Get all Ipam Global Ip Address Pools Global Ip Address Pool Id Subpools Count Info
