...
- >
   ...
   further preview-approve APIs are applied. This API is the first step in the preview-approve workflow, which
   consists of several APIs. Skipping any API in the process is not recommended for a complete preview-approve use
   case. For detailed information about the usage of the API, please refer to the Open API specification document -
...
- name: Cisco DNA Center documentation for Sensors CreatesAnICAPConfigurationIntentForPreviewApproveV1
  description: Complete reference of the CreatesAnICAPConfigurationIntentForPreviewApproveV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!creates-an-icap-configuration-intent-for-preview-approve
notes:
  - SDK Method used are
    sensors.Sensors.creates_an_i_cap_configuration_intent_for_preview_approve_v1,
