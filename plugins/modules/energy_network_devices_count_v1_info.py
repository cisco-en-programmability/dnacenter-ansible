...
DOCUMENTATION = r"""
---
module: energy_network_devices_count_v1_info
short_description: Information module for Energy Network Devices Count V1
description:
  - Get all Energy Network Devices Count V1.
  - >
    Retrieves the total count of network devices that provide energy data, filtered
...
"""
EXAMPLES = r"""
- name: Get all Energy Network Devices Count V1
  cisco.dnac.energy_network_devices_count_v1_info:
    dnac_host: "{{dnac_host}}"
