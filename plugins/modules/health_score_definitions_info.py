...
DOCUMENTATION = r"""
---
module: healthScoreDefinitions_info
short_description: Information module for Healthscoredefinitions
description:
- Get all Healthscoredefinitions.
- Get Healthscoredefinitions by id.
- Get all health score defintions.
- >
   Get health score defintion for the given id. Definition includes all properties from HealthScoreDefinition schema
...
EXAMPLES = r"""
- name: Get all Healthscoredefinitions
  cisco.dnac.healthScoreDefinitions_info:
    dnac_host: "{{dnac_host}}"
...
- name: Get Healthscoredefinitions by id
  cisco.dnac.healthScoreDefinitions_info:
    dnac_host: "{{dnac_host}}"
    dnac_username: "{{dnac_username}}"
    dnac_password: "{{dnac_password}}"
