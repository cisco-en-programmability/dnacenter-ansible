...
DOCUMENTATION = r"""
---
module: compliance_device_create_v1
short_description: Resource module for Compliance Device Create V1
description:
  - Manage operation create of the resource Compliance Device Create V1.
...
EXAMPLES = r"""
- name: Create
  cisco.dnac.compliance_device_create_v1:
    dnac_host: "{{dnac_host}}"
