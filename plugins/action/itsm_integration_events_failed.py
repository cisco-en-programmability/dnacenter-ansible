...
class ItsmIntegrationEventsFailed(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params['instance_id'] = self.new_object.get(
            'instanceId') or self.new_object.get('instance_id')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="itsm",
                function="get_failed_itsm_events",
    ...
    def create(self):
        result = self.dnac.exec(
            family="itsm",
            function="retry_integration_events",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ItsmIntegrationEventsFailed(self._task.args, dnac)
