...
class SdaProvisionDevicesV1(object):
    ...
    def get_object_by_name(self, name, is_absent=False):
        ...
        try:
            items = self.dnac.exec(
                family="sda",
                function="get_provisioned_devices_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="re_provision_devices_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="delete_provisioned_device_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaProvisionDevicesV1(self._task.args, dnac)
