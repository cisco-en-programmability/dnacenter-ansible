...
class SiteKpiSummariesTrendAnalyticsV1(object):
    ...
    def create_params(self):
        ...
        new_object_params['trendInterval'] = self.new_object.get('trendInterval')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="sites",
                function="get_site_analytics_trend_data_for_the_given_task_id_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sites",
            function="submit_request_for_site_analytics_trend_data_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteKpiSummariesTrendAnalyticsV1(self._task.args, dnac)
