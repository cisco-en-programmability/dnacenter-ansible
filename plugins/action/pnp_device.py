...
class PnpDevice(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['state'] = self.new_object.get('state')
        new_object_params['onb_state'] = self.new_object.get('onb_state')
        new_object_params['cm_state'] = self.new_object.get('cm_state')
        ...
        new_object_params['workflow_id'] = self.new_object.get('workflow_id')
        new_object_params['project_name'] = self.new_object.get('project_name')
        new_object_params['workflow_name'] = self.new_object.get('workflow_name')
        new_object_params['smart_account_id'] = self.new_object.get('smart_account_id')
        new_object_params['virtual_account_id'] = self.new_object.get('virtual_account_id')
        new_object_params['last_contact'] = self.new_object.get('last_contact')
        new_object_params['mac_address'] = self.new_object.get('mac_address')
        new_object_params['hostname'] = self.new_object.get('hostname')
        new_object_params['site_name'] = self.new_object.get('site_name')
