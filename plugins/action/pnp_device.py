...
class PnpDevice(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['cm_state'] = self.new_object.get('cmState') or self.new_object.get('cm_state')
        ...
        new_object_params['project_name'] = self.new_object.get('projectName') or self.new_object.get('project_name')
