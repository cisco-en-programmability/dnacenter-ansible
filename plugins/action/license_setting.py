...
argument_spec.update(dict(
    ...
    defaultSmartAccountId=dict(type="str"),
    autoRegistrationVirtualAccountId=dict(type="str"),
))
...
class LicenseSetting(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="licenses",
                function="retrieve_license_setting",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="licenses",
            function="update_license_setting",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = LicenseSetting(self._task.args, dnac)
