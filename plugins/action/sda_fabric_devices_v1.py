...
class SdaFabricDevicesV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['device_roles'] = self.new_object.get(
            'deviceRoles') or self.new_object.get('device_roles')
    ...
    def create(self):
        result = self.dnac.exec(
            family="sda",
            function="add_fabric_devices_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="update_fabric_devices_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="delete_fabric_device_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaFabricDevicesV1(self._task.args, dnac)
