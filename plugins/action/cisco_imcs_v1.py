...
class CiscoImcsV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="cisco_i_m_c",
                function="retrieves_cisco_i_m_c_configurations_for_catalyst_center_nodes_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="cisco_i_m_c",
            function="adds_cisco_i_m_c_configuration_to_a_catalyst_center_node_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CiscoImcsV1(self._task.args, dnac)
