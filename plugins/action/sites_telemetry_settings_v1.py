...
class SitesTelemetrySettingsV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="retrieve_telemetry_settings_for_a_site_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="network_settings",
            function="set_telemetry_settings_for_a_site_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SitesTelemetrySettingsV1(self._task.args, dnac)
