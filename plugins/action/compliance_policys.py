...
class CompliancePolicys(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="compliance",
                function="retrieve_the_policies",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.dnac.exec(
                family="compliance",
                function="retrieve_a_specific_policy",
                params={"id": id},
            )
            if isinstance(items, dict):
                if "response" in items:
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="compliance",
            function="update_an_existing_policy",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="compliance",
            function="delete_a_specific_policy",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CompliancePolicys(self._task.args, dnac)
