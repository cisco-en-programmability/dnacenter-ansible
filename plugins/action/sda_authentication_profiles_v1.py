...
class SdaAuthenticationProfilesV1(object):
    ...
    def get_object_by_name(self, name, is_absent=False):
        ...
        try:
            items = self.dnac.exec(
                family="sda",
                function="get_authentication_profiles_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="update_authentication_profile_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaAuthenticationProfilesV1(self._task.args, dnac)
