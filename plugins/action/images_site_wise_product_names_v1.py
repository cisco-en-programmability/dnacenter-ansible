...
required_if = [
    ...
    ("state", "absent", ["imageId", "productNameOrdinal"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class ImagesSiteWiseProductNamesV1(object):
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(
            productNameOrdinal=params.get("productNameOrdinal"),
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['product_name'] = self.new_object.get(
            'productName') or self.new_object.get('product_name')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="retrieves_network_device_product_names_assigned_to_a_software_image_v1",
    ...
    def exists(self):
        ...
        name = name or self.new_object.get("product_name_ordinal")
        if o_id:
    ...
    def create(self):
        result = self.dnac.exec(
            family="software_image_management_swim",
            function="assign_network_device_product_name_to_the_given_software_image_v1",
    ...
    def update(self):
        ...
        if not name:
            ...
            if prev_obj_id:
                ...
                name_ = name_ or prev_obj_id.get("productNameOrdinal")
            if name_:
                self.new_object.update(dict(product_name_ordinal=name_))
        result = self.dnac.exec(
            family="software_image_management_swim",
            function="update_the_list_of_sites_for_the_network_device_product_name_assigned_to_the_software_image_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="software_image_management_swim",
            function="unassign_network_device_product_name_from_the_given_software_image_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ImagesSiteWiseProductNamesV1(self._task.args, dnac)
