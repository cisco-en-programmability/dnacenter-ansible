...
class SdaTransitNetworksV1(object):
    ...
    def get_object_by_name(self, name, is_absent=False):
        ...
        try:
            items = self.dnac.exec(
                family="sda",
                function="get_transit_networks_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sda",
            function="add_transit_networks_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="update_transit_networks_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaTransitNetworksV1(self._task.args, dnac)
