...
class WirelessProfilesV1(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.dnac.exec(
                family="wireless",
                function="get_wireless_profile_by_id_v1",
                params={"id": id}
            )
            if isinstance(items, dict):
                if 'response' in items:
    ...
    def create(self):
        result = self.dnac.exec(
            family="wireless",
            function="create_wireless_profile_connectivity_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="update_wireless_profile_connectivity_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="delete_wireless_profile_connectivity_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessProfilesV1(self._task.args, dnac)
