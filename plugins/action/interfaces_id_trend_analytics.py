...
argument_spec.update(dict(
    ...
    trendIntervalInMinutes=dict(type="int"),
    attributes=dict(type="list"),
    filters=dict(type="list"),
    aggregateAttributes=dict(type="list"),
    timestampOrder=dict(type="str"),
    id=dict(type="str"),
))
...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        new_object = dict(
            ...
            trendIntervalInMinutes=params.get("trendIntervalInMinutes"),
            attributes=params.get("attributes"),
            filters=params.get("filters"),
            aggregateAttributes=params.get("aggregateAttributes"),
            timestampOrder=params.get("timestampOrder"),
            id=params.get("id"),
        )
        return new_object
