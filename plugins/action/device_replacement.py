...
class DeviceReplacement(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params['faulty_device_name'] = self.new_object.get('faulty_device_name')
        new_object_params['faulty_device_platform'] = self.new_object.get('faulty_device_platform')
        new_object_params['replacement_device_platform'] = self.new_object.get('replacement_device_platform')
        new_object_params['faulty_device_serial_number'] = self.new_object.get('faulty_device_serial_number')
        new_object_params['replacement_device_serial_number'] = self.new_object.get('replacement_device_serial_number')
        new_object_params['replacement_status'] = self.new_object.get('replacement_status')
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DeviceReplacement(self._task.args, dnac)
