...
class SdaLayer2VirtualNetworksV1(object):
    ...
    def get_object_by_name(self, name, is_absent=False):
        ...
        try:
            items = self.dnac.exec(
                family="sda",
                function="get_layer2_virtual_networks_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sda",
            function="add_layer2_virtual_networks_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="update_layer2_virtual_networks_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="delete_layer2_virtual_network_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaLayer2VirtualNetworksV1(self._task.args, dnac)
