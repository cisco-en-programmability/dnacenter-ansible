...
class LanAutomationPortChannelsV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params['device1_management_ipaddress'] = self.new_object.get('device1ManagementIPAddress') or \
            self.new_object.get('device1_management_ipaddress')
        new_object_params['device1_uuid'] = self.new_object.get('device1Uuid') or \
            self.new_object.get('device1_uuid')
        new_object_params['device2_management_ipaddress'] = self.new_object.get('device2ManagementIPAddress') or \
            self.new_object.get('device2_management_ipaddress')
        new_object_params['device2_uuid'] = self.new_object.get('device2Uuid') or \
            self.new_object.get('device2_uuid')
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = LanAutomationPortChannelsV1(self._task.args, dnac)
