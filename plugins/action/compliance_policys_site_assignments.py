...
class CompliancePolicysSiteAssignments(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="compliance",
                function="retrieve_site_assignments_for_policy",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="compliance",
            function="set_site_assignments_for_policy",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CompliancePolicysSiteAssignments(self._task.args, dnac)
