...
class WirelessSettingsPowerProfilesIdV1(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.dnac.exec(
                family="wireless",
                function="get_power_profile_by_id_v1",
                params={"id": id}
            )
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="update_power_profile_by_id_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="delete_power_profile_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsPowerProfilesIdV1(self._task.args, dnac)
