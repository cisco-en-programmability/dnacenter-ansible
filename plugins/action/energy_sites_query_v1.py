...
class EnergySitesQueryV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="sites",
                function="query_sites_energy_for_the_given_task_id_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sites",
            function="submit_request_to_query_sites_energy_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = EnergySitesQueryV1(self._task.args, dnac)
