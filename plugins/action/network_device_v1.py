...
class NetworkDeviceV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['management_ip_address'] = self.new_object.get(
            'managementIpAddress') or self.new_object.get('management_ip_address')
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="devices",
            function="delete_device_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDeviceV1(self._task.args, dnac)
