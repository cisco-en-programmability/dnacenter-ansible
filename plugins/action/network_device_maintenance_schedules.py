...
class NetworkDeviceMaintenanceSchedules(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params['network_device_ids'] = self.new_object.get('networkDeviceIds') or \
            self.new_object.get('network_device_ids')
    ...
    def create_params(self):
        ...
        new_object_params['maintenanceSchedule'] = self.new_object.get('maintenanceSchedule')
    ...
    def create(self):
        result = self.dnac.exec(
            family="devices",
            function="create_maintenance_schedule_for_network_devices",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDeviceMaintenanceSchedules(self._task.args, dnac)
