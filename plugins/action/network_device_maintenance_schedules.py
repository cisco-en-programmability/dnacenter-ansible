...
class NetworkDeviceMaintenanceSchedules(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["network_device_ids"] = self.new_object.get(
            "networkDeviceIds"
        ) or self.new_object.get("network_device_ids")
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="devices",
            function="updates_the_maintenance_schedule_information",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="devices",
            function="delete_maintenance_schedule",
