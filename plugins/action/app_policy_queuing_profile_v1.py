...
class AppPolicyQueuingProfileV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="get_application_policy_queuing_profile_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="application_policy",
            function="create_application_policy_queuing_profile_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="application_policy",
            function="update_application_policy_queuing_profile_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="application_policy",
            function="delete_application_policy_queuing_profile_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = AppPolicyQueuingProfileV1(self._task.args, dnac)
