...
class SdaProvisionDeviceV1(object):
    ...
    def create(self):
        result = self.dnac.exec(
            family="sda",
            function="provision_wired_device_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="re_provision_wired_device_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="delete_provisioned_wired_device_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaProvisionDeviceV1(self._task.args, dnac)
