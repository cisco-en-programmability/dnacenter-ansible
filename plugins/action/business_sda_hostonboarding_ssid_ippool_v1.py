...
class BusinessSdaHostonboardingSsidIppoolV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="get_ssid_to_ip_pool_mapping_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="fabric_wireless",
            function="add_ssid_to_ip_pool_mapping_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="fabric_wireless",
            function="update_ssid_to_ip_pool_mapping_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = BusinessSdaHostonboardingSsidIppoolV1(self._task.args, dnac)
