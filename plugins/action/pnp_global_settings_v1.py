...
class PnpGlobalSettingsV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="get_pnp_global_settings_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="device_onboarding_pnp",
            function="update_pnp_global_settings_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = PnpGlobalSettingsV1(self._task.args, dnac)
