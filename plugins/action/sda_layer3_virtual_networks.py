...
class SdaLayer3VirtualNetworks(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['virtual_network_name'] = self.new_object.get(
            'virtualNetworkName') or self.new_object.get('virtual_network_name')
        new_object_params['fabric_id'] = self.new_object.get('fabricId') or \
            self.new_object.get('fabric_id')
        new_object_params['anchored_site_id'] = self.new_object.get(
            'anchoredSiteId') or self.new_object.get('anchored_site_id')
    ...
    def create(self):
        result = self.dnac.exec(
            family="sda",
            function="add_layer3_virtual_networks",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="update_layer3_virtual_networks",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="delete_layer3_virtual_networks",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaLayer3VirtualNetworks(self._task.args, dnac)
