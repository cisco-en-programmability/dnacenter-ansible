...
class SiteKpiSummariesTopNAnalytics(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="sites",
                function="get_top_n_entities_related_to_site_analytics_for_the_given_task_id",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sites",
            function="submit_request_for_top_n_entities_related_to_site_analytics",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteKpiSummariesTopNAnalytics(self._task.args, dnac)
