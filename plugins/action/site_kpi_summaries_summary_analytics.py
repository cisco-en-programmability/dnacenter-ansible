...
class SiteKpiSummariesSummaryAnalytics(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="sites",
                function="get_site_analytics_summary_data_for_the_given_task_id",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sites",
            function="submit_request_for_site_analytics_summary_data",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteKpiSummariesSummaryAnalytics(self._task.args, dnac)
