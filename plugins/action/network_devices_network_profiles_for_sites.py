...
class NetworkDevicesNetworkProfilesForSites(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="site_design",
                function="retrieves_the_list_of_network_profiles_for_sites",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.dnac.exec(
                family="site_design",
                function="retrieve_a_network_profile_for_sites_by_id",
                params={"id": id}
            )
            if isinstance(items, dict):
                if 'response' in items:
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDevicesNetworkProfilesForSites(self._task.args, dnac)
