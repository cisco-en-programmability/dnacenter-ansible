...
class WirelessProfileV1(object):
    ...
    def create_params(self):
        new_object_params = {}
        new_object_params['profileDetails'] = self.new_object.get(
            'profileDetails')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="wireless",
                function="get_wireless_profile_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="wireless",
            function="create_wireless_profile_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="update_wireless_profile_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="delete_wireless_profile_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessProfileV1(self._task.args, dnac)
