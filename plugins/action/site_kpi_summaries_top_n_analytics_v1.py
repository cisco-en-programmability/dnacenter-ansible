...
class SiteKpiSummariesTopNAnalyticsV1(object):
    ...
    def create_params(self):
        ...
        new_object_params['topN'] = self.new_object.get('topN')
        new_object_params['groupBy'] = self.new_object.get('groupBy')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="sites",
                function="get_top_n_entities_related_to_site_analytics_for_the_given_task_id_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sites",
            function="submit_request_for_top_n_entities_related_to_site_analytics_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteKpiSummariesTopNAnalyticsV1(self._task.args, dnac)
