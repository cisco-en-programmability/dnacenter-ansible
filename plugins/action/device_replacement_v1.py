...
class DeviceReplacementV1(object):
    ...
    def create(self):
        result = self.dnac.exec(
            family="device_replacement",
            function="mark_device_for_replacement_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="device_replacement",
            function="unmark_device_for_replacement_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DeviceReplacementV1(self._task.args, dnac)
