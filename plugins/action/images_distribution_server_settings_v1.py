...
class ImagesDistributionServerSettingsV1(object):
    ...
    def create_params(self):
        new_object_params = {}
        new_object_params['serverAddress'] = self.new_object.get('serverAddress')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="retrieve_image_distribution_servers_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="software_image_management_swim",
            function="add_image_distribution_server_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ImagesDistributionServerSettingsV1(self._task.args, dnac)
