...
class NetworkDeviceImagesValidationsV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params['product_series_ordinal'] = self.new_object.get('productSeriesOrdinal') or \
            self.new_object.get('product_series_ordinal')
        new_object_params['operation_type'] = self.new_object.get('operationType') or \
            self.new_object.get('operation_type')
    ...
    def create_params(self):
        ...
        new_object_params['type'] = self.new_object.get('type')
        new_object_params['operationType'] = self.new_object.get('operationType')
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDeviceImagesValidationsV1(self._task.args, dnac)
