...
class DiscoveryV1(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.dnac.exec(
                family="discovery",
                function="get_discovery_by_id_v1",
                params={"id": id}
            )
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="discovery",
            function="delete_discovery_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DiscoveryV1(self._task.args, dnac)
