...
class DeviceRebootApreboot(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params['parent_task_id'] = self.new_object.get(
            'parentTaskId') or self.new_object.get('parent_task_id')
        return new_object_params

    def create_params(self):
        new_object_params = {}
        new_object_params['apMacAddresses'] = self.new_object.get(
            'apMacAddresses')
        return new_object_params
