...
class WirelessProfilesIdSiteTags(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params["site_tag_name"] = self.new_object.get(
            "siteTagName"
        ) or self.new_object.get("site_tag_name")
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="update_a_specific_site_tag_for_a_wireless_profile",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="delete_a_specific_site_tag_from_a_wireless_profile",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessProfilesIdSiteTags(self._task.args, dnac)
