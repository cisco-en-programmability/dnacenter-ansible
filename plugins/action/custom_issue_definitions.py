...
argument_spec.update(dict(
    ...
    isNotificationEnabled=dict(type="bool"),
...
class CustomIssueDefinitions(object):
    def __init__(self, params, dnac):
        ...
        self.new_object = dict(
            ...
            isNotificationEnabled=params.get("isNotificationEnabled"),
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['is_enabled'] = self.new_object.get('isEnabled') or \
            self.new_object.get('is_enabled')
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CustomIssueDefinitions(self._task.args, dnac)
