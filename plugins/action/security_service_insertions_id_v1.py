...
argument_spec.update(dict(
    ...
    virtualNetworks=dict(type="list"),
    id=dict(type="str"),
))
...
class SecurityServiceInsertionsIdV1(object):
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(
            siteId=params.get("siteId"),
            virtualNetworks=params.get("virtualNetworks"),
            id=params.get("id"),
        )
    ...
    def update_by_id_params(self):
        ...
        new_object_params['virtualNetworks'] = self.new_object.get('virtualNetworks')
        new_object_params['id'] = self.new_object.get('id')
        return new_object_params
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SecurityServiceInsertionsIdV1(self._task.args, dnac)
