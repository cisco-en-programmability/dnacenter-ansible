...
class WirelessSettingsAnchorGroupsId(object):
    ...
    def update_by_id_params(self):
        new_object_params = {}
        new_object_params['anchorGroupName'] = self.new_object.get(
            'anchorGroupName')
        new_object_params['mobilityAnchors'] = self.new_object.get(
            'mobilityAnchors')
        new_object_params['id'] = self.new_object.get('id')
        return new_object_params
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.dnac.exec(
                family="wireless",
                function="get_anchor_group_by_id",
                params={"id": id}
            )
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="wireless",
            function="delete_anchor_group_by_id",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsAnchorGroupsId(self._task.args, dnac)
