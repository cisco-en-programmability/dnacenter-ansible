...
class HttpReadCredentialV1(object):
    ...
    def create(self):
        result = self.dnac.exec(
            family="discovery",
            function="create_http_read_credentials_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="discovery",
            function="update_http_read_credential_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = HttpReadCredentialV1(self._task.args, dnac)
