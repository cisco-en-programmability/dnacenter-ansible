...
class Snmpv2WriteCommunityCredentialV1(object):
    ...
    def create(self):
        result = self.dnac.exec(
            family="discovery",
            function="create_snmp_write_community_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="discovery",
            function="update_snmp_write_community_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = Snmpv2WriteCommunityCredentialV1(self._task.args, dnac)
