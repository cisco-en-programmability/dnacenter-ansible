...
class ConfigurationTemplateProjectV1(object):
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="configuration_templates",
            function="deletes_the_project_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ConfigurationTemplateProjectV1(self._task.args, dnac)
