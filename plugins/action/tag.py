...
class Tag(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['additional_info_name_space'] = self.new_object.get('additionalInfo_nameSpace') or self.new_object.get('additional_info_name_space')
        new_object_params['additional_info_attributes'] = self.new_object.get('additionalInfo_attributes') or self.new_object.get('additional_info_attributes')
