...
class SitesSiteIdWirelessSettingsFlexConnectNativeVlanV1(object):
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(
            nativeVlanId=params.get("nativeVlanId"),
    ...
    def update_all_params(self):
        new_object_params = {}
        new_object_params['nativeVlanId'] = self.new_object.get('nativeVlanId')
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SitesSiteIdWirelessSettingsFlexConnectNativeVlanV1(self._task.args, dnac)
