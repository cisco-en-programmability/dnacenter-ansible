...
class WirelessSettingsCertificateRenewalProfiles(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["lsc_profile_name"] = self.new_object.get(
            "lscProfileName"
        ) or self.new_object.get("lsc_profile_name")
        new_object_params["renewal_type"] = self.new_object.get(
            "renewalType"
        ) or self.new_object.get("renewal_type")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsCertificateRenewalProfiles(self._task.args, dnac)
