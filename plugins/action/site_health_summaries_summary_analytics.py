...
class SiteHealthSummariesSummaryAnalytics(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params["site_hierarchy"] = self.new_object.get(
            "siteHierarchy"
        ) or self.new_object.get("site_hierarchy")
        new_object_params["site_hierarchy_id"] = self.new_object.get(
            "siteHierarchyId"
        ) or self.new_object.get("site_hierarchy_id")
        new_object_params["site_type"] = self.new_object.get(
            "siteType"
        ) or self.new_object.get("site_type")
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="sites",
                function="read_an_aggregated_summary_of_site_health_data",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sites",
            function="query_an_aggregated_summary_of_site_health_data",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteHealthSummariesSummaryAnalytics(self._task.args, dnac)
