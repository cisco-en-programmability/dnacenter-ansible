...
class FeatureTemplatesWirelessAaaRadiusAttributesConfigurationsId(object):
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FeatureTemplatesWirelessAaaRadiusAttributesConfigurationsId(self._task.args, dnac)
