...
class IpamSiteIpAddressPoolsId(object):
    ...
    def update_by_id_params(self):
        new_object_params = {}
        new_object_params['ipV4AddressSpace'] = self.new_object.get(
            'ipV4AddressSpace')
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="retrieves_an_ip_address_subpool",
                params={"id": id}
            )
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="network_settings",
            function="release_an_ip_address_subpool",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = IpamSiteIpAddressPoolsId(self._task.args, dnac)
