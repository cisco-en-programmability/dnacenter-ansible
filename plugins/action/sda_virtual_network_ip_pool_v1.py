...
class SdaVirtualNetworkIpPoolV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['ip_pool_name'] = self.new_object.get(
            'ipPoolName') or self.new_object.get('ip_pool_name')
    ...
    def get_object_by_name(self, name, is_absent=False):
        ...
        try:
            items = self.dnac.exec(
                family="sda",
                function="get_ip_pool_from_sda_virtual_network_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="sda",
            function="add_ip_pool_in_sda_virtual_network_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="delete_ip_pool_from_sda_virtual_network_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaVirtualNetworkIpPoolV1(self._task.args, dnac)
