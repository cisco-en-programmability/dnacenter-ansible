...
required_if = [
    ("state", "present", ["floorId", "id"], True),
    ("state", "absent", ["floorId", "id"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class FloorsFloorIdPlannedAccessPointPositions(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                family="site_design",
                function="get_planned_access_points_positions_v2",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FloorsFloorIdPlannedAccessPointPositions(self._task.args, dnac)
