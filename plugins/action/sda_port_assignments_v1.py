...
class SdaPortAssignmentsV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['data_vlan_name'] = self.new_object.get(
            'dataVlanName') or self.new_object.get('data_vlan_name')
        new_object_params['voice_vlan_name'] = self.new_object.get(
            'voiceVlanName') or self.new_object.get('voice_vlan_name')
    ...
    def create(self):
        result = self.dnac.exec(
            family="sda",
            function="add_port_assignments_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="update_port_assignments_v1",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="sda",
            function="delete_port_assignment_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaPortAssignmentsV1(self._task.args, dnac)
