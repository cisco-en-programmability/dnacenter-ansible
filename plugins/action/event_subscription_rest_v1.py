...
class EventSubscriptionRestV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['sub_domain'] = self.new_object.get('subDomain') or \
            self.new_object.get('sub_domain')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.dnac.exec(
                ...
                function="get_rest_webhook_event_subscriptions_v1",
    ...
    def create(self):
        result = self.dnac.exec(
            family="event_management",
            function="create_rest_webhook_event_subscription_v1",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="event_management",
            function="update_rest_webhook_event_subscription_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = EventSubscriptionRestV1(self._task.args, dnac)
