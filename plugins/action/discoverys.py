...
class Discoverys(object):
    ...
    def create_params(self):
        ...
        new_object_params["discoveryTypeDetails"] = self.new_object.get(
            "discoveryTypeDetails"
        )
        new_object_params["onlyNewDevice"] = self.new_object.get("onlyNewDevice")
        new_object_params["updateManagementIp"] = self.new_object.get(
            "updateManagementIp"
        )
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="devices",
            function="deletes_discovery_by_id",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = Discoverys(self._task.args, dnac)
