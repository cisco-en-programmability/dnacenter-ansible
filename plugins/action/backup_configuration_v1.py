...
argument_spec.update(dict(
    ...
    dataRetention=dict(type="int"),
    encryptionPassphrase=dict(type="str"),
    mountPath=dict(type="str"),
    type=dict(type="str"),
))
...
class BackupConfigurationV1(object):
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(
            dataRetention=params.get("dataRetention"),
            encryptionPassphrase=params.get("encryptionPassphrase"),
            mountPath=params.get("mountPath"),
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = BackupConfigurationV1(self._task.args, dnac)
